<template>
  ...
  <mt-popup
    ...
    <div v-show="!confirmShow" class="application-refunded2-content">
      <!--编辑栏-->
      <div class="application-refunded-content-title">温馨提醒</div>
      <div class="application-refunded-content-title">此功能仅适用于发起退款时间距下单时间超过90天的用户；未超过90天的用户请到我的订单中进行退款。</div>
    ...
    <!--<confirm v-show="confirmShow" @cancel="confirmCancel" @ok="confirmOk"></confirm>-->
  </mt-popup>
</template>
