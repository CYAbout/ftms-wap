// import jQuery from 'jquery'; // 内部引用

(function ($) {
  var supportedCSS = document.getElementsByTagName('head')[0].style
    ...
    _Loader: (function () {
      if (IE) {
        return function (parameters) {
          ...
          this._vimage = (function () {
            document.createStyleSheet().addRule('.rvml', 'behavior:url(#default#VML)')
            try {
              !document.namespaces.rvml && document.namespaces.add('rvml', 'urn:schemas-microsoft-com:vml')
              return function () {
                return document.createElement('<rvml:image' + ' class="rvml">')
              }
            } catch (e) {
              return function () {
                return document.createElement('<image' + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')
              }
            }
          })()
          ...
          this._container = (function () {
            ...
            try {
              !document.namespaces.rvml && document.namespaces.add('rvml', 'urn:schemas-microsoft-com:vml')
              return function () {
                return document.createElement('<rvml:group' + ' class="rvml">')
              }
            } catch (e) {
              return function () {
                return document.createElement('<group' + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')
              }
            }
          })()
