<template>
  <div class="sales-container">
    <iframe :src="src" frameborder="no" style="width: 100vw;height: 263.6vw;"></iframe>
  </div>
</template>
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        src: 'https://mall.ftms.com.cn/ftmsweb/index.html?phone='
      }
    },
    mounted() {
      let t = this
        ...
        if (!userObj.logined) {
          ...
          ; (async () => {
            try {
              ...
              t.src = 'https://mall.ftms.com.cn/ftmsweb/index.html?phone=' + t.userObj.data.mobile
            } catch (error) {
              console.log(error)
            }
          })()
