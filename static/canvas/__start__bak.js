function CANVAS_PLAY(carType, CANVAS_ID) {
    ...
    window.reflow = function () {
        ...
        //alert(canvas.width)
        app.setCanvasFillMode(pc.FILLMODE_NONE, window.innerWidth * 0.9, window.innerWidth * (CANVAS_PROPORTION) * 1);
    ...
    if (e == "addUi") {
        ...
        var innerHTML = carType === 'avalon' ? [
            `<div class="ui_contro canvasUiContro">
                    <div class="vehicle">
                        <div class="car1 in">2.5L汽油版</div>
                        <div class="car4">2.5L双擎版</div>
                    </div>
                    <div class="colorList">
                        <div class="color6 in"></div>
    ...
    `
        ...
        $(".fullScreen,.tui-hengping").click(function () {
            ...
            if (window.currentStep != 3) {
                window.DISTANCEDEF = 18;
            }
        })
        $(".tui-hengping").click(function () {
            CANVAS_PROPORTION = 740 / 1400;//canvas尺寸比例
            reflow();
        })
        $(".fullScreen").click(function () {
            CANVAS_PROPORTION = 800 / 1400;//canvas尺寸比例
            reflow();
        })
        ...
        $(".fullback").click(function () {
            ...
            CANVAS_PROPORTION = window.innerWidth / 1.6 / window.innerHeight;//canvas尺寸比例
            reflow();
            $(this).hide();
            ...
            if (window.currentStep != 3) {
                window.DISTANCEDEF = 16;
            }
        })
        $(".hengping").click(function () {
            $(".content .right").removeClass("full");
            $(".content .right").addClass("back");
            CANVAS_PROPORTION = window.innerHeight / 1.3 / window.innerWidth;;//canvas尺寸比例
            reflow();
            $(".fullback").hide();
            $(".fullScreen,.title").show();
            $(".ui_contro").removeClass("da");
        ...
        $(".foot .prve").click(function () {
            ...
            window.currentStep--;
            $(".content .left>div").eq(ind).addClass("in").removeClass("yellow");
            $(".content .left>div").eq(ind + 1).removeClass("in");
