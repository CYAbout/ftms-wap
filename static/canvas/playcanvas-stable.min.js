;(function (root, factory) {
  ...
  /*
 PlayCanvas Engine v1.10.7 revision cb1c3c0
 http://playcanvas.com
 Copyright 2011-2018 PlayCanvas Ltd. All rights reserved.
*/
var _typeLookup=function(){for(var e={},b="Array Object Function Date RegExp Float32Array".split(" "),a=0;a<b.length;a++)e["[object "+b[a]+"]"]=b[a].toLowerCase();return e}(),pc={version:"1.10.7",revision:"cb1c3c0",config:{},common:{},apps:{},data:{},unpack:function(){console.warn("pc.unpack has been deprecated and will be removed shortly. Please update your code.")},makeArray:function(e){var b,a=[],c=e.length;for(b=0;b<c;++b)a.push(e[b]);return a},type:function(e){if(null===
...
1).join(pc.path.delimiter)},getExtension:function(e){var b=e.split("?")[0].split(".").pop();return b!==e?"."+b:""},isRelativePath:function(e){return"/"!==e.charAt(0)&&null===e.match(/:\/\//)},extractPath:function(e){var b=".",a=e.split("/");if(1<a.length)for(!1===pc.path.isRelativePath(e)&&(b=""),e=0;e<a.length-1;++e)b+="/"+a[e];return b}}}();pc.string=function(){function e(a,c){var b=a.length;c=c||0;if(0>c||c>=b)return null;var f=a.charCodeAt(c);return 1<b&&55296<=f&&56319>=f&&(b=a.charCodeAt(c+1),56320<=b&&57343>=b)?{code:1024*(f-55296)+b-56320+65536,"long":!0}:{code:f,"long":!1}}function b(a,c,b){return a?(a=e(a))?(a=a.code,a>=c&&a<=b):!1:!1}return{ASCII_LOWERCASE:"abcdefghijklmnopqrstuvwxyz",ASCII_UPPERCASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZ",ASCII_LETTERS:"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",format:function(a){var c,b,
f=pc.makeArray(arguments);f.shift();for(c=0;c<f.length;c++)b=new RegExp("\\{"+c+"\\}","gi"),a=a.replace(b,f[c]);return a},startsWith:function(a,c){console.warn("WARNING: startsWith: Function is deprecated. Use String.startsWith instead.");return a.startsWith(c)},endsWith:function(a,c){console.warn("WARNING: endsWith: Function is deprecated. Use String.endsWith instead.");return a.endsWith(c)},toBool:function(a,c){if("true"===a)return!0;if(c){if("false"===a)return!1;throw new TypeError("Not a boolean string");
}return!1},getCodePoint:function(a,c){var b=e(a,c);return b&&b.code},getCodePoints:function(a){if("string"!==typeof a)throw new TypeError("Not a string");for(var c=0,b=[],f;f=e(a,c);)b.push(f.code),c+=f["long"]?2:1;return b},getSymbols:function(a){if("string"!==typeof a)throw new TypeError("Not a string");for(var c=0,d=a.length,f=[],g=0,l;c<d;){l=g;var k=a,e=c+g;e===k.length-1?g=1:b(k[e],55296,56319)?(g=k.substring(e,e+2),k=k.substring(e+2,e+4),g=b(k,127995,127999)||b(g,127462,127487)&&b(k,127462,
127487)?4:2):g=1;g=l+g;l=a[c+g];b(l,8400,8447)&&(l=a[c+g++]);b(l,65024,65039)&&(l=a[c+g++]);l&&8205===l.charCodeAt(0)?g++:(l=a.substring(c,c+g),f.push(l),c+=g,g=0)}return f},fromCodePoint:function(){for(var a=[],c,b,f=0;f<arguments.length;++f)c=Number(arguments[f]),b=c-65536,c=65535<c?[(b>>10)+55296,b%1024+56320]:[c],a.push(String.fromCharCode.apply(null,c));return a.join("")}}}();pc.debug=function(){var e=null,b=null,a=null,c=null;return{display:function(d){e||(e=document.createElement("table"),b=document.createElement("tr"),a=document.createElement("td"),c=document.createElement("td"),e.style.cssText="position:absolute;font-family:sans-serif;font-size:12px;color:#cccccc",e.style.top="0px",e.style.left="0px",e.style.border="thin solid #cccccc",document.body.appendChild(e));e.innerHTML="";for(var f in d){var g=b.cloneNode(),l=a.cloneNode(),k=c.cloneNode();l.textContent=f;k.textContent=
d[f];g.appendChild(l);g.appendChild(k);e.appendChild(g)}}}}();pc.events={attach:function(e){var b=pc.events;e.on=b.on;e.off=b.off;e.fire=b.fire;e.once=b.once;e.hasEvent=b.hasEvent;e._callbackActive={};return e},on:function(e,b,a){if(!e||"string"!==typeof e||!b)return this;this._callbacks||(this._callbacks={});this._callbacks[e]||(this._callbacks[e]=[]);this._callbackActive||(this._callbackActive={});this._callbackActive[e]&&this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice());this._callbacks[e].push({callback:b,
...
a||e.splice(c,1))}else this._callbacks[e]&&delete this._callbacks[e];else this._callbacks=null;return this},fire:function(e,b,a,c,d,f,g,l,k){if(!e||!this._callbacks||!this._callbacks[e])return this;var p;this._callbackActive||(this._callbackActive={});this._callbackActive[e]?(this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice()),p=this._callbacks[e].slice()):this._callbackActive[e]=this._callbacks[e];for(var h=0;(p||this._callbackActive[e])&&h<(p||
this._callbackActive[e]).length;h++){var n=(p||this._callbackActive[e])[h];n.callback.call(n.scope,b,a,c,d,f,g,l,k);n.callback.once&&(n=this._callbacks[e].indexOf(n),-1!==n&&(this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice()),this._callbacks[e].splice(n,1)))}p||(this._callbackActive[e]=null);return this},once:function(e,b,a){b.once=!0;this.on(e,b,a);return this},hasEvent:function(e){return this._callbacks&&this._callbacks[e]&&0!==this._callbacks[e].length||
!1}};Object.assign(pc,function(){var e=function(a){this._index={};this._key=a||null};Object.assign(e.prototype,{addItem:function(a){for(var c=a.tags._list,b=0;b<c.length;b++)this.add(c[b],a)},removeItem:function(a){for(var c=a.tags._list,b=0;b<c.length;b++)this.remove(c[b],a)},add:function(a,c){this._index[a]&&-1!==this._index[a].list.indexOf(c)||(this._index[a]||(this._index[a]={list:[]},this._key&&(this._index[a].keys={})),this._index[a].list.push(c),this._key&&(this._index[a].keys[c[this._key]]=c))},
remove:function(a,c){if(this._index[a]&&(!this._key||this._index[a].keys[c[this._key]])){var b=this._index[a].indexOf(c);-1!==b&&(this._index[a].list.splice(b,1),this._key&&delete this._index[a].keys[c[this._key]],0===this._index[a].list.length&&delete this._index[a])}},find:function(a){var c=this,b={},f=[],g,l,k,e,h,n=function(a,b){return c._index[a].list.length-c._index[b].list.length};for(g=0;g<a.length;g++){e=a[g];if(e instanceof Array){if(0===e.length)continue;if(1===e.length)e=e[0];else{k=!1;
for(l=0;l<e.length;l++)if(!this._index[e[l]]){k=!0;break}if(k)continue;e=e.slice(0).sort(n);h=e.slice(1);1===h.length&&(h=h[0]);for(l=0;l<this._index[e[0]].list.length;l++)k=this._index[e[0]].list[l],(this._key?!b[k[this._key]]:-1===f.indexOf(k))&&k.tags.has(h)&&(this._key&&(b[k[this._key]]=!0),f.push(k));continue}}if(e&&"string"===typeof e&&this._index[e])for(l=0;l<this._index[e].list.length;l++)k=this._index[e].list[l],this._key?b[k[this._key]]||(b[k[this._key]]=!0,f.push(k)):-1===f.indexOf(k)&&
f.push(k)}return f}});var b=function(a){this._index={};this._list=[];this._parent=a;pc.events.attach(this)};Object.assign(b.prototype,{add:function(){var a=!1,c=this._processArguments(arguments,!0);if(!c.length)return a;for(var b=0;b<c.length;b++)this._index[c[b]]||(a=!0,this._index[c[b]]=!0,this._list.push(c[b]),this.fire("add",c[b],this._parent));a&&this.fire("change",this._parent);return a},remove:function(){var a=!1;if(!this._list.length)return a;var c=this._processArguments(arguments,!0);if(!c.length)return a;
...
a[13]===b[13]&&a[14]===b[14]&&a[15]===b[15]},isIdentity:function(){var b=this.data;return 1===b[0]&&0===b[1]&&0===b[2]&&0===b[3]&&0===b[4]&&1===b[5]&&0===b[6]&&0===b[7]&&0===b[8]&&0===b[9]&&1===b[10]&&0===b[11]&&0===b[12]&&0===b[13]&&0===b[14]&&1===b[15]},mul2:function(b,a){var c,d,f,g,l,k,e,h,n,q,m,r,t,v,y,u,w,x,D,z;u=b.data;var C=a.data,A=this.data;c=u[0];d=u[1];f=u[2];g=u[3];l=u[4];k=u[5];e=u[6];h=u[7];n=u[8];q=u[9];m=u[10];r=u[11];t=u[12];v=u[13];y=u[14];u=u[15];w=C[0];x=C[1];D=C[2];z=C[3];A[0]=
c*w+l*x+n*D+t*z;A[1]=d*w+k*x+q*D+v*z;A[2]=f*w+e*x+m*D+y*z;A[3]=g*w+h*x+r*D+u*z;w=C[4];x=C[5];D=C[6];z=C[7];A[4]=c*w+l*x+n*D+t*z;A[5]=d*w+k*x+q*D+v*z;A[6]=f*w+e*x+m*D+y*z;A[7]=g*w+h*x+r*D+u*z;w=C[8];x=C[9];D=C[10];z=C[11];A[8]=c*w+l*x+n*D+t*z;A[9]=d*w+k*x+q*D+v*z;A[10]=f*w+e*x+m*D+y*z;A[11]=g*w+h*x+r*D+u*z;w=C[12];x=C[13];D=C[14];z=C[15];A[12]=c*w+l*x+n*D+t*z;A[13]=d*w+k*x+q*D+v*z;A[14]=f*w+e*x+m*D+y*z;A[15]=g*w+h*x+r*D+u*z;return this},mul:function(b){return this.mul2(this,b)},transformPoint:function(b,
...
n;l=2*f;k=a-b;e=d-c;h=g-f;n=this.data;n[0]=l/k;n[1]=0;n[2]=0;n[3]=0;n[4]=0;n[5]=l/e;n[6]=0;n[7]=0;n[8]=(a+b)/k;n[9]=(d+c)/e;n[10]=(-g-f)/h;n[11]=-1;n[12]=0;n[13]=0;n[14]=-l*g/h;n[15]=0;return this},setPerspective:function(b,a,c,d,f){f?(b=c*Math.tan(b*Math.PI/360),f=b/a):(f=c*Math.tan(b*Math.PI/360),b=f*a);return this.setFrustum(-b,b,-f,f,c,d)},setOrtho:function(b,a,c,d,f,g){var l=this.data;l[0]=2/(a-b);l[1]=0;l[2]=0;l[3]=0;l[4]=0;l[5]=2/(d-c);l[6]=0;l[7]=0;l[8]=0;l[9]=0;l[10]=-2/(g-f);l[11]=0;l[12]=
-(a+b)/(a-b);l[13]=-(d+c)/(d-c);l[14]=-(g+f)/(g-f);l[15]=1;return this},setFromAxisAngle:function(b,a){var c,d,f,g,l,k,e,h,n;a*=pc.math.DEG_TO_RAD;c=b.x;d=b.y;f=b.z;g=Math.cos(a);l=Math.sin(a);k=1-g;e=k*c;h=k*d;n=this.data;n[0]=e*c+g;n[1]=e*d+l*f;n[2]=e*f-l*d;n[3]=0;n[4]=e*d-l*f;n[5]=h*d+g;n[6]=h*f+l*c;n[7]=0;n[8]=e*f+l*d;n[9]=h*f-c*l;n[10]=k*f*f+g;n[11]=0;n[12]=0;n[13]=0;n[14]=0;n[15]=1;return this},setTranslate:function(b,a,c){var d=this.data;d[0]=1;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=1;d[6]=0;d[7]=
0;d[8]=0;d[9]=0;d[10]=1;d[11]=0;d[12]=b;d[13]=a;d[14]=c;d[15]=1;return this},setScale:function(b,a,c){var d=this.data;d[0]=b;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=a;d[6]=0;d[7]=0;d[8]=0;d[9]=0;d[10]=c;d[11]=0;d[12]=0;d[13]=0;d[14]=0;d[15]=1;return this},invert:function(){var b,a,c,d,f,g,l,k,e,h,n,q,m,r,t,v,y,u,w,x,D,z,C,A,B,J,F,H,E,G;G=this.data;b=G[0];a=G[1];c=G[2];d=G[3];f=G[4];g=G[5];l=G[6];k=G[7];e=G[8];h=G[9];n=G[10];q=G[11];m=G[12];r=G[13];t=G[14];v=G[15];y=b*g-a*f;u=b*l-c*f;w=b*k-d*f;x=a*l-c*g;
D=a*k-d*g;z=c*k-d*l;C=e*r-h*m;A=e*t-n*m;B=e*v-q*m;J=h*t-n*r;F=h*v-q*r;H=n*v-q*t;E=y*H-u*F+w*J+x*B-D*A+z*C;0===E?this.setIdentity():(E=1/E,G[0]=(g*H-l*F+k*J)*E,G[1]=(-a*H+c*F-d*J)*E,G[2]=(r*z-t*D+v*x)*E,G[3]=(-h*z+n*D-q*x)*E,G[4]=(-f*H+l*B-k*A)*E,G[5]=(b*H-c*B+d*A)*E,G[6]=(-m*z+t*w-v*u)*E,G[7]=(e*z-n*w+q*u)*E,G[8]=(f*F-g*B+k*C)*E,G[9]=(-b*F+a*B-d*C)*E,G[10]=(m*D-r*w+v*y)*E,G[11]=(-e*D+h*w-q*y)*E,G[12]=(-f*J+g*A-l*C)*E,G[13]=(b*J-a*A+c*C)*E,G[14]=(-m*x+r*u-t*y)*E,G[15]=(e*x-h*u+n*y)*E);return this},
set:function(b){var a=this.data;a[0]=b[0];a[1]=b[1];a[2]=b[2];a[3]=b[3];a[4]=b[4];a[5]=b[5];a[6]=b[6];a[7]=b[7];a[8]=b[8];a[9]=b[9];a[10]=b[10];a[11]=b[11];a[12]=b[12];a[13]=b[13];a[14]=b[14];a[15]=b[15];return this},setIdentity:function(){var b=this.data;b[0]=1;b[1]=0;b[2]=0;b[3]=0;b[4]=0;b[5]=1;b[6]=0;b[7]=0;b[8]=0;b[9]=0;b[10]=1;b[11]=0;b[12]=0;b[13]=0;b[14]=0;b[15]=1;return this},setTRS:function(b,a,c){var d,f,g,l,k,e,h,n,q,m,r,t,v;d=b.x;f=b.y;b=b.z;g=a.x;l=a.y;k=a.z;e=a.w;a=c.x;h=c.y;c=c.z;n=
g+g;q=l+l;m=k+k;r=g*n;t=g*q;g*=m;v=l*q;l*=m;k*=m;n*=e;q*=e;e*=m;m=this.data;m[0]=(1-(v+k))*a;m[1]=(t+e)*a;m[2]=(g-q)*a;m[3]=0;m[4]=(t-e)*h;m[5]=(1-(r+k))*h;m[6]=(l+n)*h;m[7]=0;m[8]=(g+q)*c;m[9]=(l-n)*c;m[10]=(1-(r+v))*c;m[11]=0;m[12]=d;m[13]=f;m[14]=b;m[15]=1;return this},transpose:function(){var b,a=this.data;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[3];a[3]=a[12];a[12]=b;b=a[6];a[6]=a[9];a[9]=b;b=a[7];a[7]=a[13];a[13]=b;b=a[11];a[11]=a[14];a[14]=b;return this},invertTo3x3:function(b){var a,
c,d,f;a=this.data;b=b.data;var g=a[0],l=a[1],k=a[2],e=a[4],h=a[5],n=a[6],q=a[8],m=a[9],r=a[10];a=r*h-n*m;c=-r*e+n*q;d=m*e-h*q;f=g*a+l*c+k*d;if(0===f)return this;f=1/f;b[0]=f*a;b[1]=f*(-r*l+k*m);b[2]=f*(n*l-k*h);b[3]=f*c;b[4]=f*(r*g-k*q);b[5]=f*(-n*g+k*e);b[6]=f*d;b[7]=f*(-m*g+l*q);b[8]=f*(h*g-l*e);return this},getTranslation:function(b){b=void 0===b?new pc.Vec3:b;return b.set(this.data[12],this.data[13],this.data[14])},getX:function(b){b=void 0===b?new pc.Vec3:b;return b.set(this.data[0],this.data[1],
...
Math.asin(c),d=Math.atan2(2*(l*g+d*f),1-2*(f*f+g*g)));return b.set(a,c,d).scale(pc.math.RAD_TO_DEG)},invert:function(){return this.conjugate().normalize()},length:function(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w)},lengthSq:function(){return this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w},mul:function(b){var a,c,d,f,g,l,k;a=this.x;c=this.y;d=this.z;f=this.w;g=b.x;l=b.y;k=b.z;b=b.w;this.x=f*g+a*b+c*k-d*l;this.y=f*l+c*b+d*g-a*k;this.z=f*k+d*b+a*l-c*g;this.w=
f*b-a*g-c*l-d*k;return this},mul2:function(b,a){var c,d,f,g,l,k,e,h;c=b.x;d=b.y;f=b.z;g=b.w;l=a.x;k=a.y;e=a.z;h=a.w;this.x=g*l+c*h+d*e-f*k;this.y=g*k+d*h+f*l-c*e;this.z=g*e+f*h+c*k-d*l;this.w=g*h-c*l-d*k-f*e;return this},normalize:function(){var b=this.length();0===b?(this.x=this.y=this.z=0,this.w=1):(b=1/b,this.x*=b,this.y*=b,this.z*=b,this.w*=b);return this},set:function(b,a,c,d){this.x=b;this.y=a;this.z=c;this.w=d;return this},setFromAxisAngle:function(b,a){var c,d;a*=.5*pc.math.DEG_TO_RAD;c=Math.sin(a);
d=Math.cos(a);this.x=c*b.x;this.y=c*b.y;this.z=c*b.z;this.w=d;return this},setFromEulerAngles:function(b,a,c){var d,f,g;d=.5*pc.math.DEG_TO_RAD;b*=d;a*=d;c*=d;d=Math.sin(b);b=Math.cos(b);f=Math.sin(a);a=Math.cos(a);g=Math.sin(c);c=Math.cos(c);this.x=d*a*c-b*f*g;this.y=b*f*c+d*a*g;this.z=b*a*g-d*f*c;this.w=b*a*c+d*f*g;return this},setFromMat4:function(b){var a,c,d,f,g,l,k,e,h,n,q;b=b.data;a=b[0];c=b[1];d=b[2];f=b[4];g=b[5];l=b[6];k=b[8];e=b[9];b=b[10];h=1/Math.sqrt(a*a+c*c+d*d);n=1/Math.sqrt(f*f+g*
g+l*l);q=1/Math.sqrt(k*k+e*e+b*b);a*=h;c*=h;d*=h;f*=n;g*=n;l*=n;k*=q;e*=q;b*=q;h=a+g+b;0<=h?(a=Math.sqrt(h+1),this.w=.5*a,a=.5/a,this.x=(l-e)*a,this.y=(k-d)*a,this.z=(c-f)*a):a>g?a>b?(a=Math.sqrt(a-(g+b)+1),this.x=.5*a,a=.5/a,this.w=(l-e)*a,this.y=(c+f)*a,this.z=(d+k)*a):(a=Math.sqrt(b-(a+g)+1),this.z=.5*a,a=.5/a,this.w=(c-f)*a,this.x=(k+d)*a,this.y=(e+l)*a):g>b?(a=Math.sqrt(g-(b+a)+1),this.y=.5*a,a=.5/a,this.w=(k-d)*a,this.z=(l+e)*a,this.x=(f+c)*a):(a=Math.sqrt(b-(a+g)+1),this.z=.5*a,a=.5/a,this.w=
(c-f)*a,this.x=(k+d)*a,this.y=(e+l)*a);return this},slerp:function(b,a,c){var d,f,g,l,k,e;d=b.x;f=b.y;g=b.z;b=b.w;l=a.x;k=a.y;e=a.z;a=a.w;var h=b*a+d*l+f*k+g*e;0>h&&(a=-a,l=-l,k=-k,e=-e,h=-h);if(1<=Math.abs(h))return this.w=b,this.x=d,this.y=f,this.z=g,this;var n=Math.acos(h),q=Math.sqrt(1-h*h);if(.001>Math.abs(q))return this.w=.5*b+.5*a,this.x=.5*d+.5*l,this.y=.5*f+.5*k,this.z=.5*g+.5*e,this;h=Math.sin((1-c)*n)/q;c=Math.sin(c*n)/q;this.w=b*h+a*c;this.x=d*h+l*c;this.y=f*h+k*c;this.z=g*h+e*c;return this},
transformVector:function(b,a){void 0===a&&(a=new pc.Vec3);var c=b.x,d=b.y,f=b.z,g=this.x,l=this.y,k=this.z,e=this.w,h=e*c+l*f-k*d,n=e*d+k*c-g*f,q=e*f+g*d-l*c,c=-g*c-l*d-k*f;a.x=h*e+c*-g+n*-k-q*-l;a.y=n*e+c*-l+q*-g-h*-k;a.z=q*e+c*-k+h*-l-n*-g;return a},toString:function(){return"["+this.x+", "+this.y+", "+this.z+", "+this.w+"]"}});Object.defineProperty(e,"IDENTITY",{get:function(){var b=new e;return function(){return b}}()});Object.defineProperty(e,"ZERO",{get:function(){var b=new e(0,0,0,0);return function(){return b}}()});
...
d[d.length-1][0])return d[d.length-1][1];var f=0,g=d.length?d[0][1]:0,l=1,k=0;a=0;for(c=d.length;a<c;a++){if(d[a][0]===b)return d[a][1];k=d[a][1];if(b<d[a][0]){l=d[a][0];break}f=d[a][0];g=d[a][1]}c=l-f;b=0===c?0:(b-f)/c;if(1===this.type)b*=b*(3-2*b);else if(2===this.type||3===this.type){c=g+(g-k);var e=k+(k-g),h=l=f=l-f;0<a&&a--;0<a&&(c=d[a-1][1],l=d[a][0]-d[a-1][0]);d.length>a+1&&(f=d[a+1][0]-d[a][0]);d.length>a+2&&(h=d[a+2][0]-d[a+1][0],e=d[a+2][1]);c=g+(c-g)*f/l;e=k+(e-k)*f/h;return 2===this.type?
...
Math.min(g.z,l.z));g=c.set(Math.max(g.x,l.x),Math.max(g.y,l.y),Math.max(g.z,l.z));l=Math.max(Math.max(h.x,h.y),h.z);(g=Math.min(Math.min(g.x,g.y),g.z)>=l&&0<=l)&&f.copy(d.direction).scale(l).add(d.origin);return g},_fastIntersectsRay:function(f){var g=f.direction;e.sub2(f.origin,this.center);c.set(Math.abs(e.x),Math.abs(e.y),Math.abs(e.z));a.mul2(e,g);if(c.x>this.halfExtents.x&&0<=a.x||c.y>this.halfExtents.y&&0<=a.y||c.z>this.halfExtents.z&&0<=a.z)return!1;d.set(Math.abs(g.x),Math.abs(g.y),Math.abs(g.z));
b.cross(g,e);b.set(Math.abs(b.x),Math.abs(b.y),Math.abs(b.z));return b.x>this.halfExtents.y*d.z+this.halfExtents.z*d.y||b.y>this.halfExtents.x*d.z+this.halfExtents.z*d.x||b.z>this.halfExtents.x*d.y+this.halfExtents.y*d.x?!1:!0},intersectsRay:function(a,c){return c?this._intersectsRay(a,c):this._fastIntersectsRay(a)},setMinMax:function(a,c){this.center.add2(c,a).scale(.5);this.halfExtents.sub2(c,a).scale(.5)},getMin:function(){return this._min.copy(this.center).sub(this.halfExtents)},getMax:function(){return this._max.copy(this.center).add(this.halfExtents)},
containsPoint:function(a){var c=this.getMin(),b=this.getMax();return a.x<c.x||a.x>b.x||a.y<c.y||a.y>b.y||a.z<c.z||a.z>b.z?!1:!0},setFromTransformedAabb:function(a,c){var b=this.center,d=this.halfExtents,f=a.center,g=a.halfExtents;c=c.data;var l=c[0],e=c[4],r=c[8],t=c[1],v=c[5],y=c[9],u=c[2],w=c[6],x=c[10],D=Math.abs(l),z=Math.abs(e),C=Math.abs(r),A=Math.abs(t),B=Math.abs(v),J=Math.abs(y),F=Math.abs(u),H=Math.abs(w),E=Math.abs(x);b.set(c[12]+l*f.x+e*f.y+r*f.z,c[13]+t*f.x+v*f.y+y*f.z,c[14]+u*f.x+w*
f.y+x*f.z);d.set(D*g.x+z*g.y+C*g.z,A*g.x+B*g.y+J*g.z,F*g.x+H*g.y+E*g.z)},compute:function(a){for(var c=e.set(a[0],a[1],a[2]),d=b.set(a[0],a[1],a[2]),f=a.length/3,g=1;g<f;g++){var n=a[3*g+0],q=a[3*g+1],m=a[3*g+2];n<c.x&&(c.x=n);q<c.y&&(c.y=q);m<c.z&&(c.z=m);n>d.x&&(d.x=n);q>d.y&&(d.y=q);m>d.z&&(d.z=m)}this.setMinMax(c,d)},intersectsBoundingSphere:function(a){return this._distanceToBoundingSphereSq(a)<=a.radius*a.radius?!0:!1},_distanceToBoundingSphereSq:function(a){for(var c=this.getMin(),b=this.getMax(),
d=0,f=["x","y","z"],g=0;3>g;++g){var e=0,m=a.center[f[g]],r=c[f[g]],t=b[f[g]];m<r&&(r-=m,e+=r*r);m>t&&(r=m-t,e+=r*r);d+=e}return d}});return{BoundingBox:f}}());Object.assign(pc,function(){function e(a,c){this.center=a||new pc.Vec3(0,0,0);this.radius=void 0===c?.5:c}var b=new pc.Vec3,a=new pc.Vec3,c=new pc.Vec3,d=new pc.Vec3;Object.assign(e.prototype,{containsPoint:function(a){a=b.sub2(a,this.center).lengthSq();var c=this.radius;return a<c*c},compute:function(f){var g,l=f.length/3;for(g=0;g<l;g++)b.set(f[3*g],f[3*g+1],f[3*g+2]),c.addSelf(b),0===g%100&&(c.scale(1/l),a.add(c),c.set(0,0,0));c.scale(1/l);a.add(c);this.center.copy(a);var k=0;for(g=0;g<l;g++)b.set(f[3*
g],f[3*g+1],f[3*g+2]),d.sub2(b,this.center),k=Math.max(d.lengthSq(),k);this.radius=Math.sqrt(k)},intersectsRay:function(c,d){var f=b.copy(c.origin).sub(this.center),g=f.dot(a.copy(c.direction).normalize()),f=f.dot(f)-this.radius*this.radius;if(0<f&&0<g)return null;f=g*g-f;if(0>f)return!1;g=Math.abs(-g-Math.sqrt(f));d&&d.copy(c.direction).scale(g).add(c.origin);return!0},intersectsBoundingSphere:function(a){b.sub2(a.center,this.center);a=a.radius+this.radius;return b.lengthSq()<=a*a?!0:!1}});return{BoundingSphere:e}}());Object.assign(pc,function(){var e=new pc.Mat4,b=function(a,c){a=a||(new pc.Mat4).setPerspective(90,16/9,.1,1E3);c=c||new pc.Mat4;this.planes=[];for(var b=0;6>b;b++)this.planes[b]=[];this.update(a,c)};Object.assign(b.prototype,{update:function(a,c){e.mul2(a,c);var b=e.data;this.planes[0][0]=b[3]-b[0];this.planes[0][1]=b[7]-b[4];this.planes[0][2]=b[11]-b[8];this.planes[0][3]=b[15]-b[12];var f=Math.sqrt(this.planes[0][0]*this.planes[0][0]+this.planes[0][1]*this.planes[0][1]+this.planes[0][2]*this.planes[0][2]);
this.planes[0][0]/=f;this.planes[0][1]/=f;this.planes[0][2]/=f;this.planes[0][3]/=f;this.planes[1][0]=b[3]+b[0];this.planes[1][1]=b[7]+b[4];this.planes[1][2]=b[11]+b[8];this.planes[1][3]=b[15]+b[12];f=Math.sqrt(this.planes[1][0]*this.planes[1][0]+this.planes[1][1]*this.planes[1][1]+this.planes[1][2]*this.planes[1][2]);this.planes[1][0]/=f;this.planes[1][1]/=f;this.planes[1][2]/=f;this.planes[1][3]/=f;this.planes[2][0]=b[3]+b[1];this.planes[2][1]=b[7]+b[5];this.planes[2][2]=b[11]+b[9];this.planes[2][3]=
b[15]+b[13];f=Math.sqrt(this.planes[2][0]*this.planes[2][0]+this.planes[2][1]*this.planes[2][1]+this.planes[2][2]*this.planes[2][2]);this.planes[2][0]/=f;this.planes[2][1]/=f;this.planes[2][2]/=f;this.planes[2][3]/=f;this.planes[3][0]=b[3]-b[1];this.planes[3][1]=b[7]-b[5];this.planes[3][2]=b[11]-b[9];this.planes[3][3]=b[15]-b[13];f=Math.sqrt(this.planes[3][0]*this.planes[3][0]+this.planes[3][1]*this.planes[3][1]+this.planes[3][2]*this.planes[3][2]);this.planes[3][0]/=f;this.planes[3][1]/=f;this.planes[3][2]/=
f;this.planes[3][3]/=f;this.planes[4][0]=b[3]-b[2];this.planes[4][1]=b[7]-b[6];this.planes[4][2]=b[11]-b[10];this.planes[4][3]=b[15]-b[14];f=Math.sqrt(this.planes[4][0]*this.planes[4][0]+this.planes[4][1]*this.planes[4][1]+this.planes[4][2]*this.planes[4][2]);this.planes[4][0]/=f;this.planes[4][1]/=f;this.planes[4][2]/=f;this.planes[4][3]/=f;this.planes[5][0]=b[3]+b[2];this.planes[5][1]=b[7]+b[6];this.planes[5][2]=b[11]+b[10];this.planes[5][3]=b[15]+b[14];f=Math.sqrt(this.planes[5][0]*this.planes[5][0]+
this.planes[5][1]*this.planes[5][1]+this.planes[5][2]*this.planes[5][2]);this.planes[5][0]/=f;this.planes[5][1]/=f;this.planes[5][2]/=f;this.planes[5][3]/=f},containsPoint:function(a){for(var c=0;6>c;c++)if(0>=this.planes[c][0]*a.x+this.planes[c][1]*a.y+this.planes[c][2]*a.z+this.planes[c][3])return!1;return!0},containsSphere:function(a){var c=0,b,f,g=a.radius;f=a.center;a=f.x;var l=f.y,k=f.z,e=this.planes;for(f=0;6>f;f++){b=e[f];b=b[0]*a+b[1]*l+b[2]*k+b[3];if(b<=-g)return 0;b>g&&c++}return 6===c?
2:1}});return{Frustum:b}}());Object.assign(pc,function(){var e=new pc.Vec3,b=function(a,c){this.normal=c||new pc.Vec3(0,0,1);this.point=a||new pc.Vec3(0,0,0)};Object.assign(b.prototype,{intersectsLine:function(a,c,b){var d=-this.normal.dot(this.point),g=this.normal.dot(a)+d,d=this.normal.dot(c)+d,g=g/(g-d);(d=0<=g&&1>=g)&&b&&b.lerp(a,c,g);return d},intersectsRay:function(a,c){var b=e.sub2(this.point,a.origin),b=this.normal.dot(b)/this.normal.dot(a.direction),f=0<=b;f&&c&&c.copy(a.direction).scale(b).add(a.origin);return f}});
...
l.offset)}switch(l.numComponents){case 1:this.set=b;break;case 2:this.set=a;break;case 3:this.set=c;break;case 4:this.set=d}}function b(a){this.array[this.index]=a}function a(a,c){this.array[this.index]=a;this.array[this.index+1]=c}function c(a,c,b){this.array[this.index]=a;this.array[this.index+1]=c;this.array[this.index+2]=b}function d(a,c,b,d){this.array[this.index]=a;this.array[this.index+1]=c;this.array[this.index+2]=b;this.array[this.index+3]=d}function f(a){this.vertexBuffer=a;this.buffer=
this.vertexBuffer.lock();this.accessors=[];this.element={};a=this.vertexBuffer.getFormat();for(var c=0;c<a.elements.length;c++){var b=a.elements[c];this.accessors[c]=new e(this.buffer,b);this.element[b.name]=this.accessors[c]}}e.prototype.get=function(a){return this.array[this.index+a]};Object.assign(f.prototype,{next:function(a){void 0===a&&(a=1);for(var c=0,b=this.accessors,d=this.accessors.length,f=this.vertexBuffer.getFormat();c<d;){var g=b[c++];g.index+=a*f.size/g.array.constructor.BYTES_PER_ELEMENT}},
...
"inputBuffer",{get:function(){return this._inputBuffer}});Object.defineProperty(e.prototype,"outputBuffer",{get:function(){return this._outputBuffer}});return{TransformFeedback:e}}());Object.assign(pc,function(){var e=function(a,c){this.device=a;this.name=null;this._height=this._width=4;this._depth=1;this._pot=!0;this._format=pc.PIXELFORMAT_R8_G8_B8_A8;this.fixCubemapSeams=this._volume=this._cubemap=this.rgbm=!1;this._flipY=!0;this._premultiplyAlpha=!1;this._mipmaps=!0;this._minFilter=pc.FILTER_LINEAR_MIPMAP_LINEAR;this._magFilter=pc.FILTER_LINEAR;this._anisotropy=1;this._addressW=this._addressV=this._addressU=pc.ADDRESS_REPEAT;this._compareOnRead=!1;this._compareFunc=pc.FUNC_LESS;
void 0!==c&&(this._width=void 0!==c.width?c.width:this._width,this._height=void 0!==c.height?c.height:this._height,this._pot=pc.math.powerOfTwo(this._width)&&pc.math.powerOfTwo(this._height),this._format=void 0!==c.format?c.format:this._format,this.rgbm=void 0!==c.rgbm?c.rgbm:this.rgbm,this._mipmaps=void 0!==c.mipmaps?c.mipmaps:void 0!==c.autoMipmap?c.autoMipmap:this._mipmaps,this._levels=c.levels,this._cubemap=void 0!==c.cubemap?c.cubemap:this._cubemap,this.fixCubemapSeams=void 0!==c.fixCubemapSeams?
c.fixCubemapSeams:this.fixCubemapSeams,this._minFilter=void 0!==c.minFilter?c.minFilter:this._minFilter,this._magFilter=void 0!==c.magFilter?c.magFilter:this._magFilter,this._anisotropy=void 0!==c.anisotropy?c.anisotropy:this._anisotropy,this._addressU=void 0!==c.addressU?c.addressU:this._addressU,this._addressV=void 0!==c.addressV?c.addressV:this._addressV,this._compareOnRead=void 0!==c.compareOnRead?c.compareOnRead:this._compareOnRead,this._compareFunc=void 0!==c._compareFunc?c._compareFunc:this._compareFunc,
this._flipY=void 0!==c.flipY?c.flipY:this._flipY,this._premultiplyAlpha=void 0!==c.premultiplyAlpha?c.premultiplyAlpha:this._premultiplyAlpha,a.webgl2&&(this._depth=void 0!==c.depth?c.depth:this._depth,this._volume=void 0!==c.volume?c.volume:this._volume,this._addressW=void 0!==c.addressW?c.addressW:this._addressW));this._compressed=this._format===pc.PIXELFORMAT_DXT1||this._format===pc.PIXELFORMAT_DXT3||this._format===pc.PIXELFORMAT_DXT5||this._format>=pc.PIXELFORMAT_ETC1;this._invalid=!1;this._lockedLevel=
...
this._height*this._depth*4)}return this._levels[a.level]},setSource:function(a){var c,b=!1,f,g;if(this._cubemap){if(a[0])for(f=a[0].width||0,g=a[0].height||0,c=0;6>c;c++){if(!a[c]||a[c].width!==f||a[c].height!==g||!(a[c]instanceof HTMLImageElement||a[c]instanceof HTMLCanvasElement||a[c]instanceof HTMLVideoElement)){b=!0;break}}else b=!0;if(!b)for(c=0;6>c;c++)this._levels[0][c]!==a[c]&&(this._levelsUpdated[0][c]=!0)}else a instanceof HTMLImageElement||a instanceof HTMLCanvasElement||a instanceof HTMLVideoElement||
(b=!0),b||(a!==this._levels[0]&&(this._levelsUpdated[0]=!0),f=a.width,g=a.height);if(b)if(this._height=this._width=4,this._pot=!0,this._cubemap)for(c=0;6>c;c++)this._levels[0][c]=null,this._levelsUpdated[0][c]=!0;else this._levels[0]=null,this._levelsUpdated[0]=!0;else this._width=f,this._height=g,this._pot=pc.math.powerOfTwo(this._width)&&pc.math.powerOfTwo(this._height),this._levels[0]=a;this._invalid===b&&b||(this._invalid=b,this.upload())},getSource:function(){return this._levels[0]},unlock:function(){this.upload();
this._lockedLevel=-1},upload:function(){this._needsUpload=!0;this._needsMipmapsUpload=this._mipmaps},getDds:function(){this.format!==pc.PIXELFORMAT_R8_G8_B8_A8&&console.error("This format is not implemented yet");for(var a=128,c=0,b,f;this._levels[c];){if(this.cubemap)for(f=0;6>f;f++){if(!this._levels[c][f]){console.error("No level data for mip "+c+", face "+f);return}b=this._levels[c][f].length;if(!b){console.error("No byte array for mip "+c+", face "+f);return}a+=b}else{b=this._levels[c].length;
if(!b){console.error("No byte array for mip "+c);return}a+=b}a+=this._levels[c].length;c++}a=new ArrayBuffer(a);f=new Uint32Array(a,0,32);c=528391;1<this._levels.length&&(c|=131072);b=4096;1<this._levels.length&&(b|=4194304);if(1<this._levels.length||this.cubemap)b|=8;var g=this.cubemap?65024:0;f[0]=542327876;f[1]=124;f[2]=c;f[3]=this.height;f[4]=this.width;f[5]=this.width*this.height*4;f[6]=0;f[7]=this._levels.length;for(c=0;11>c;c++)f[8+c]=0;f[19]=32;f[20]=65;f[21]=0;f[22]=32;f[23]=16711680;f[24]=
65280;f[25]=255;f[26]=4278190080;f[27]=b;f[28]=g;f[29]=0;f[30]=0;f[31]=0;var g=128,l,k;if(this.cubemap)for(f=0;6>f;f++)for(c=0;c<this._levels.length;c++){l=this._levels[c][f];k=new Uint8Array(a,g,l.length);for(b=0;b<l.length;b++)k[b]=l[b];g+=l.length}else for(c=0;c<this._levels.length;c++){l=this._levels[c];k=new Uint8Array(a,g,l.length);for(b=0;b<l.length;b++)k[b]=l[b];g+=l.length}return a}});return{Texture:e}}());Object.assign(pc,function(){var e={depth:!0,face:0},b=function(a,c,b){a instanceof pc.GraphicsDevice?(this._colorBuffer=c,a=b):this._colorBuffer=a.colorBuffer;this._glDepthBuffer=this._glFrameBuffer=null;a=void 0!==a?a:e;this._depthBuffer=a.depthBuffer;this._face=void 0!==a.face?a.face:0;this._depthBuffer?(c=this._depthBuffer._format,c===pc.PIXELFORMAT_DEPTH?(this._depth=!0,this._stencil=!1):this._stencil=c===pc.PIXELFORMAT_DEPTHSTENCIL?this._depth=!0:this._depth=!1):(this._depth=void 0!==a.depth?
a.depth:!0,this._stencil=void 0!==a.stencil?a.stencil:!1);this._samples=void 0!==a.samples?a.samples:1;this.autoResolve=void 0!==a.autoResolve?a.autoResolve:!0;this._glMsaaDepthBuffer=this._glMsaaColorBuffer=this._glResolveFrameBuffer=null};Object.assign(b.prototype,{destroy:function(){if(this._device){var a=this._device,c=a.targets.indexOf(this);-1!==c&&a.targets.splice(c,1);a=a.gl;this._glFrameBuffer&&(a.deleteFramebuffer(this._glFrameBuffer),this._glFrameBuffer=null);this._glDepthBuffer&&(a.deleteRenderbuffer(this._glDepthBuffer),
...
this.pcUniformType[k.SAMPLER_3D]=pc.UNIFORMTYPE_TEXTURE3D);this.targetToSlot={};this.targetToSlot[k.TEXTURE_2D]=0;this.targetToSlot[k.TEXTURE_CUBE_MAP]=1;this.targetToSlot[k.TEXTURE_3D]=2;var p,h,n,q,m;this.commitFunction=[];this.commitFunction[pc.UNIFORMTYPE_BOOL]=function(a,c){a.value!==c&&(k.uniform1i(a.locationId,c),a.value=c)};this.commitFunction[pc.UNIFORMTYPE_INT]=this.commitFunction[pc.UNIFORMTYPE_BOOL];this.commitFunction[pc.UNIFORMTYPE_FLOAT]=function(a,c){a.value!==c&&(k.uniform1f(a.locationId,
c),a.value=c)};this.commitFunction[pc.UNIFORMTYPE_VEC2]=function(a,c){m=a.value;p=c[0];h=c[1];if(m[0]!==p||m[1]!==h)k.uniform2fv(a.locationId,c),m[0]=p,m[1]=h};this.commitFunction[pc.UNIFORMTYPE_VEC3]=function(a,c){m=a.value;p=c[0];h=c[1];n=c[2];if(m[0]!==p||m[1]!==h||m[2]!==n)k.uniform3fv(a.locationId,c),m[0]=p,m[1]=h,m[2]=n};this.commitFunction[pc.UNIFORMTYPE_VEC4]=function(a,c){m=a.value;p=c[0];h=c[1];n=c[2];q=c[3];if(m[0]!==p||m[1]!==h||m[2]!==n||m[3]!==q)k.uniform4fv(a.locationId,c),m[0]=p,m[1]=
h,m[2]=n,m[3]=q};this.commitFunction[pc.UNIFORMTYPE_IVEC2]=function(a,c){m=a.value;p=c[0];h=c[1];if(m[0]!==p||m[1]!==h)k.uniform2iv(a.locationId,c),m[0]=p,m[1]=h};this.commitFunction[pc.UNIFORMTYPE_BVEC2]=this.commitFunction[pc.UNIFORMTYPE_IVEC2];this.commitFunction[pc.UNIFORMTYPE_IVEC3]=function(a,c){m=a.value;p=c[0];h=c[1];n=c[2];if(m[0]!==p||m[1]!==h||m[2]!==n)k.uniform3iv(a.locationId,c),m[0]=p,m[1]=h,m[2]=n};this.commitFunction[pc.UNIFORMTYPE_BVEC3]=this.commitFunction[pc.UNIFORMTYPE_IVEC3];
this.commitFunction[pc.UNIFORMTYPE_IVEC4]=function(a,c){m=a.value;p=c[0];h=c[1];n=c[2];q=c[3];if(m[0]!==p||m[1]!==h||m[2]!==n||m[3]!==q)k.uniform4iv(a.locationId,c),m[0]=p,m[1]=h,m[2]=n,m[3]=q};this.commitFunction[pc.UNIFORMTYPE_BVEC4]=this.commitFunction[pc.UNIFORMTYPE_IVEC4];this.commitFunction[pc.UNIFORMTYPE_MAT2]=function(a,c){k.uniformMatrix2fv(a.locationId,!1,c)};this.commitFunction[pc.UNIFORMTYPE_MAT3]=function(a,c){k.uniformMatrix3fv(a.locationId,!1,c)};this.commitFunction[pc.UNIFORMTYPE_MAT4]=
function(a,c){k.uniformMatrix4fv(a.locationId,!1,c)};this.commitFunction[pc.UNIFORMTYPE_FLOATARRAY]=function(a,c){k.uniform1fv(a.locationId,c)};this.scope=new pc.ScopeSpace("Device");this.programLib=new pc.ProgramLibrary(this);for(var r in pc.programlib)this.programLib.register(r,pc.programlib[r]);pc.events.attach(this);this.supportsBoneTextures=this.extTextureFloat&&0<this.maxVertexTextures;this.useTexCubeLod=this.extTextureLod&&16>this.maxTextures;this.boneLimit=Math.floor((this.vertexUniformsCount-
...
a)}},uploadTexture:function(a){var c=this.gl;if(a._needsUpload||!(a._needsMipmapsUpload&&a._mipmapsUploaded||!a._pot)){for(var f=0,g,l;a._levels[f]||0===f;){if(a._needsUpload||0!==f){if(f&&(!a._needsMipmapsUpload||!a._mipmaps))break;g=a._levels[f];1!=f||a._compressed||(c.generateMipmap(a._glTarget),a._mipmapsUploaded=!0);if(a._cubemap){var k;if(g[0]instanceof HTMLCanvasElement||g[0]instanceof HTMLImageElement||g[0]instanceof HTMLVideoElement)for(k=0;6>k;k++)a._levelsUpdated[0][k]&&(l=g[k],l instanceof
HTMLImageElement&&(l.width>this.maxCubeMapSize||l.height>this.maxCubeMapSize)&&(l=b(l,this.maxCubeMapSize),0===f&&(a.width=l.width,a.height=l.height)),this.setUnpackFlipY(!1),this.setUnpackPremultiplyAlpha(a._premultiplyAlpha),c.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+k,f,a._glInternalFormat,a._glFormat,a._glPixelType,l));else for(l=1/Math.pow(2,f),k=0;6>k;k++)if(a._levelsUpdated[0][k]){var e=g[k];a._compressed?c.compressedTexImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+k,f,a._glInternalFormat,Math.max(a._width*
l,1),Math.max(a._height*l,1),0,e):(this.setUnpackFlipY(!1),this.setUnpackPremultiplyAlpha(a._premultiplyAlpha),c.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+k,f,a._glInternalFormat,Math.max(a._width*l,1),Math.max(a._height*l,1),0,a._glFormat,a._glPixelType,e))}}else a._volume?(l=1/Math.pow(2,f),a._compressed?c.compressedTexImage3D(c.TEXTURE_3D,f,a._glInternalFormat,Math.max(a._width*l,1),Math.max(a._height*l,1),Math.max(a._depth*l,1),0,g):(this.setUnpackFlipY(!1),this.setUnpackPremultiplyAlpha(a._premultiplyAlpha),
...
this.gl,c=a.definition,g=this.compileShaderSource(c.vshader,!0),l=this.compileShaderSource(c.fshader,!1),k=b.createProgram();b.attachShader(k,g);b.attachShader(k,l);if(this.webgl2&&c.useTransformFeedback){var c=c.attributes,e=[],h;for(h in c)c.hasOwnProperty(h)&&e.push("out_"+h);b.transformFeedbackVaryings(k,e,b.INTERLEAVED_ATTRIBS)}b.linkProgram(k);a._glVertexShader=g;a._glFragmentShader=l;a._glProgram=k},createShader:function(a){this.compileAndLinkShader(a);this.shaders.push(a)},destroyShader:function(a){var b=
...
d);return new pc.Shader(a,{attributes:c,vshader:b,fshader:d,useTransformFeedback:f})};e.createShaderFromCode=function(a,b,d,f,g){var c=a.programLib._cache,k=c[f];if(void 0!==k)return k;d=pc.programlib.precisionCode(a)+"\n"+(d||pc.programlib.dummyFragmentCode());k=this.collectAttribs(b);a.webgl2&&(b=pc.programlib.versionCode(a)+this.gles3VS+b,d=pc.programlib.versionCode(a)+this.gles3PS+d);c[f]=new pc.Shader(a,{attributes:k,vshader:b,fshader:d,useTransformFeedback:g});return c[f]};return{shaderChunks:e}}());Object.assign(pc,function(){var e=null,b={type:pc.PRIMITIVE_TRISTRIP,base:0,count:4,indexed:!1};return{drawQuadWithShader:function(a,c,d,f,g,l){if(null===e){var k=new pc.VertexFormat(a,[{semantic:pc.SEMANTIC_POSITION,components:2,type:pc.TYPE_FLOAT32}]);e=new pc.VertexBuffer(a,k,4);k=new pc.VertexIterator(e);k.element[pc.SEMANTIC_POSITION].set(-1,-1);k.next();k.element[pc.SEMANTIC_POSITION].set(1,-1);k.next();k.element[pc.SEMANTIC_POSITION].set(-1,1);k.next();k.element[pc.SEMANTIC_POSITION].set(1,
1);k.end()}k=a.renderTarget;a.setRenderTarget(c);a.updateBegin();var p,h,n,q,m,r,t,v;f?(p=f.x,h=f.y,n=f.z,q=f.w):(n=c?c.width:a.width,q=c?c.height:a.height,h=p=0);g?(m=g.x,r=g.y,t=g.z,v=g.w):(m=p,r=h,t=n,v=q);g=a.vx;f=a.vy;c=a.vw;var y=a.vh;a.setViewport(p,h,n,q);n=a.sx;p=a.sy;h=a.sw;q=a.sh;a.setScissor(m,r,t,v);m=a.getDepthTest();r=a.getDepthWrite();t=a.getCullMode();v=a.writeRed;var u=a.writeGreen,w=a.writeBlue,x=a.writeAlpha;a.setDepthTest(!1);a.setDepthWrite(!1);a.setCullMode(pc.CULLFACE_NONE);
a.setColorWrite(!0,!0,!0,!0);l||a.setBlending(!1);a.setVertexBuffer(e,0);a.setShader(d);a.draw(b);a.setDepthTest(m);a.setDepthWrite(r);a.setCullMode(t);a.setColorWrite(v,u,w,x);a.updateEnd();a.setRenderTarget(k);a.updateBegin();a.setViewport(g,f,c,y);a.setScissor(n,p,h,q)},destroyPostEffectQuad:function(){e&&(e.destroy(),e=null)}}}());Object.assign(pc,function(){function e(a,b,d){var c=b._colorBuffer;if(c.format==pc.PIXELFORMAT_R8_G8_B8_A8){var g=new Uint8Array(c.width*c.height*4),l=a.gl;a.setFramebuffer(b._glFrameBuffer);l.readPixels(0,0,c.width,c.height,l.RGBA,l.UNSIGNED_BYTE,g);c._levels||(c._levels=[]);c._levels[0]||(c._levels[0]=[]);c._levels[0][d]=g}}function b(a,b){return Math.atan2(a*b,Math.sqrt(a*a+b*b+1))}return{prefilterCubemap:function(a){var b=a.device,d=a.sourceCubemap,f=a.method,g=a.samples,l=a.cpuSync;if(l&&!d._levels[0])console.error("ERROR: prefilter: cubemap must have _levels");
else{var k=pc.shaderChunks,p=d.rgbm,g=k.createShaderFromCode(b,k.fullscreenQuadVS,k.rgbmPS+k.prefilterCubemapPS.replace(/\$METHOD/g,0===f?"cos":"phong").replace(/\$NUMSAMPLES/g,g).replace(/\$textureCube/g,p?"textureCubeRGBM":"textureCube"),"prefilter"+f+""+g+""+p),h=k.createShaderFromCode(b,k.fullscreenQuadVS,k.outputCubemapPS,"outputCubemap"),n=b.scope.resolve("source"),q=b.scope.resolve("params"),m=new pc.Vec4,r=d.width,k=d.format,t=[[],a.filteredFixed,a.filteredRgbm,a.filteredFixedRgbm],v=0===
f?[.9,.85,.7,.4,.25]:[512,128,32,8,2],y=[64,32,16,8,4],u,w,x;w=k===pc.PIXELFORMAT_R8_G8_B8;u=!1;var D;l&&(u=d._levels[0][0]instanceof HTMLImageElement);if((w||u)&&l){k=pc.PIXELFORMAT_R8_G8_B8_A8;D=new pc.Texture(b,{cubemap:!0,rgbm:p,format:k,width:r,height:r,mipmaps:!1});D.name="prefiltered-cube";for(x=0;6>x;x++)u=new pc.RenderTarget(b,D,{face:x,depth:!1}),m.x=x,m.y=0,n.setValue(d),q.setValue(m.data),pc.drawQuadWithShader(b,u,h),e(b,u,x);d=D}if(128<r){var z=Math.round(Math.log2(r))-Math.round(Math.log2(128));
for(w=0;w<z;w++){var r=.5*d.width,C=0===f?1:Math.pow(2,Math.round(Math.log2(v[0])+2*(z-w)));D=new pc.Texture(b,{cubemap:!0,rgbm:p,format:k,width:r,height:r,mipmaps:!1});D.name="prefiltered-cube";for(x=0;6>x;x++)u=new pc.RenderTarget(b,D,{face:x,depth:!1}),m.x=x,m.y=C,m.z=r,m.w=p?3:0,n.setValue(d),q.setValue(m.data),pc.drawQuadWithShader(b,u,h),w===z-1&&l&&e(b,u,x);d=D}}a.sourceCubemap=d;D=null;if(!p&&a.filteredFixedRgbm)for(D=new pc.Texture(b,{cubemap:!0,rgbm:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,
width:r,height:r,mipmaps:!1}),D.name="prefiltered-cube",x=0;6>x;x++)u=new pc.RenderTarget(b,D,{face:x,depth:!1}),m.x=x,m.w=2,n.setValue(d),q.setValue(m.data),pc.drawQuadWithShader(b,u,h),e(b,u,x);r=0===f?1:2048;u=0===f?0:-1;t[u]=[];for(w=0;5>w;w++)for(h=u;h<t.length;h++)null!=t[h]&&(t[h][w]=new pc.Texture(b,{cubemap:!0,rgbm:2>h?p:!0,format:2>h?k:pc.PIXELFORMAT_R8_G8_B8_A8,fixCubemapSeams:1===h||3===h,width:y[w],height:y[w],mipmaps:!1}),t[h][w].name="prefiltered-cube");for(h=u;h<t.length;h++)if(null!=
t[h])if(1<h&&p)t[h]=t[h-2];else for(w=0;5>w;w++)for(x=0;6>x;x++)u=new pc.RenderTarget(b,t[h][w],{face:x,depth:!1}),m.x=x,m.y=0>h?r:v[w],m.z=y[w],m.w=p?3:h,n.setValue(0===w?d:0===f?t[0][w-1]:t[-1][w-1]),q.setValue(m.data),pc.drawQuadWithShader(b,u,g),l&&e(b,u,x);a.filtered=t[0];if(l&&a.singleFilteredFixed){d=[d,a.filteredFixed[0],a.filteredFixed[1],a.filteredFixed[2],a.filteredFixed[3],a.filteredFixed[4],a.filteredFixed[5]];p=new pc.Texture(b,{cubemap:!0,rgbm:p,fixCubemapSeams:!0,format:k,width:128,
...
g.gl;d=pc.shaderChunks;var k=d.createShaderFromCode(g,d.fullscreenQuadVS,d.fullscreenQuadPS,"fsQuadSimple"),e=g.scope.resolve("source");for(d=0;6>d;d++){var h=a._levels[0][d],n=new pc.Texture(g,{cubemap:!1,rgbm:!1,format:a.format,width:f,height:f,mipmaps:!1});n.name="prefiltered-cube";n._levels[0]=h;n.upload();h=new pc.Texture(g,{cubemap:!1,rgbm:!1,format:a.format,width:f,height:f,mipmaps:!1});h.name="prefiltered-cube";h=new pc.RenderTarget(g,h,{depth:!1});e.setValue(n);pc.drawQuadWithShader(g,h,
k);var q=new Uint8Array(f*f*4);l.bindFramebuffer(l.FRAMEBUFFER,h._glFrameBuffer);l.readPixels(0,0,n.width,n.height,l.RGBA,l.UNSIGNED_BYTE,q);a._levels[0][d]=q}}else{console.error("ERROR: SH: cubemap must be composed of arrays or images");return}k=[];for(l=0;l<f;l++)for(g=0;g<f;g++)k[l*f+g]=(new pc.Vec3(g/(f-1)*2-1,l/(f-1)*2-1,1)).normalize();var e=new Float32Array(27),m,r,t,v,y,u,w,x,D,z,C;for(d=h=0;6>d;d++)for(l=0;l<f;l++)for(g=0;g<f;g++){n=l*f+g;q=g;w=l;x=f;r=(2*(q+.5)/x-1)*(1-1/x);C=(2*(w+.5)/
...
8*r,t*=t):t=Math.pow(t,2.2),e[0+m]+=t*w,e[3+m]+=t*x*v,e[6+m]+=t*x*y,e[9+m]+=t*x*u,e[12+m]+=t*D*v*u,e[15+m]+=t*D*u*y,e[18+m]+=t*D*y*v,e[21+m]+=t*z*(3*u*u-1),e[24+m]+=t*C*(v*v-y*y),h+=q}for(m=0;m<e.length;m++)e[m]*=4*Math.PI/h;return e}console.error("ERROR: SH: cubemap must be synced to CPU")}}}}());Object.assign(pc,function(){return{paraboloidFromCubemap:function(e,b,a,c){var d=pc.shaderChunks,d=d.createShaderFromCode(e,d.fullscreenQuadVS,(b.fixCubemapSeams?d.fixCubemapSeamsStretchPS:d.fixCubemapSeamsNonePS)+d.genParaboloidPS,"genParaboloid"),f=e.scope.resolve("source"),g=e.scope.resolve("params"),l=new pc.Vec4,k=b.width,p=b.rgbm,h=b.format,k=2*Math.max(k,8),k=new pc.Texture(e,{rgbm:p,format:h,width:2*k,height:k,mipmaps:!1});k.name="paraboloid";p=new pc.RenderTarget(e,k,{depth:!1});l.x=a;l.y=
c?-1:1;f.setValue(b);g.setValue(l.data);pc.drawQuadWithShader(e,p,d);return k},generateDpAtlas:function(e,b,a){var c,d;d=new pc.Vec4;var f=new pc.Vec4,g=4*b[0].width,l=pc.shaderChunks,l=l.createShaderFromCode(e,l.fullscreenQuadVS,l.dpAtlasQuadPS,"dpAtlasQuad"),k=e.scope.resolve("source"),p=e.scope.resolve("params"),h=new pc.Texture(e,{rgbm:b[0].rgbm,format:b[0].format,width:g,height:g,mipmaps:!1});h.name="paraboloid";for(var n=new pc.RenderTarget(e,h,{depth:!1}),q=(g+2)/g-1,m=0;6>m;m++){c=pc.paraboloidFromCubemap(e,
b[m],m,a);k.setValue(c);c=d;var r=m;c.x=.5*pc.math.clamp(r-2,0,1);var r=r-6*c.x,t=1-c.x;c.y=Math.min(.5*r,.75)*t+c.x;c.z=(1-.5*pc.math.clamp(r,0,1))*t;c.w=.5*c.z;c=1/c.z;f.x=c*q;f.y=2*f.x;f.x+=1;f.y+=1;p.setValue(f.data);d.x*=g;d.y*=g;d.z*=g;d.w*=g;pc.drawQuadWithShader(e,n,l,d)}return h}}}());pc.shaderChunks.TBNPS="void getTBN() {\n    dTBN = mat3(normalize(dTangentW), normalize(dBinormalW), normalize(dVertexNormalW));\n}\n";pc.shaderChunks.TBNderivativePS="// http://www.thetenthplanet.de/archives/1180\nvoid getTBN() {\n    vec2 uv = $UV;\n    // get edge vectors of the pixel triangle\n    vec3 dp1 = dFdx( vPositionW );\n    vec3 dp2 = dFdy( vPositionW );\n    vec2 duv1 = dFdx( uv );\n    vec2 duv2 = dFdy( uv );\n    // solve the linear system\n    vec3 dp2perp = cross( dp2, dVertexNormalW );\n    vec3 dp1perp = cross( dVertexNormalW, dp1 );\n    vec3 T = dp2perp * duv1.x + dp1perp * duv2.x;\n    vec3 B = dp2perp * duv1.y + dp1perp * duv2.y;\n    // construct a scale-invariant frame\n    float invmax = 1.0 / sqrt( max( dot(T,T), dot(B,B) ) );\n    dTBN = mat3( T * invmax, B * invmax, dVertexNormalW );\n}\n";
...
0<=r.indexOf("vertex_color")&&(t.vertex_color=pc.SEMANTIC_COLOR),0<=r.indexOf("vertex_boneWeights")&&(t.vertex_boneWeights=pc.SEMANTIC_BLENDWEIGHT),0<=r.indexOf("vertex_boneIndices")&&(t.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES),v[c]=r):v[c]=m[c]);for(c in b.chunks)(m=this._oldChunkToNew[c])&&(v[m.n]=m.f(b.chunks[c],m.n,c));m=v}h=this._vsAddBaseCode(h,e,m,b);v=-1;if(!b.noShadow&&!b.twoSidedLighting){for(a=0;a<b.lights.length;a++)if(r=b.lights[a]._type,b.lights[a].castShadows&&r===pc.LIGHTTYPE_DIRECTIONAL){h+=
...
t.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES,h+=pc.programlib.skinCode(e,m),h+="#define SKIN\n"):b.useInstancing&&(h+="#define INSTANCING\n");b.screenSpace&&(h+="#define SCREENSPACE\n");b.pixelSnap&&(h+="#define PIXELSNAP\n");h=this._vsAddTransformCode(h,e,m,b);k&&(h+=m.normalVS);h=h+"\n"+m.startVS;c=h=h+n+"}";r=q;q=""+this._addVaryingIfNeeded(h,"vec4","vMainShadowUv");q+=this._addVaryingIfNeeded(h,"vec4","vVertexColor");q+=this._addVaryingIfNeeded(h,"vec3","vPositionW");q+=this._addVaryingIfNeeded(h,
"vec3","vNormalV");q+=this._addVaryingIfNeeded(h,"vec3","vNormalW");q+=this._addVaryingIfNeeded(h,"vec3","vTangentW");q+=this._addVaryingIfNeeded(h,"vec3","vBinormalW");q+=this._addVaryingIfNeeded(h,"vec2","vUv0");q+=this._addVaryingIfNeeded(h,"vec2","vUv1");q+=r;c=q+c;h="";e.webgl2?(h=pc.programlib.versionCode(e),m.extensionVS&&(h+=m.extensionVS+"\n"),c=h+m.gles3VS+c):(m.extensionVS&&(h=m.extensionVS+"\n"),c=h+c);b.forceFragmentPrecision&&"highp"!=b.forceFragmentPrecision&&"mediump"!==b.forceFragmentPrecision&&
"lowp"!==b.forceFragmentPrecision&&(b.forceFragmentPrecision=null);b.forceFragmentPrecision&&("highp"===b.forceFragmentPrecision&&"highp"!==e.maxPrecision&&(b.forceFragmentPrecision="mediump"),"mediump"===b.forceFragmentPrecision&&"lowp"===e.maxPrecision&&(b.forceFragmentPrecision="lowp"));h="";e.webgl2&&(h+=pc.programlib.versionCode(e));e.extStandardDerivatives&&!e.webgl2&&(h+="#extension GL_OES_standard_derivatives : enable\n\n");m.extensionPS&&(h+=m.extensionPS+"\n");e.webgl2&&(h+=m.gles3PS);h+=
...
m.reflectionSpherePS:m.reflectionSphereLowPS,r=r.replace(/\$texture2DSAMPLE/g,b.rgbmReflection?"texture2DRGBM":b.hdrReflection?"texture2D":"texture2DSRGB"),h+=r):f?h=b.prefilteredCubemap?l?h+m.reflectionPrefilteredCubeLodPS.replace(/\$DECODE/g,r):h+m.reflectionPrefilteredCubePS.replace(/\$DECODE/g,r):h+m.reflectionCubePS.replace(/\$textureCubeSAMPLE/g,b.rgbmReflection?"textureCubeRGBM":b.hdrReflection?"textureCube":"textureCubeSRGB"):b.dpAtlas&&(h+=m.reflectionDpAtlasPS.replace(/\$texture2DSAMPLE/g,
b.rgbmReflection?"texture2DRGBM":b.hdrReflection?"texture2D":"texture2DSRGB"));(f||b.sphereMap||b.dpAtlas)&&b.refraction&&(h+=m.refractionPS);0<y&&(w[pc.SHADOW_PCF3]&&(h+=m.shadowStandardPS),w[pc.SHADOW_PCF5]&&(h+=m.shadowStandardGL2PS),x&&(h+=m.shadowVSM_commonPS,w[pc.SHADOW_VSM8]&&(h+=m.shadowVSM8PS),w[pc.SHADOW_VSM16]&&(h+=e.extTextureHalfFloatLinear?m.shadowEVSMPS.replace(/\$/g,"16"):m.shadowEVSMnPS.replace(/\$/g,"16")),w[pc.SHADOW_VSM32]&&(h+=e.extTextureFloatLinear?m.shadowEVSMPS.replace(/\$/g,
"32"):m.shadowEVSMnPS.replace(/\$/g,"32"))),e.webgl2||e.extStandardDerivatives||(h+=m.biasConstPS),h+=m.shadowCoordPS+m.shadowCommonPS,u&&(h+=m.shadowCoordPerspZbufferPS),0<=v&&(w[pc.SHADOW_PCF3]&&(h+=m.shadowStandardVSPS),w[pc.SHADOW_PCF5]&&(h+=m.shadowStandardGL2VSPS),x&&(w[pc.SHADOW_VSM8]&&(h+=m.shadowVSMVSPS.replace(/\$VSM/g,"VSM8").replace(/\$/g,"8")),w[pc.SHADOW_VSM16]&&(h+=m.shadowVSMVSPS.replace(/\$VSM/g,"VSM16").replace(/\$/g,"16")),w[pc.SHADOW_VSM32]&&(h+=m.shadowVSMVSPS.replace(/\$VSM/g,
"VSM32").replace(/\$/g,"32")))));d&&(h+=m.lightDiffuseLambertPS);r=!1;b.useSpecular?(d&&(h+=b.shadingModel===pc.SPECULAR_PHONG?m.lightSpecularPhongPS:m.lightSpecularBlinnPS),b.sphereMap||f||b.dpAtlas||0<b.fresnelModel?h=0<b.fresnelModel?b.conserveEnergy?h+m.combineDiffuseSpecularPS:h+m.combineDiffuseSpecularNoConservePS:h+m.combineDiffuseSpecularOldPS:b.diffuseMap?h+=m.combineDiffuseSpecularNoReflPS:(h+=m.combineDiffuseSpecularNoReflSeparateAmbientPS,r=!0)):h+=m.combineDiffusePS;a=!0;if(b.lightMap||
...
n.castShadows&&!b.noShadow&&(n._shadowType===pc.SHADOW_VSM8?(k="VSM8",D="0.0"):n._shadowType===pc.SHADOW_VSM16?(k="VSM16",D="5.54"):n._shadowType===pc.SHADOW_VSM32?(k="VSM32",D=e.textureFloatHighPrecision?"15.0":"5.54"):k=n._shadowType===pc.SHADOW_PCF5?"PCF5x5":"PCF3x3",null!==k&&(r===pc.LIGHTTYPE_POINT?(d="(light"+a+"_shadowMap, light"+a+"_shadowParams);\n",n._normalOffsetBias&&(h+="       normalOffsetPointShadow(light"+a+"_shadowParams);\n"),h+="       dAtten *= getShadowPoint"+k+d):(v===a?k+="VS":
(d="(light"+a+"_shadowMatrix, light"+a+"_shadowParams);\n",h+=this._nonPointShadowMapProjection(e,b.lights[a],d)),r===pc.LIGHTTYPE_SPOT&&(k="Spot"+k),h+="       dAtten *= getShadow"+k+"(light"+a+"_shadowMap, light"+a+"_shadowParams"+(n._isVsm?", "+D:"")+");\n"))),h+="       dDiffuseLight += dAtten * light"+a+"_color"+(g?" * dAtten3":"")+";\n",b.useSpecular&&(h+="       dAtten *= getLightSpecular();\n",h+="       dSpecularLight += dAtten * light"+a+"_color"+(g?" * dAtten3":"")+";\n"),r!==pc.LIGHTTYPE_DIRECTIONAL&&
...
-1);b.next();b.element[pc.SEMANTIC_POSITION].set(1,-1);b.next();b.element[pc.SEMANTIC_POSITION].set(-1,1);b.next();b.element[pc.SEMANTIC_POSITION].set(1,1);b.end();return a},drawFullscreenQuad:function(a,b,d,f,g){var c=a.getRenderTarget();a.setRenderTarget(b);a.updateBegin();var k=null!==b?b.width:a.width,p=null!==b?b.height:a.height,h=0,n=0;g&&(h=g.x*k,n=g.y*p,k*=g.z,p*=g.w);g=a.vx;b=a.vy;var q=a.vw,m=a.vh;a.setViewport(h,n,k,p);var r=a.sx,t=a.sy,v=a.sw,y=a.sh;a.setScissor(h,n,k,p);var k=a.getBlending(),
p=a.getDepthTest(),h=a.getDepthWrite(),n=a.getCullMode(),u=a.writeRed,w=a.writeGreen,x=a.writeBlue,D=a.writeAlpha;a.setBlending(!1);a.setDepthTest(!1);a.setDepthWrite(!1);a.setCullMode(pc.CULLFACE_NONE);a.setColorWrite(!0,!0,!0,!0);a.setVertexBuffer(d,0);a.setShader(f);a.draw(e);a.setBlending(k);a.setDepthTest(p);a.setDepthWrite(h);a.setCullMode(n);a.setColorWrite(u,w,x,D);a.updateEnd();a.setRenderTarget(c);a.updateBegin();a.setViewport(g,b,q,m);a.setScissor(r,t,v,y)}}}());(function(){var e={BLEND_SUBTRACTIVE:0,BLEND_ADDITIVE:1,BLEND_NORMAL:2,BLEND_NONE:3,BLEND_PREMULTIPLIED:4,BLEND_MULTIPLICATIVE:5,BLEND_ADDITIVEALPHA:6,BLEND_MULTIPLICATIVE2X:7,BLEND_SCREEN:8,BLEND_MIN:9,BLEND_MAX:10,FOG_NONE:"none",FOG_LINEAR:"linear",FOG_EXP:"exp",FOG_EXP2:"exp2",FRESNEL_NONE:0,FRESNEL_SCHLICK:2,LAYER_HUD:0,LAYER_GIZMO:1,LAYER_FX:2,LAYER_WORLD:15,LAYERID_WORLD:0,LAYERID_DEPTH:1,LAYERID_SKYBOX:2,LAYERID_IMMEDIATE:3,LAYERID_UI:4,LIGHTTYPE_DIRECTIONAL:0,LIGHTTYPE_POINT:1,LIGHTTYPE_SPOT:2,
...
g.clearColor[1]=1,g.clearColor[2]=1,g.clearColor[3]=1);g.clearDepth=1;g.clearFlags=d;g.clearStencil=null;g._node=new pc.GraphNode;c=b._shadowCamera=g;f(a,b)}else d=c.renderTarget,d.width===b._shadowResolution&&d.height===b._shadowResolution||f(a,b);return c},updateCameraFrustum:function(a){if(a.vrDisplay&&a.vrDisplay.presenting){D=a.vrDisplay.combinedProj;var b=a._node.getParent();b?u.copy(b.getWorldTransform()).mul(a.vrDisplay.combinedViewInv).invert():u.copy(a.vrDisplay.combinedView);y.copy(u).invert();
this.viewInvId.setValue(y.data)}else{D=a.getProjectionMatrix();a.overrideCalculateProjection&&a.calculateProjection(D,pc.VIEW_CENTER);if(a.overrideCalculateTransform)a.calculateTransform(y,pc.VIEW_CENTER);else{var b=a._node.getPosition(),c=a._node.getRotation();y.setTRS(b,c,pc.Vec3.ONE);this.viewInvId.setValue(y.data)}u.copy(y).invert()}a.frustum.update(D,u)},setCamera:function(a,b,c,d){var f=a.vrDisplay;if(f&&f.presenting){H=f.leftProj;E=f.rightProj;D=f.combinedProj;a.overrideCalculateProjection&&
(a.calculateProjection(H,pc.VIEW_LEFT),a.calculateProjection(E,pc.VIEW_RIGHT),a.calculateProjection(D,pc.VIEW_CENTER));if(a.overrideCalculateTransform)a.calculateTransform(z,pc.VIEW_LEFT),a.calculateTransform(C,pc.VIEW_RIGHT),a.calculateTransform(y,pc.VIEW_CENTER),A.copy(z).invert(),B.copy(C).invert(),u.copy(y).invert();else{var g=a._node.getParent();if(g){var k=g.getWorldTransform();z.mul2(k,f.leftViewInv);C.mul2(k,f.rightViewInv);A.copy(z).invert();B.copy(C).invert();u.copy(g.getWorldTransform()).mul(f.combinedViewInv).invert()}else z.copy(f.leftViewInv),
C.copy(f.rightViewInv),A.copy(f.leftView),B.copy(f.rightView),u.copy(f.combinedView)}l(G,A);l(I,B);Q.mul2(H,A);V.mul2(E,B);J.x=z.data[12];J.y=z.data[13];J.z=z.data[14];F.x=C.data[12];F.y=C.data[13];F.z=C.data[14]}else D=a.getProjectionMatrix(),a.overrideCalculateProjection&&a.calculateProjection(D,pc.VIEW_CENTER),this.projId.setValue(D.data),a.overrideCalculateTransform?a.calculateTransform(y,pc.VIEW_CENTER):(f=a._node.getPosition(),g=a._node.getRotation(),y.setTRS(f,g,pc.Vec3.ONE)),this.viewInvId.setValue(y.data),
u.copy(y).invert(),this.viewId.setValue(u.data),l(w,u),this.viewId3.setValue(w.data),x.mul2(D,u),this.viewProjId.setValue(x.data),f=a._node.getPosition(),this.viewPos[0]=f.x,this.viewPos[1]=f.y,this.viewPos[2]=f.z,this.viewPosId.setValue(this.viewPos);a.frustum.update(D,u);this.nearClipId.setValue(a._nearClip);this.farClipId.setValue(a._farClip);this.cameraParamsId.setValue(a._shaderParams);f=this.device;f.setRenderTarget(b);f.updateBegin();k=a.getRect();g=b?b.width:f.width;b=b?b.height:f.height;
var e=Math.floor(k.x*g),h=Math.floor(k.y*b),p=Math.floor(k.width*g),k=Math.floor(k.height*b);f.setViewport(e,h,p,k);f.setScissor(e,h,p,k);c&&f.clear(a._clearOptions);k=a._scissorRect;e=Math.floor(k.x*g);h=Math.floor(k.y*b);p=Math.floor(k.width*g);k=Math.floor(k.height*b);f.setScissor(e,h,p,k);d&&f.setScissor(1,1,g-2,b-2)},dispatchGlobalLights:function(a){var b;this.mainLight=-1;this.ambientColor[0]=a.ambientLight.r;this.ambientColor[1]=a.ambientLight.g;this.ambientColor[2]=a.ambientLight.b;if(a.gammaCorrection)for(b=
...
"_positionVS");this.lightCookieId[b]=a.resolve(c+"_cookie");this.lightCookieIntId[b]=a.resolve(c+"_cookieIntensity");this.lightCookieMatrixId[b]=a.resolve(c+"_cookieMatrix");this.lightCookieOffsetId[b]=a.resolve(c+"_cookieOffset")},dispatchDirectLights:function(a,b,c){var d=a.length,f,g,l,k=0;this.mainLight=-1;var e=this.device.scope;for(f=0;f<d;f++)if(a[f]._mask&c){g=a[f];l=g._node.getWorldTransform();this.lightColorId[k]||this._resolveLight(e,k);this.lightColorId[k].setValue(b.gammaCorrection?g._linearFinalColor:
...
c._cookieOffsetUniform[1]=c._cookieOffset.y,this.lightCookieOffsetId[d].setValue(c._cookieOffsetUniform)))},dispatchLocalLights:function(a,b,c,d,f){var g,l=a[pc.LIGHTTYPE_POINT];a=a[pc.LIGHTTYPE_SPOT];var k=l.length,e=a.length,h=d,p=this.device.scope;for(d=0;d<k;d++)g=l[d],g._mask&c&&!g.isStatic&&(this.dispatchPointLight(b,p,g,h),h++);l=0;if(f)for(g=f[l];g&&g._type===pc.LIGHTTYPE_POINT;)this.dispatchPointLight(b,p,g,h),h++,l++,g=f[l];for(d=0;d<e;d++)g=a[d],g._mask&c&&!g.isStatic&&(this.dispatchSpotLight(b,
p,g,h),h++);if(f)for(g=f[l];g&&g._type===pc.LIGHTTYPE_SPOT;)this.dispatchSpotLight(b,p,g,h),h++,l++,g=f[l]},cull:function(a,b,c){var d=0,f,g,l,k=b.length,e=a.cullingMask||4294967295;if(!a.frustumCulling){for(f=0;f<k;f++)if(g=b[f],g.visible||g.command)g.mask&&0===(g.mask&e)||(c[d]=g,d++,g.visibleThisFrame=!0);return d}for(f=0;f<k;f++)g=b[f],g.command?(c[d]=g,d++,g.visibleThisFrame=!0):g.visible&&(l=!0,g.mask&&0===(g.mask&e)||(g.cull&&(l=this._isVisible(a,g)),l&&(c[d]=g,d++,g.visibleThisFrame=!0)));
...
null,P.count-1}else return a.draw(c.primitive[d]),0},renderShadows:function(a,b){var f=this.device,g,l,e,n,v,u,w,y,E,x,J,H,G,F,C=1<<pc.SHADER_SHADOW,z,A;for(g=0;g<a.length;g++)if(e=a[g],v=e._type,e.castShadows&&e._enabled&&(e._shadowCamera||this.getShadowCamera(f,e),e.shadowUpdateMode!==pc.SHADOWUPDATE_NONE&&e.visibleThisFrame)){u=this.getShadowCamera(f,e);w=u._node;y=0;E=1;if(v===pc.LIGHTTYPE_DIRECTIONAL){if(0>e._visibleLength[b])continue;y=e._visibleCameraSettings[b];w.setPosition(y.x,y.y,y.z);
u.orthoHeight=y.orthoHeight;u.farClip=y.farClip;y=b}else v===pc.LIGHTTYPE_SPOT?(F=w.getPosition(),this.viewPos[0]=F.x,this.viewPos[1]=F.y,this.viewPos[2]=F.z,this.viewPosId.setValue(this.viewPos),this.shadowMapLightRadiusId.setValue(e.attenuationEnd)):v===pc.LIGHTTYPE_POINT&&(F=w.getPosition(),this.viewPos[0]=F.x,this.viewPos[1]=F.y,this.viewPos[2]=F.z,this.viewPosId.setValue(this.viewPos),this.shadowMapLightRadiusId.setValue(e.attenuationEnd),E=6);v!==pc.LIGHTTYPE_POINT&&(r.setTRS(w.getPosition(),
w.getRotation(),pc.Vec3.ONE).invert(),t.mul2(u.getProjectionMatrix(),r),e._shadowMatrix.mul2(k,t));f.webgl2?v===pc.LIGHTTYPE_POINT?f.setDepthBias(!1):(f.setDepthBias(!0),f.setDepthBiasValues(-1E3*e.shadowBias,-1E3*e.shadowBias)):f.extStandardDerivatives&&(v===pc.LIGHTTYPE_POINT?(this.polygonOffset[0]=0,this.polygonOffset[1]=0):(this.polygonOffset[0]=-1E3*e.shadowBias,this.polygonOffset[1]=-1E3*e.shadowBias),this.polygonOffsetId.setValue(this.polygonOffset));e.shadowUpdateMode===pc.SHADOWUPDATE_THISFRAME&&
(e.shadowUpdateMode=pc.SHADOWUPDATE_NONE);this._shadowMapUpdates+=E;f.setBlending(!1);f.setDepthWrite(!0);f.setDepthTest(!0);e._isPcf&&f.webgl2&&v!==pc.LIGHTTYPE_POINT?f.setColorWrite(!1,!1,!1,!1):f.setColorWrite(!0,!0,!0,!0);for(y?E=y+1:y=0;y<E;){v===pc.LIGHTTYPE_POINT&&(w.setRotation(h[y]),u.renderTarget=e._shadowCubeMap[y]);this.setCamera(u,u.renderTarget,!0,v!==pc.LIGHTTYPE_POINT);F=e._visibleList[y];J=e._visibleLength[y];l=e._shadowType;x=l+5*v;for(l=0;l<J;l++){H=F[l];G=H.mesh;n=H.material;this.setBaseConstants(f,
n);this.setSkinning(f,H,n);n.dirty&&(n.updateUniforms(),n.dirty=!1);if(n.chunks){A=n.parameters;for(z in A)n=A[z],n.passFlags&C&&(n.scopeId||(n.scopeId=f.scope.resolve(z)),n.scopeId.setValue(n.data));A=H.parameters;for(z in A)n=A[z],n.passFlags&C&&(n.scopeId||(n.scopeId=f.scope.resolve(z)),n.scopeId.setValue(n.data))}n=H._shader[pc.SHADER_SHADOW+x];if(!n){this.updateShader(H,H._shaderDefs,null,pc.SHADER_SHADOW+x);n=H._shader[pc.SHADER_SHADOW+x];A=H._key;var B=pc.SORTKEY_DEPTH,L=H.material,K=H.skinInstance?
10:0,D=0;L.opacityMap&&(L=L.opacityMapChannel)&&(D=p[L]);A[B]=K+D}f.setShader(n);n=H.renderStyle;f.setVertexBuffer(H.morphInstance&&H.morphInstance._vertexBuffer?H.morphInstance._vertexBuffer:G.vertexBuffer,0);f.setIndexBuffer(G.indexBuffer[n]);l+=this.drawInstance(f,H,G,n);this._shadowDrawCalls++}y++;v===pc.LIGHTTYPE_DIRECTIONAL&&(e._visibleLength[b]=-1)}e._isVsm&&(v=e._vsmBlurSize,1<v&&(u=u.renderTarget,w=d(f,e._shadowResolution,e._shadowType,1),E=e._shadowType===pc.SHADOW_VSM8,y=e.vsmBlurMode,
F=(E?this.blurPackedVsmShader:this.blurVsmShader)[y][v],F||(this.blurVsmWeights[v]=c(v),F=pc.shaderChunks.fullscreenQuadVS,l="#define SAMPLES "+v+"\n",l=E?l+this.blurPackedVsmShaderCode[y]:l+this.blurVsmShaderCode[y],F=pc.shaderChunks.createShaderFromCode(this.device,F,l,"blurVsm"+y+""+v+""+E),E?this.blurPackedVsmShader[y][v]=F:this.blurVsmShader[y][v]=F),m.z=e._shadowResolution-2,m.w=m.z,this.sourceId.setValue(u.colorBuffer),q[0]=1/e._shadowResolution,q[1]=0,this.pixelOffsetId.setValue(q),y===pc.BLUR_GAUSSIAN&&
this.weightId.setValue(this.blurVsmWeights[v]),pc.drawQuadWithShader(f,w,F,null,m),this.sourceId.setValue(w.colorBuffer),q[1]=q[0],q[0]=0,this.pixelOffsetId.setValue(q),pc.drawQuadWithShader(f,u,F,null,m)))}f.webgl2?f.setDepthBias(!1):f.extStandardDerivatives&&(this.polygonOffset[0]=0,this.polygonOffset[1]=0,this.polygonOffsetId.setValue(this.polygonOffset))},updateShader:function(a,b,c,d,f){a.material._scene=this.scene;a.material.updateShader(this.device,this.scene,b,c,d,f);a._shader[d]=a.material.shader},
renderForward:function(a,b,c,d,f,g,l,k){var e=this.device,h=this.scene,p=a.vrDisplay,n=1<<f;k=k?k._lightHash:0;var m,q,t,r,v,u,y,w,x=null,L,K,D=.5*e.width;for(m=0;m<c;m++)if(q=b[m],!g||!q.mask||g&q.mask)if(q.command)q.command();else{t=q.mesh;r=q.material;v=q._shaderDefs;y=q.mask;this.setSkinning(e,q,r);r&&r===x&&v!==u&&(x=null);if(q.isStatic||L)x=null;if(r!==x){this._materialSwitches++;r.dirty&&(r.updateUniforms(),r.dirty=!1);q._shader[f]&&q._shaderDefs===v&&q._lightHash===k||(q.isStatic?this.updateShader(q,
v,q._staticLightList,f,d):(u=f+"_"+v+"_"+k,q._shader[f]=r.variants[u],q._shader[f]||(this.updateShader(q,v,null,f,d),r.variants[u]=q._shader[f])),q._shaderDefs=v,q._lightHash=k);e.setShader(q._shader[f]);u=r.parameters;for(K in u)L=u[K],L.passFlags&n&&(L.scopeId||(L.scopeId=e.scope.resolve(K)),L.scopeId.setValue(L.data));x&&y===w||(w=this.dispatchDirectLights(d[pc.LIGHTTYPE_DIRECTIONAL],h,y),this.dispatchLocalLights(d,h,y,w,q._staticLightList));this.alphaTestId.setValue(r.alphaTest);e.setBlending(r.blend);
...
e.setDepthTest(r.depthTest);e.setAlphaToCoverage(r.alphaToCoverage);r.depthBias||r.slopeDepthBias?(e.setDepthBias(!0),e.setDepthBiasValues(r.depthBias,r.slopeDepthBias)):e.setDepthBias(!1)}w=q.stencilFront||r.stencilFront;x=q.stencilBack||r.stencilBack;w||x?(e.setStencilTest(!0),w===x?(e.setStencilFunc(w.func,w.ref,w.readMask),e.setStencilOperation(w.fail,w.zfail,w.zpass,w.writeMask)):(w?(e.setStencilFuncFront(w.func,w.ref,w.readMask),e.setStencilOperationFront(w.fail,w.zfail,w.zpass,w.writeMask)):
(e.setStencilFuncFront(pc.FUNC_ALWAYS,0,255),e.setStencilOperationFront(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEPP,255)),x?(e.setStencilFuncBack(x.func,x.ref,x.readMask),e.setStencilOperationBack(x.fail,x.zfail,x.zpass,x.writeMask)):(e.setStencilFuncBack(pc.FUNC_ALWAYS,0,255),e.setStencilOperationBack(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,255)))):e.setStencilTest(!1);u=q.parameters;for(K in u)L=u[K],L.passFlags&n&&(L.scopeId||(L.scopeId=e.scope.resolve(K)),L.scopeId.setValue(L.data));
e.setVertexBuffer(q.morphInstance&&q.morphInstance._vertexBuffer?q.morphInstance._vertexBuffer:t.vertexBuffer,0);w=q.renderStyle;e.setIndexBuffer(t.indexBuffer[w]);l&&l(q,m);p&&p.presenting?(e.setViewport(0,0,D,e.height),this.projId.setValue(H.data),this.viewInvId.setValue(z.data),this.viewId.setValue(A.data),this.viewId3.setValue(G.data),this.viewProjId.setValue(Q.data),this.viewPos[0]=J.x,this.viewPos[1]=J.y,this.viewPos[2]=J.z,this.viewPosId.setValue(this.viewPos),m+=this.drawInstance(e,q,t,w,
!0),this._forwardDrawCalls++,e.setViewport(D,0,D,e.height),this.projId.setValue(E.data),this.viewInvId.setValue(C.data),this.viewId.setValue(B.data),this.viewId3.setValue(I.data),this.viewProjId.setValue(V.data),this.viewPos[0]=F.x,this.viewPos[1]=F.y,this.viewPos[2]=F.z,this.viewPosId.setValue(this.viewPos),m+=this.drawInstance2(e,q,t,w)):m+=this.drawInstance(e,q,t,w,!0);this._forwardDrawCalls++;if(m<c-1&&b[m+1].material===r)for(K in u)if(L=r.parameters[K])L.scopeId||(L.scopeId=e.scope.resolve(K)),
L.scopeId.setValue(L.data);x=r;u=v;w=y;L=q.isStatic}e.updateEnd()},setupInstancing:function(a){pc._instanceVertexFormat||(pc._instanceVertexFormat=new pc.VertexFormat(a,[{semantic:pc.SEMANTIC_TEXCOORD2,components:4,type:pc.TYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD3,components:4,type:pc.TYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD4,components:4,type:pc.TYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD5,components:4,type:pc.TYPE_FLOAT32}]));a.enableAutoInstancing&&!pc._autoInstanceBuffer&&(pc._autoInstanceBuffer=
new pc.VertexBuffer(a,pc._instanceVertexFormat,a.autoInstancingMaxObjects,pc.BUFFER_DYNAMIC),pc._autoInstanceBufferData=new Float32Array(pc._autoInstanceBuffer.lock()))},revertStaticMeshes:function(a){var b,c=a.length,d,f=[],g;for(b=0;b<c;b++)d=a[b],d._staticSource?d._staticSource!==g&&(f.push(d._staticSource),g=d._staticSource):f.push(d);a.length=f.length;for(b=0;b<f.length;b++)a[b]=f[b]},prepareStaticMeshes:function(a,b){var c,d,f,g,l,e=this.device,k=a.length,h,p,n=[],m,q,r,t,v,u,w,y,x,E,J,H,F,
G,C=new pc.Vec3,z=new pc.Vec3,A=new pc.BoundingBox,L=new pc.Mat4,B=[],K,D,I=[],P=[],R=[];for(c=0;c<k;c++)if(h=a[c],h.isStatic){m=h.aabb;R.length=0;for(K=pc.LIGHTTYPE_POINT;K<=pc.LIGHTTYPE_SPOT;K++)for(d=0;d<b.length;d++)p=b[d],p._type===K&&p._enabled&&p._mask&h.mask&&p.isStatic&&(I[d]||(I[d]=new pc.BoundingBox,p._node.getWorldTransform(),p.getBoundingSphere(U),I[d].center.copy(U.center),I[d].halfExtents.x=U.radius,I[d].halfExtents.y=U.radius,I[d].halfExtents.z=U.radius),I[d].intersects(m)&&R.push(d));
if(0===R.length)n.push(h);else{m=h.mesh;K=m.vertexBuffer;p=m.indexBuffer[h.renderStyle];q=2===p.bytesPerIndex?new Uint16Array(p.lock()):new Uint32Array(p.lock());r=m.primitive[h.renderStyle].count/3;w=m.primitive[h.renderStyle].base;t=K.format.elements;v=K.format.size/4;m=new Float32Array(K.storage);for(f=0;f<t.length;f++)t[f].name===pc.SEMANTIC_POSITION&&(u=t[f].offset/4);B.length=r;for(f=0;f<r;f++)B[f]=0;t=!1;P.length=6*r;for(f=0;f<r;f++){J=E=x=Number.MAX_VALUE;H=-Number.MAX_VALUE;F=-Number.MAX_VALUE;
G=-Number.MAX_VALUE;for(g=0;3>g;g++)d=q[3*f+g+w],d=d*v+u,l=m[d],y=m[d+1],d=m[d+2],l<x&&(x=l),y<E&&(E=y),d<J&&(J=d),l>H&&(H=l),y>F&&(F=y),d>G&&(G=d);d=6*f;P[d]=x;P[d+1]=E;P[d+2]=J;P[d+3]=H;P[d+4]=F;P[d+5]=G}for(l=0;l<R.length;l++)for(d=R[l],L.copy(h.node.worldTransform).invert(),A.setFromTransformedAabb(I[d],L),y=A.getMin(),x=A.getMax(),g=1<<l,f=0;f<r;f++)d=6*f,P[d]<=x.x&&P[d+3]>=y.x&&P[d+1]<=x.y&&P[d+4]>=y.y&&P[d+2]<=x.z&&P[d+5]>=y.z&&(B[f]|=g,t=!0);if(t){t={};for(f=0;f<r;f++)d=3*f+w,D=B[f],t[D]||
(t[D]=[]),g=t[D],g.push(q[d]),g.push(q[d+1]),g.push(q[d+2]);for(D in t){g=t[D];q=new pc.IndexBuffer(e,p.format,g.length,p.usage);(2===q.bytesPerIndex?new Uint16Array(q.lock()):new Uint32Array(q.lock())).set(g);q.unlock();J=E=x=Number.MAX_VALUE;H=-Number.MAX_VALUE;F=-Number.MAX_VALUE;G=-Number.MAX_VALUE;for(f=0;f<g.length;f++)d=g[f],l=m[d*v+u],y=m[d*v+u+1],d=m[d*v+u+2],l<x&&(x=l),y<E&&(E=y),d<J&&(J=d),l>H&&(H=l),y>F&&(F=y),d>G&&(G=d);C.set(x,E,J);z.set(H,F,G);f=new pc.BoundingBox;f.setMinMax(C,z);
r=new pc.Mesh;r.vertexBuffer=K;r.indexBuffer[0]=q;r.primitive[0].type=pc.PRIMITIVE_TRIANGLES;r.primitive[0].base=0;r.primitive[0].count=g.length;r.primitive[0].indexed=!0;r.aabb=f;q=new pc.MeshInstance(h.node,r,h.material);q.isStatic=h.isStatic;q.visible=h.visible;q.layer=h.layer;q.castShadow=h.castShadow;q._receiveShadow=h._receiveShadow;q.cull=h.cull;q.pick=h.pick;q.mask=h.mask;q.parameters=h.parameters;q._shaderDefs=h._shaderDefs;q._staticSource=h;q._staticLightList=h._staticLightList?h._staticLightList:
[];for(f=0;f<R.length;f++)g=1<<f,D&g&&(r=b[R[f]],0>q._staticLightList.indexOf(r)&&q._staticLightList.push(r));q._staticLightList.sort(this.lightCompare);n.push(q)}}else n.push(h)}}else n.push(h);a.length=n.length;for(c=0;c<n.length;c++)a[c]=n[c]},updateShaders:function(a){var b,c=[];for(b=0;b<a.length;b++){var d=a[b];void 0!==d.material&&-1===c.indexOf(d.material)&&c.push(d.material)}for(b=0;b<c.length;b++)a=c[b],a.updateShader!==pc.Material.prototype.updateShader&&(a.clearVariants(),a.shader=null)},
...
b){var c,d,f,g,l,e,k,p,n,m,q;d=a._type;if(d!==pc.LIGHTTYPE_DIRECTIONAL)for(a.visibleThisFrame=!0,f=this.getShadowCamera(this.device,a),f.projection=pc.PROJECTION_PERSPECTIVE,f.nearClip=a.attenuationEnd/1E3,f.farClip=a.attenuationEnd,f.aspectRatio=1,d===pc.LIGHTTYPE_SPOT?(f.fov=2*a._outerConeAngle,l=1):(f.fov=90,l=6),g=f._node,c=a._node,g.setPosition(c.getPosition()),d===pc.LIGHTTYPE_SPOT&&(g.setRotation(c.getRotation()),g.rotateLocal(-90,0,0)),e=0;e<l;e++){d===pc.LIGHTTYPE_POINT&&(g.setRotation(h[e]),
f.renderTarget=a._shadowCubeMap[e]);this.updateCameraFrustum(f);(n=a._visibleList[e])||(n=a._visibleList[e]=[]);c=m=a._visibleLength[e]=0;for(k=b.length;c<k;c++)p=b[c],q=!0,p.cull&&(q=this._isVisible(f,p)),q&&(n[m]=p,m++,p.visibleThisFrame=!0);a._visibleLength[e]=m;n.length!==m&&(n.length=m);n.sort(this.depthSortCompare)}},cullDirectionalShadowmap:function(a,b,c,d){var f,g,l,e,k,h,p,n,m,q,t,u;g=this.device;a.visibleThisFrame=!0;g=this.getShadowCamera(g,a);l=g._node;e=a._node;l.setPosition(e.getPosition());
l.setRotation(e.getRotation());l.rotateLocal(-90,0,0);n=a.shadowDistance||c._farClip;m=c._nearClip;f=c._fov*Math.PI/180;k=c._aspect;h=c._projection;t=h===pc.PROJECTION_PERSPECTIVE?Math.tan(f/2)*m:c._orthoHeight;q=t*k;N[0].x=q;N[0].y=-t;N[0].z=-m;N[1].x=q;N[1].y=t;N[1].z=-m;N[2].x=-q;N[2].y=t;N[2].z=-m;N[3].x=-q;N[3].y=-t;N[3].z=-m;h===pc.PROJECTION_PERSPECTIVE&&(t=Math.tan(f/2)*n,q=t*k);N[4].x=q;N[4].y=-t;N[4].z=-n;N[5].x=q;N[5].y=t;N[5].z=-n;N[6].x=-q;N[6].y=t;N[6].z=-n;N[7].x=-q;N[7].y=-t;N[7].z=
-n;k=W.sub2(N[0],N[6]).length();k=Math.max(k,W.sub2(N[4],N[6]).length());r.copy(l.getWorldTransform()).invert();v.copy(r).mul(c._node.worldTransform);for(f=0;8>f;f++)v.transformPoint(N[f],N[f]);n=m=c=1E6;q=t=h=-1E6;for(f=0;8>f;f++)p=N[f],p.x<n&&(n=p.x),p.x>q&&(q=p.x),p.y<m&&(m=p.y),p.y>t&&(t=p.y),p.z<c&&(c=p.z),p.z>h&&(h=p.z);f=k/a._shadowResolution;n=Math.floor((n-.5*(k-(q-n)))/f)*f;m=Math.floor((m-.5*(k-(t-m)))/f)*f;n=.5*(n+k+n);m=.5*(m+k+m);l.translateLocal(n,m,1E5);g.projection=pc.PROJECTION_ORTHOGRAPHIC;
g.nearClip=0;g.farClip=2E5;g.aspectRatio=1;g.orthoHeight=.5*k;this.updateCameraFrustum(g);t=!0;(h=a._visibleList[d])||(h=a._visibleList[d]=[]);f=k=a._visibleLength[d]=0;for(q=b.length;f<q;f++)u=b[f],p=!0,u.cull&&(p=this._isVisible(g,u)),p&&(h[k]=u,k++,u.visibleThisFrame=!0,p=u.aabb,t?(T.copy(p),t=!1):T.add(p));a._visibleLength[d]=k;h.length!==k&&(h.length=k);h.sort(this.depthSortCompare);b=T.getMin();f=T.getMax();M[0].x=M[1].x=M[2].x=M[3].x=b.x;M[1].y=M[3].y=M[7].y=M[5].y=b.y;M[2].z=M[3].z=M[6].z=
M[7].z=b.z;M[4].x=M[5].x=M[6].x=M[7].x=f.x;M[0].y=M[2].y=M[4].y=M[6].y=f.y;M[0].z=M[1].z=M[4].z=M[5].z=f.z;f=9999999999;b=-9999999999;for(h=0;8>h;++h)r.transformPoint(M[h],M[h]),k=M[h].z,k<f&&(f=k),k>b&&(b=k);h=b;f>c&&(c=f);l.setPosition(e.getPosition());l.translateLocal(n,m,h+.01);g.farClip=h-c;(e=a._visibleCameraSettings[d])||(e=a._visibleCameraSettings[d]={});a=l.getPosition();e.x=a.x;e.y=a.y;e.z=a.z;e.orthoHeight=g.orthoHeight;e.farClip=g.farClip},gpuUpdate:function(a){this.updateGpuSkinMatrices(a);
this.updateMorphing(a)},clearView:function(a,b,c){a=a.camera;var d=this.device;d.setRenderTarget(b);d.updateBegin();d.setColorWrite(!0,!0,!0,!0);d.setDepthWrite(!0);var f=a.getRect(),g=b?b.width:d.width,l=b?b.height:d.height;b=Math.floor(f.x*g);var e=Math.floor(f.y*l),g=Math.floor(f.width*g),f=Math.floor(f.height*l);d.setViewport(b,e,g,f);d.setScissor(b,e,g,f);d.clear(c?c:a._clearOptions)},setSceneConstants:function(){var a,b=this.device,c=this.scene;this.dispatchGlobalLights(c);if(c.fog!==pc.FOG_NONE){this.fogColor[0]=
...
this.device,c,d=a._renderedRt,f=a._renderedByCam,g=a._renderedLayer,l,e,k,h,p,n,m,q;this.beginLayers(a);a._update()&pc.COMPUPDATED_LIGHTS&&(this.scene.updateLitShaders=!0);this.beginFrame(a);this.setSceneConstants();var r=0,t,v;for(l=0;l<a.layerList.length;l++)if(e=a.layerList[l],e.enabled&&a.subLayerEnabled[l])for(k=a.subLayerList[l],t=e.instances,h=e.cameras,p=0;p<h.length;p++)if(c=h[p]){c.frameBegin(e.renderTarget);v=k?e.transparentMeshInstances:e.opaqueMeshInstances;q=m=!1;for(n=0;n<r;n++)if(f[n]===
c&&(m=!0,g[n]===e)){q=!0;break}m||(this.updateCameraFrustum(c.camera),this._camerasRendered++);q||this.cullLights(c.camera,e._lights);m&&q||(f[r]=c,g[r]=e,r++);n=k?t.visibleTransparent[p]:t.visibleOpaque[p];if(!n.done){if(e.onPreCull)e.onPreCull(p);n.length=this.cull(c.camera,v,n.list);n.done=!0;if(e.onPostCull)e.onPostCull(p)}c.frameEnd()}for(l=0;l<a._lights.length;l++)c=a._lights[l],c.visibleThisFrame&&c._type!==pc.LIGHTTYPE_DIRECTIONAL&&c.castShadows&&c._enabled&&c.shadowUpdateMode!==pc.SHADOWUPDATE_NONE&&
(e=a._lightShadowCasters[l],this.cullLocalShadowmap(c,e));k=-1;for(l=0;l<a._lights.length;l++)if(c=a._lights[l],c._type===pc.LIGHTTYPE_DIRECTIONAL&&(k++,c.castShadows&&c._enabled&&c.shadowUpdateMode!==pc.SHADOWUPDATE_NONE))for(e=a._lightShadowCasters[l],h=a._globalLightCameras[k],p=0;p<h.length;p++)this.cullDirectionalShadowmap(c,e,h[p].camera,a._globalLightCameraIds[k][p]);this.gpuUpdate(a._meshInstances);this.renderShadows(a._sortedLights[pc.LIGHTTYPE_SPOT]);this.renderShadows(a._sortedLights[pc.LIGHTTYPE_POINT]);
for(l=r=0;l<a._renderList.length;l++)if(e=a.layerList[a._renderList[l]],e.enabled&&a.subLayerEnabled[a._renderList[l]]){t=e.instances;k=a.subLayerList[a._renderList[l]];h=a._renderListCamera[l];(c=e.cameras[h])&&c.frameBegin(e.renderTarget);if(!k&&e.onPreRenderOpaque)e.onPreRenderOpaque(h);else if(k&&e.onPreRenderTransparent)e.onPreRenderTransparent(h);if(!(e._preRenderCalledForCameras&1<<h)){if(e.onPreRender)e.onPreRender(h);e._preRenderCalledForCameras|=1<<h;e.overrideClear&&this.clearView(c,e.renderTarget,
e._clearOptions)}if(c){p=e.renderTarget;g=!1;for(n=0;n<r;n++)if(d[n]===p&&f[n]===c){g=!0;break}g||(e.overrideClear||this.clearView(c,e.renderTarget),d[r]=p,f[r]=c,r++);this.renderShadows(e._sortedLights[pc.LIGHTTYPE_DIRECTIONAL],h);e._sortVisible(k,c.node,h);n=k?t.visibleTransparent[h]:t.visibleOpaque[h];this.scene._activeCamera=c.camera;this.setCamera(c.camera,e.renderTarget);this.renderForward(c.camera,n.list,n.length,e._sortedLights,e.shaderPass,e.cullingMask,e.onDrawCall,e);b.setColorWrite(!0,
!0,!0,!0);b.setStencilTest(!1);b.setAlphaToCoverage(!1);b.setDepthBias(!1);c.frameEnd()}if(!k&&e.onPostRenderOpaque)e.onPostRenderOpaque(h);else if(k&&e.onPostRenderTransparent)e.onPostRenderTransparent(h);!e.onPostRender||e._postRenderCalledForCameras&1<<h||(e._postRenderCounter&=~(k?2:1),0===e._postRenderCounter&&(e.onPostRender(h),e._postRenderCalledForCameras|=1<<h,e._postRenderCounter=e._postRenderCounterMax))}}});return{ForwardRenderer:g,gaussWeights:c}}());Object.assign(pc,function(){var e=new pc.Mat4,b=new pc.Vec3,a=new pc.Quat,c=new pc.Quat,d=new pc.Vec3,f=new pc.Vec3,g=function(a){this.name="string"===typeof a?a:"Untitled";this.tags=new pc.Tags(this);this._labels={};this.localPosition=new pc.Vec3(0,0,0);this.localRotation=new pc.Quat(0,0,0,1);this.localScale=new pc.Vec3(1,1,1);this.localEulerAngles=new pc.Vec3(0,0,0);this.position=new pc.Vec3(0,0,0);this.rotation=new pc.Quat(0,0,0,1);this.eulerAngles=new pc.Vec3(0,0,0);this.localTransform=new pc.Mat4;
...
h=k;if(h){for(;h&&h.scaleCompensation;)h=h._parent;h&&(h=h._parent)&&(g=h.worldTransform.getScale(),d.mul2(g,this.localScale),p=d)}c.setFromMat4(k.worldTransform);a.mul2(c,this.localRotation);h=k.worldTransform;k.scaleCompensation&&(f.mul2(g,k.getLocalScale()),e.setTRS(k.worldTransform.getTranslation(b),c,f),h=e);h.transformPoint(this.localPosition,b);this.worldTransform.setTRS(b,a,p)}else this.worldTransform.mul2(this._parent.worldTransform,this.localTransform);this._dirtyWorld=!1}},syncHierarchy:function(){if(this._enabled){(this._dirtyLocal||
this._dirtyWorld)&&this._sync();for(var a=this._children,b=0,c=a.length;b<c;b++)a[b].syncHierarchy()}},lookAt:function(){var a=new pc.Mat4,b=new pc.Vec3,c=new pc.Vec3,d=new pc.Quat;return function(f,g,l,e,k,h){if(f instanceof pc.Vec3)b.copy(f),g instanceof pc.Vec3?c.copy(g):c.copy(pc.Vec3.UP);else{if(void 0===l)return;b.set(f,g,l);void 0!==e?c.set(e,k,h):c.copy(pc.Vec3.UP)}a.setLookAt(this.getPosition(),b,c);d.setFromMat4(a);this.setRotation(d)}}(),translate:function(){var a=new pc.Vec3;return function(b,
...
var f=this.getProjectionMatrix(),g=this._node.getWorldTransform();this._viewMat.copy(g).invert();this._viewProjMat.mul2(f,this._viewMat);this._viewProjMat.transformPoint(a,d);f=this._viewProjMat.data;a=a.x*f[3]+a.y*f[7]+a.z*f[11]+1*f[15];d.x=.5*(d.x/a+1)*b;d.y=.5*(1-d.y/a)*c;return d},screenToWorld:function(d,g,l,k,p,h){void 0===h&&(h=new pc.Vec3);var f=this.getProjectionMatrix(),q=this._node.getWorldTransform();this._viewMat.copy(q).invert();this._viewProjMat.mul2(f,this._viewMat);c.copy(this._viewProjMat).invert();
this._projection===pc.PROJECTION_PERSPECTIVE?(b.set(d/k*2-1,(p-g)/p*2-1,1),c.transformPoint(b,a),a.scale(1/(b.x*c.data[3]+b.y*c.data[7]+b.z*c.data[11]+c.data[15])),d=l/this._farClip,h.lerp(this._node.getPosition(),a,d)):(e.set(d/k,(p-g)/p,l/(this._farClip-this._nearClip)),e.scale(2),e.sub(pc.Vec3.ONE),c.transformPoint(e,h));return h},getClearOptions:function(){return this._clearOptions},getProjectionMatrix:function(){if(this._projMatDirty){if(this._projection===pc.PROJECTION_PERSPECTIVE)this._projMat.setPerspective(this._fov,
...
a.mask=this._mask;a.innerConeAngle=this._innerConeAngle;a.outerConeAngle=this._outerConeAngle;a.shadowBias=this.shadowBias;a.normalOffsetBias=this._normalOffsetBias;a.shadowResolution=this._shadowResolution;a.shadowDistance=this.shadowDistance;return a},getColor:function(){return this._color},getBoundingSphere:function(c){if(this._type===pc.LIGHTTYPE_SPOT){var d=this.attenuationEnd,f=this._outerConeAngle,k=Math.cos(f*pc.math.DEG_TO_RAD),p=this._node;e.copy(p.up);e.scale(.5*-d*k);e.add(p.getPosition());
...
c),this._collectLights(pc.LIGHTTYPE_POINT,d[pc.LIGHTTYPE_POINT],a,c,f),this._collectLights(pc.LIGHTTYPE_SPOT,d[pc.LIGHTTYPE_SPOT],a,c,f)),b.lights=a):b.lights=[];0===b.lights.length&&(b.noShadow=!0)};e.prototype._updateTexOptions=function(b,a,c,d,f,g,l){var e=c+"Map",p=c+"VertexColor",h=c+"VertexColorChannel",n=e+"Channel",q=e+"Transform",m=e+"Uv";"light"!==c&&(b[e]=!1,b[n]="",b[q]=0,b[m]=0);b[p]=!1;b[h]="";var r="opacity"===c;if(r&&a.blendType===pc.BLEND_NONE&&0===a.alphaTest&&!a.alphaToCoverage)return b;
if(!l||r)"height"!==c&&a[p]&&g&&(b[p]=a[p],b[h]=a[h],b.vertexColors=!0),a[e]&&(c=!0,0!==a[m]||d||(c=!1),1!==a[m]||f||(c=!1),c&&(b[e]=!!a[e],b[q]=this._getMapTransformID(a[q],a[m]),b[n]=a[n],b[m]=a[m]))};e.prototype._collectLights=function(b,a,c,d,f){var g,e;for(e=0;e<a.length;e++)g=a[e],g._enabled&&g._mask&d&&(b===pc.LIGHTTYPE_DIRECTIONAL||!g.isStatic)&&c.push(g);if(f)for(e=0;e<f.length;e++)g=f[e],g._type===b&&c.push(g)};e.prototype._getMapTransformID=function(b,a){if(!b)return 0;this._mapXForms[a]||
...
e=this.mesh.vertexBuffer.numVertices;b=this.mesh.vertexBuffer.format.size;var m,r,t,v,y;for(f=0;f<g.length;f++)g[f].name===pc.SEMANTIC_POSITION?r=g[f].offset:g[f].name===pc.SEMANTIC_BLENDINDICES?t=g[f].offset:g[f].name===pc.SEMANTIC_BLENDWEIGHT&&(v=g[f].offset);var g=new Uint8Array(this.mesh.vertexBuffer.storage),u=new Float32Array(this.mesh.vertexBuffer.storage),w=r/4,x=v/4,D=b/4,z,C,A,B,J;v=[];r=[];d=this.mesh.boneUsed;for(f=0;f<c;f++)v[f]=new pc.Vec3(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),
r[f]=new pc.Vec3(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);for(y=0;y<e;y++)for(f=0;4>f;f++)0<u[y*D+x+f]&&(m=g[y*b+t+f],A=u[y*D+w],B=u[y*D+w+1],J=u[y*D+w+2],z=r[m],C=v[m],C.x>A&&(C.x=A),C.y>B&&(C.y=B),C.z>J&&(C.z=J),z.x<A&&(z.x=A),z.y<B&&(z.y=B),z.z<J&&(z.z=J),d[m]=!0);if(this.morphInstance){var F;d=this.morphInstance.morph._targets;var H=new Float32Array(3*e),E=new Float32Array(3*e),G;for(y=0;y<e;y++)H[3*y]=E[3*y]=u[y*D+w],H[3*y+1]=E[3*y+1]=u[y*D+w+1],H[3*y+2]=E[3*y+2]=u[y*D+w+2];for(e=
0;e<d.length;e++)for(f=d[e],w=f.indices,y=w.length,A=f.deltaPositions,f=0;f<y;f++)F=w[f],m=A[3*f],z=A[3*f+1],C=A[3*f+2],0>m?H[3*F]+=m:E[3*F]+=m,0>z?H[3*F+1]+=z:E[3*F+1]+=z,0>C?H[3*F+2]+=C:E[3*F+2]+=C;for(e=0;e<d.length;e++)for(f=d[e],w=f.indices,y=w.length,f=0;f<y;f++)for(F=w[f],G=0;4>G;G++)0<u[F*D+x+G]&&(m=g[F*b+t+G],z=r[m],C=v[m],A=H[3*F],B=H[3*F+1],J=H[3*F+2],C.x>A&&(C.x=A),C.y>B&&(C.y=B),C.z>J&&(C.z=J),A=E[3*F],B=E[3*F+1],J=E[3*F+2],z.x<A&&(z.x=A),z.y<B&&(z.y=B),z.z<J&&(z.z=J))}for(f=0;f<c;f++)b=
...
this.indexMap[b]=c}},addPrimitive:function(a,b,c,e){var d,f,g=[],l=0,q=a.length;for(d=0;d<q;d++)for(var m=a[d].index,r=0;4>r;r++)if(0<c.blendWeight.data[4*m+r]){var t=c.blendIndices.data[4*m+r],v=!0;for(f=0;f<l;f++)if(g[f]==t){v=!1;break}v&&(g[l]=t,f=this.getBoneRemap(t),l+=-1===f?1:0)}if(this.boneIndices.length+l>e)return!1;for(d=0;d<l;d++)this.boneIndices.push(g[d]);for(d=0;d<q;d++)this.addVertex(a[d],b[d],c);return!0},getBoneRemap:function(a){for(var b=0;b<this.boneIndices.length;b++)if(this.boneIndices[b]===
a)return b;return-1}});return{partitionSkin:function(d,f,g){var l,k,p,h;a(d);var n=d.vertices,q=d.skins,m,r=d.meshes,t=d.meshInstances,v=function(a){var b=new e;b.index=a;return b};for(l=q.length-1;0<=l;l--)if(q[l].boneNames.length>g){var y=q.splice(l,1)[0],u=[];for(k=0;k<r.length;k++)r[k].skin===y&&u.push(r[k]);for(k=0;k<u.length;k++)h=r.indexOf(u[k]),-1!==h&&r.splice(h,1);if(0===u.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var w=u[0].vertices;for(k=
...
h.originalMesh&&(t.push({mesh:m,node:t[p].node}),f&&f.push({material:f[p].material,path:f[p].path}));for(k=0;k<x.length;k++)for(h=x[k],p=t.length-1;0<=p;p--)t[p].mesh===h.originalMesh&&(t.splice(p,1),f&&f.splice(p,1))}c(d)}}}());Object.assign(pc,function(){var e=new pc.Vec3,b=new pc.Vec3,a=function(a){this.aabb=new pc.BoundingBox;this._baseAabb=this._baseBuffer=null;this._targets=a;this._aabbDirty=this._dirty=!0;this._baseData=null;this._vertSizeF=this._offsetTF=this._offsetNF=this._offsetPF=0};Object.assign(a.prototype,{_setBaseMesh:function(a){this._baseBuffer=a.vertexBuffer;this._baseAabb=a._aabb;this._baseData=new Float32Array(this._baseBuffer.storage);for(var b=a=-1,c=-1,d=this._baseBuffer.format.elements,e=this._baseBuffer.format.size,
p=0;p<d.length;p++)d[p].name===pc.SEMANTIC_POSITION?a=d[p].offset:d[p].name===pc.SEMANTIC_NORMAL?b=d[p].offset:d[p].name===pc.SEMANTIC_TANGENT&&(c=d[p].offset);this._offsetPF=a/4;this._offsetNF=b/4;this._offsetTF=c/4;this._vertSizeF=e/4;this._dirty=!0},_calculateAabb:function(){if(this._baseBuffer){this.aabb.copy(this._baseAabb);var a,c,g,l,k,p,h,n=this._vertSizeF,q=this._offsetPF,m=this._baseData;for(c=0;c<this._targets.length;c++){l=this._targets[c];if(!l.aabb&&0<l.indices.length){l.aabb=this.aabb.clone();
e.set(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE);b.set(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);a=l.indices.length;for(g=0;g<a;g++)k=l.indices[g],p=k*n+q,k=m[p]+l.deltaPositions[3*g],h=m[p+1]+l.deltaPositions[3*g+1],p=m[p+2]+l.deltaPositions[3*g+2],e.x>k&&(e.x=k),e.y>h&&(e.y=h),e.z>p&&(e.z=p),b.x<k&&(b.x=k),b.y<h&&(b.y=h),b.z<p&&(b.z=p);l.aabb.setMinMax(e,b)}l.aabb&&this.aabb.add(l.aabb)}this._aabbDirty=!1}},addTarget:function(a){this._targets.push(a);this._aabbDirty=!0},removeTarget:function(a){a=
...
this.morph._aabbDirty&&this.morph._calculateAabb()},update:function(a){this.morph._baseBuffer!==a.vertexBuffer&&this.morph._setBaseMesh(a);this._vertexData||this._setBaseMesh(a);var b,c=this.morph._targets,d=this._weights,e,p,h,n,q,m=this.morph._vertSizeF,r=this.morph._offsetPF,t=this.morph._offsetNF,v=this.morph._offsetTF,y=this._vertexData;y.set(this.morph._baseData);for(var u=0;u<c.length;u++)if(p=d[u],0!==p)for(e=c[u],a=e.indices.length,h=0;h<a;h++)q=3*h,b=e.indices[h],n=b*m+r,y[n]+=e.deltaPositions[q]*
...
!0;this.meshInstance.aabb=this.worldBounds;this.meshInstance._updateAabb=!1;this.meshInstance.visible=a;this._initializeTextures();this.addTime(0);this.preWarm&&this.prewarm(this.lifetime);this.resetTime()},_isAnimated:function(){return 1<=this.animNumFrames&&(1<this.animTilesX||1<this.animTilesY)&&(this.colorMap&&this.colorMap!==T.DEFAULT_PARAM_TEXTURE||this.normalMap)},calcSpawnPosition:function(a,c){var d=Math.random(),f=Math.random(),g=Math.random(),l=Math.random();this.useCpu&&(this.particleTex[4*
c+0+8*this.numParticlesPot]=d,this.particleTex[4*c+1+8*this.numParticlesPot]=f,this.particleTex[4*c+2+8*this.numParticlesPot]=g);G.x=d-.5;G.y=f-.5;G.z=g-.5;this.emitterShape===pc.EMITTERSHAPE_BOX?I.copy(a).add(E.transformPoint(G)):(G.normalize(),I.copy(a).add(G.scale(l*this.spawnBounds)));if(this.pack8){var k=(I.x-this.worldBounds.center.x)/this.worldBoundsSize.x+.5,l=(I.y-this.worldBounds.center.y)/this.worldBoundsSize.y+.5,g=(I.z-this.worldBounds.center.z)/this.worldBoundsSize.z+.5,f=pc.math.lerp(this.startAngle*
pc.math.DEG_TO_RAD,this.startAngle2*pc.math.DEG_TO_RAD,d),f=f%(2*Math.PI)/(2*Math.PI),k=b(k);this.particleTex[4*c]=k[0];this.particleTex[4*c+1]=k[1];l=b(l);this.particleTex[4*c+2]=l[0];this.particleTex[4*c+3]=l[1];g=b(g);this.particleTex[4*c+0+4*this.numParticlesPot]=g[0];this.particleTex[4*c+1+4*this.numParticlesPot]=g[1];f=b(f);this.particleTex[4*c+2+4*this.numParticlesPot]=f[0];this.particleTex[4*c+3+4*this.numParticlesPot]=f[1];this.particleTex[4*c+3+8*this.numParticlesPot]=1;d=pc.math.lerp(this.rate,
this.rate2,d);f=Math.max(this.lifetime,(this.numParticles-1)*Math.max(this.rate,this.rate2));l=(-d*c+f)/(f+(this.lifetime+1));d=e(l);f=e(255*l);g=e(65025*l);l=e(160581375*l);d-=f/255;f-=g/255;d=[d,f,g-l/255,l-l/255];this.particleTex[4*c+0+12*this.numParticlesPot]=d[0];this.particleTex[4*c+1+12*this.numParticlesPot]=d[1];this.particleTex[4*c+2+12*this.numParticlesPot]=d[2];this.particleTex[4*c+3+12*this.numParticlesPot]=d[3]}else this.particleTex[4*c]=I.x,this.particleTex[4*c+1]=I.y,this.particleTex[4*
...
[0,0,0];f(this.qVelocity,e);var l=[0,0,0];f(this.qVelocity2,l);c=[0,0,0];f(this.qLocalVelocity,c);var k=[0,0,0];f(this.qLocalVelocity2,k);var h=Math.max(e[0],l[0]),h=Math.max(h,e[1]),h=Math.max(h,l[1]),h=Math.max(h,e[2]),h=Math.max(h,l[2]),e=Math.max(c[0],k[0]),e=Math.max(e,c[1]),e=Math.max(e,k[1]),e=Math.max(e,c[2]),e=Math.max(e,k[2]);this.maxVel=h+e}if(!this.useCpu){this.internalTex0=p(b,a,1,d(this.qLocalVelocity,this.qLocalVelocityDiv));this.internalTex1=p(b,a,1,d(this.qVelocity,this.qVelocityDiv));
c=this.qRotSpeed;for(var k=this.qScale,h=this.qScaleDiv,e=this.qRotSpeedDiv,l=this.qAlphaDiv,m=Array(4*c.length),n=0;n<c.length;n++)m[4*n]=c[n],m[4*n+1]=k[n],m[4*n+2]=0,m[4*n+3]=(255*h[n]<<16|255*e[n]<<8|255*l[n])/16777216;this.internalTex2=p(b,a,1,m)}c=this.qColor;k=this.qAlpha;h=Array(4*k.length);for(e=0;e<k.length;e++)h[4*e]=c[3*e],h[4*e+1]=c[3*e+1],h[4*e+2]=c[3*e+2],h[4*e+3]=k[e];this.internalTex3=p(b,a,1,h,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0)},_initializeTextures:function(){this.colorMap&&(this.material.setParameter("colorMap",
...
d,b,pc.BUFFER_DYNAMIC);this.indexBuffer=new pc.IndexBuffer(this.graphicsDevice,pc.INDEXFORMAT_UINT16,c);d=new Float32Array(this.vertexBuffer.lock());var f,g;this.useMesh&&(f=new Float32Array(this.mesh.vertexBuffer.lock()),g=f.length/this.mesh.vertexBuffer.numVertices);for(var e,c=0;c<b;c++){e=Math.floor(c/this.numParticleVerts);if(this.useMesh){var l=c%this.numParticleVerts;d[4*c]=f[l*g];d[4*c+1]=f[l*g+1];d[4*c+2]=f[l*g+2]}else l=c%4,d[4*c]=k[l][0],d[4*c+1]=k[l][1],d[4*c+2]=0;d[4*c+3]=e}this.useCpu&&
(this.vbCPU=new Float32Array(d),this.vbOld=new Float32Array(this.vbCPU.length));this.vertexBuffer.unlock();this.useMesh&&this.mesh.vertexBuffer.unlock();b=0;g=new Uint16Array(this.indexBuffer.lock());this.useMesh&&(f=new Uint16Array(this.mesh.indexBuffer[0].lock()));for(c=0;c<a;c++)if(this.useMesh)for(d=0;d<this.numParticleIndices;d++)g[c*this.numParticleIndices+d]=f[d]+c*this.numParticleVerts;else d=4*c,g[b++]=d,g[b++]=d+1,g[b++]=d+2,g[b++]=d,g[b++]=d+2,g[b++]=d+3;this.indexBuffer.unlock();this.useMesh&&
...
this.emitterScaleUniform);this.localSpace&&this.meshInstance.node&&(k=this.meshInstance.node.getPosition(),this.emitterPosUniform[0]=k.x,this.emitterPosUniform[1]=k.y,this.emitterPosUniform[2]=k.z,this.material.setParameter("emitterPos",this.emitterPosUniform));if(this.useCpu){h=new Float32Array(this.vertexBuffer.lock());if(this.meshInstance.node){e=this.meshInstance.node.worldTransform;for(k=0;12>k;k++)A.data[k]=e.data[k];H=this.meshInstance.node.localScale;F=Math.max(Math.max(H.x,H.y),H.z)}k=null===
this.meshInstance.node||this.localSpace?pc.Vec3.ZERO:this.meshInstance.node.getPosition();var p=this.camera?this.camera._node.getPosition():pc.Vec3.ZERO,m,n,q,r,I,V,W,U=this.precision-1;for(e=0;e<this.numParticles;e++){var L=Math.floor(this.vbCPU[e*this.numParticleVerts*4+3]),Z=this.particleTex[4*L+0+8*this.numParticlesPot];w.x=Z;w.y=this.particleTex[4*L+1+8*this.numParticlesPot];w.z=this.particleTex[4*L+2+8*this.numParticlesPot];var T=this.rate+(this.rate2-this.rate)*Z,R=this.lifetime,X=this.particleTex[4*
L+3+4*this.numParticlesPot]+b,la=Math.max(Math.min(X/R,1),0),ha=0;d=0;var ka=0<X&&X<R;ka?(g=la*U,m=Math.floor(g),n=Math.ceil(g),g%=1,d=this.qRotSpeed[m],f=this.qRotSpeed[n],q=d+(f-d)*g,d=this.qRotSpeed2[m],f=this.qRotSpeed2[n],r=d+(f-d)*g,d=this.qScale[m],f=this.qScale[n],ha=d+(f-d)*g,d=this.qScale2[m],f=this.qScale2[n],I=d+(f-d)*g,d=this.qAlpha[m],f=this.qAlpha[n],V=d+(f-d)*g,d=this.qAlpha2[m],f=this.qAlpha2[n],W=d+(f-d)*g,m*=3,n*=3,d=this.qLocalVelocity[m],f=this.qLocalVelocity[n],v.x=d+(f-d)*g,
d=this.qLocalVelocity[m+1],f=this.qLocalVelocity[n+1],v.y=d+(f-d)*g,d=this.qLocalVelocity[m+2],f=this.qLocalVelocity[n+2],v.z=d+(f-d)*g,d=this.qLocalVelocity2[m],f=this.qLocalVelocity2[n],u.x=d+(f-d)*g,d=this.qLocalVelocity2[m+1],f=this.qLocalVelocity2[n+1],u.y=d+(f-d)*g,d=this.qLocalVelocity2[m+2],f=this.qLocalVelocity2[n+2],u.z=d+(f-d)*g,d=this.qVelocity[m],f=this.qVelocity[n],t.x=d+(f-d)*g,d=this.qVelocity[m+1],f=this.qVelocity[n+1],t.y=d+(f-d)*g,d=this.qVelocity[m+2],f=this.qVelocity[n+2],t.z=
d+(f-d)*g,d=this.qVelocity2[m],f=this.qVelocity2[n],y.x=d+(f-d)*g,d=this.qVelocity2[m+1],f=this.qVelocity2[n+1],y.y=d+(f-d)*g,d=this.qVelocity2[m+2],f=this.qVelocity2[n+2],y.z=d+(f-d)*g,v.x+=(u.x-v.x)*w.x,v.y+=(u.y-v.y)*w.y,v.z+=(u.z-v.z)*w.z,0<this.initialVelocity&&(this.emitterShape===pc.EMITTERSHAPE_SPHERE?(G.copy(w).scale(2).sub(pc.Vec3.ONE).normalize(),v.add(G.scale(this.initialVelocity))):v.add(pc.Vec3.FORWARD.scale(this.initialVelocity))),t.x+=(y.x-t.x)*w.x,t.y+=(y.y-t.y)*w.y,t.z+=(y.z-t.z)*
...
1));0>this.particleTex[4*L+3+8*this.numParticlesPot]&&(ka=!1);this.particleTex[4*L+3+4*this.numParticlesPot]=X;for(q=0;q<this.numParticleVerts;q++)Z=this.vbCPU[e*this.numParticleVerts*4+4*q],T=this.vbCPU[e*this.numParticleVerts*4+4*q+1],R=this.vbCPU[e*this.numParticleVerts*4+4*q+2],ka||(Z=T=R=0),X=e*this.numParticleVerts*14+14*q,h[X]=z.x,h[X+1]=z.y,h[X+2]=z.z,h[X+3]=la,h[X+4]=this.alignToMotion?0:this.particleTex[4*L+3],h[X+5]=ha,h[X+6]=d,h[X+7]=C.x,h[X+8]=Z,h[X+9]=T,h[X+10]=R,h[X+11]=C.y,h[X+12]=
C.z}if(this.sort>pc.PARTICLESORT_NONE&&this.camera){k=this.particleDistance;for(e=0;e<this.numParticles;e++)this.vbToSort[e]=[e,k[Math.floor(this.vbCPU[e*this.numParticleVerts*4+3])]];this.vbOld.set(this.vbCPU);this.vbToSort.sort(function(a,b){return a[1]-b[1]});for(e=0;e<this.numParticles;e++)for(h=this.vbToSort[e][0]*this.numParticleVerts*4,p=e*this.numParticleVerts*4,k=0;k<4*this.numParticleVerts;k++)this.vbCPU[p+k]=this.vbOld[h+k]}}else e.setBlending(!1),e.setColorWrite(!0,!0,!0,!0),e.setCullMode(pc.CULLFACE_NONE),
e.setDepthTest(!1),e.setDepthWrite(!1),this.frameRandomUniform[0]=Math.random(),this.frameRandomUniform[1]=Math.random(),this.frameRandomUniform[2]=Math.random(),this.constantGraphSampleSize.setValue(1/this.precision),this.constantGraphNumSamples.setValue(this.precision),this.constantNumParticles.setValue(this.numParticles),this.constantNumParticlesPot.setValue(this.numParticlesPot),this.constantInternalTex0.setValue(this.internalTex0),this.constantInternalTex1.setValue(this.internalTex1),this.constantInternalTex2.setValue(this.internalTex2),
...
pc.calculateNormals=function(e,b){var a=b.length/3,c=e.length/3,d,f,g,l,k=new pc.Vec3,p=new pc.Vec3,h=new pc.Vec3,n=new pc.Vec3,q=new pc.Vec3,m=new pc.Vec3,r=[];for(l=0;l<e.length;l++)r[l]=0;for(l=0;l<a;l++)d=b[3*l],f=b[3*l+1],g=b[3*l+2],k.set(e[3*d],e[3*d+1],e[3*d+2]),p.set(e[3*f],e[3*f+1],e[3*f+2]),h.set(e[3*g],e[3*g+1],e[3*g+2]),n.sub2(p,k),q.sub2(h,k),m.cross(n,q).normalize(),r[3*d]+=m.x,r[3*d+1]+=m.y,r[3*d+2]+=m.z,r[3*f]+=m.x,r[3*f+1]+=m.y,r[3*f+2]+=m.z,r[3*g]+=m.x,r[3*g+1]+=m.y,r[3*g+2]+=m.z;
for(l=0;l<c;l++)a=r[3*l],d=r[3*l+1],f=r[3*l+2],a=1/Math.sqrt(a*a+d*d+f*f),r[3*l]*=a,r[3*l+1]*=a,r[3*l+2]*=a;return r};
pc.calculateTangents=function(e,b,a,c){var d=c.length/3,f=e.length/3,g,l,k,p,h,n,q,m,r,t,v,y,u,w,x=new pc.Vec3,D=new pc.Vec3,z=new pc.Vec3,C=new pc.Vec3,A=new pc.Vec3,B=new pc.Vec2,J=new pc.Vec2,F=new pc.Vec2,H,E=new Float32Array(3*f),G=new Float32Array(3*f),I=[];for(H=0;H<d;H++)g=c[3*H],l=c[3*H+1],k=c[3*H+2],z.set(e[3*g],e[3*g+1],e[3*g+2]),C.set(e[3*l],e[3*l+1],e[3*l+2]),A.set(e[3*k],e[3*k+1],e[3*k+2]),B.set(a[2*g],a[2*g+1]),J.set(a[2*l],a[2*l+1]),F.set(a[2*k],a[2*k+1]),p=C.x-z.x,h=A.x-z.x,n=C.y-
...
a=new pc.Vec3;for(H=0;H<f;H++)e.set(b[3*H],b[3*H+1],b[3*H+2]),y.set(E[3*H],E[3*H+1],E[3*H+2]),u.set(G[3*H],G[3*H+1],G[3*H+2]),c=e.dot(y),a.copy(e).scale(c),a.sub2(y,a).normalize(),I[4*H]=a.x,I[4*H+1]=a.y,I[4*H+2]=a.z,a.cross(e,y),I[4*H+3]=0>a.dot(u)?-1:1;return I};
pc.createMesh=function(e,b,a){var c=a&&void 0!==a.normals?a.normals:null,d=a&&void 0!==a.tangents?a.tangents:null,f=a&&void 0!==a.colors?a.colors:null,g=a&&void 0!==a.uvs?a.uvs:null,l=a&&void 0!==a.uvs1?a.uvs1:null,k=a&&void 0!==a.indices?a.indices:null,p=a&&void 0!==a.blendIndices?a.blendIndices:null,h=a&&void 0!==a.blendWeights?a.blendWeights:null;a=[{semantic:pc.SEMANTIC_POSITION,components:3,type:pc.TYPE_FLOAT32}];null!==c&&a.push({semantic:pc.SEMANTIC_NORMAL,components:3,type:pc.TYPE_FLOAT32});
...
m],l[2*m+1]),null!==p&&q.element[pc.SEMANTIC_BLENDINDICES].set(p[2*m],p[2*m+1]),null!==h&&q.element[pc.SEMANTIC_BLENDWEIGHT].set(h[2*m],h[2*m+1]),q.next();q.end();c=null;if(d=null!==k)c=new pc.IndexBuffer(e,pc.INDEXFORMAT_UINT16,k.length),(new Uint16Array(c.lock())).set(k),c.unlock();e=new pc.BoundingBox;e.compute(b);b=new pc.Mesh;b.vertexBuffer=n;b.indexBuffer[0]=c;b.primitive[0].type=pc.PRIMITIVE_TRIANGLES;b.primitive[0].base=0;b.primitive[0].count=d?k.length:a;b.primitive[0].indexed=d;b.aabb=e;
return b};
pc.createTorus=function(e,b){var a=b&&void 0!==b.tubeRadius?b.tubeRadius:.2,c=b&&void 0!==b.ringRadius?b.ringRadius:.3,d=b&&void 0!==b.segments?b.segments:30,f=b&&void 0!==b.sides?b.sides:20,g=b&&void 0!==b.calculateTangents?b.calculateTangents:!1,l,k,p,h,n,q,m,r,t,v,y=[],u=[],w=[],x=[];for(l=0;l<=f;l++)for(k=0;k<=d;k++)p=Math.cos(2*Math.PI*k/d)*(c+a*Math.cos(2*Math.PI*l/f)),h=Math.sin(2*Math.PI*l/f)*a,n=Math.sin(2*Math.PI*k/d)*(c+a*Math.cos(2*Math.PI*l/f)),q=Math.cos(2*Math.PI*k/d)*Math.cos(2*Math.PI*
l/f),m=Math.sin(2*Math.PI*l/f),r=Math.sin(2*Math.PI*k/d)*Math.cos(2*Math.PI*l/f),t=l/f,v=1-k/d,y.push(p,h,n),u.push(q,m,r),w.push(t,v),l<f&&k<d&&(p=l*(d+1)+k,h=(l+1)*(d+1)+k,n=l*(d+1)+(k+1),q=(l+1)*(d+1)+(k+1),x.push(p,h,n),x.push(h,q,n));a={normals:u,uvs:w,indices:x};g&&(a.tangents=pc.calculateTangents(y,u,w,x));return pc.createMesh(e,y,a)};
pc._createConeData=function(e,b,a,c,d,f){var g,l,k,p,h,n=new pc.Vec3,q=new pc.Vec3;k=new pc.Vec3;var m,r=[],t=[],v=[],y=[],u=[],w;if(0<a)for(g=0;g<=c;g++)for(l=0;l<=d;l++)w=l/d*2*Math.PI-Math.PI,m=Math.sin(w),w=Math.cos(w),h=new pc.Vec3(m*e,-a/2,w*e),p=new pc.Vec3(m*b,a/2,w*b),n.lerp(h,p,g/c),q.sub2(p,h).normalize(),m=new pc.Vec3(w,0,-m),k.cross(m,q).normalize(),r.push(n.x,n.y,n.z),t.push(k.x,k.y,k.z),p=l/d,h=g/c,v.push(p,h),m=h,h=p,p=m,p/=3,p=p*primitiveUv1PaddingScale+primitiveUv1Padding,h=h*primitiveUv1PaddingScale+
primitiveUv1Padding,y.push(p,h),g<c&&l<d&&(m=g*(d+1)+l,w=g*(d+1)+(l+1),p=(g+1)*(d+1)+l,h=(g+1)*(d+1)+(l+1),u.push(m,w,p),u.push(w,h,p));if(f){e=Math.floor(d/2);g=a/2;for(a=0;a<=e;a++)for(w=a*Math.PI*.5/e,m=Math.sin(w),w=Math.cos(w),n=0;n<=d;n++)f=2*n*Math.PI/d-Math.PI/2,p=Math.sin(f),f=Math.cos(f),f*=m,l=w,k=p*m,p=1-n/d,h=1-a/e,r.push(f*b,l*b+g,k*b),t.push(f,l,k),v.push(p,h),p/=3,h/=3,p=p*primitiveUv1PaddingScale+primitiveUv1Padding,h=h*primitiveUv1PaddingScale+primitiveUv1Padding,p+=1/3,y.push(p,
h);q=(c+1)*(d+1);for(a=0;a<e;++a)for(n=0;n<d;++n)m=a*(d+1)+n,w=m+d+1,u.push(q+m+1,q+w,q+m),u.push(q+m+1,q+w+1,q+w);for(a=0;a<=e;a++)for(w=.5*Math.PI+a*Math.PI*.5/e,m=Math.sin(w),w=Math.cos(w),n=0;n<=d;n++)f=2*n*Math.PI/d-Math.PI/2,p=Math.sin(f),f=Math.cos(f),f*=m,l=w,k=p*m,p=1-n/d,h=1-a/e,r.push(f*b,l*b-g,k*b),t.push(f,l,k),v.push(p,h),p/=3,h/=3,p=p*primitiveUv1PaddingScale+primitiveUv1Padding,h=h*primitiveUv1PaddingScale+primitiveUv1Padding,p+=2/3,y.push(p,h);q=(c+1)*(d+1)+(d+1)*(e+1);for(a=0;a<
e;++a)for(n=0;n<d;++n)m=a*(d+1)+n,w=m+d+1,u.push(q+m+1,q+w,q+m),u.push(q+m+1,q+w+1,q+w)}else{q=(c+1)*(d+1);if(0<e)for(g=0;g<d;g++)w=g/d*2*Math.PI,f=Math.sin(w),l=-a/2,k=Math.cos(w),p=1-(f+1)/2,h=(k+1)/2,r.push(f*e,l,k*e),t.push(0,-1,0),v.push(p,h),p/=3,h/=3,p=p*primitiveUv1PaddingScale+primitiveUv1Padding,h=h*primitiveUv1PaddingScale+primitiveUv1Padding,p+=1/3,y.push(p,h),1<g&&u.push(q,q+g,q+g-1);q+=d;if(0<b)for(g=0;g<d;g++)w=g/d*2*Math.PI,f=Math.sin(w),l=a/2,k=Math.cos(w),p=1-(f+1)/2,h=(k+1)/2,r.push(f*
...
pc.createSphere=function(e,b){var a=b&&void 0!==b.radius?b.radius:.5,c=b&&void 0!==b.latitudeBands?b.latitudeBands:16,d=b&&void 0!==b.longitudeBands?b.longitudeBands:16,f=b&&void 0!==b.calculateTangents?b.calculateTangents:!1,g,l,k,p,h,n,q,m,r,t=[],v=[],y=[],u=[];for(l=0;l<=c;l++)for(g=l*Math.PI/c,k=Math.sin(g),p=Math.cos(g),g=0;g<=d;g++)h=2*g*Math.PI/d-Math.PI/2,n=Math.sin(h),h=Math.cos(h),h*=k,q=p,n*=k,m=1-g/d,r=1-l/c,t.push(h*a,q*a,n*a),v.push(h,q,n),y.push(m,r);for(l=0;l<c;++l)for(g=0;g<d;++g)a=
l*(d+1)+g,k=a+d+1,u.push(a+1,k,a),u.push(a+1,k+1,k);c={normals:v,uvs:y,uvs1:y,indices:u};f&&(c.tangents=pc.calculateTangents(t,v,y,u));return pc.createMesh(e,t,c)};
pc.createPlane=function(e,b){var a=b&&void 0!==b.halfExtents?b.halfExtents:new pc.Vec2(.5,.5),c=b&&void 0!==b.widthSegments?b.widthSegments:5,d=b&&void 0!==b.lengthSegments?b.lengthSegments:5,f=b&&void 0!==b.calculateTangents?b.calculateTangents:!1,g,l,k,p,h,n,q=[],m=[],r=[],t=[],v=0;for(g=0;g<=c;g++)for(l=0;l<=d;l++)k=-a.x+2*a.x*g/c,p=-(-a.y+2*a.y*l/d),h=g/c,n=l/d,q.push(k,0,p),m.push(0,1,0),r.push(h,n),g<c&&l<d&&(t.push(v+d+1,v+1,v),t.push(v+d+1,v+d+2,v+1)),v++;a={normals:m,uvs:r,uvs1:r,indices:t};
...
f,g,e=this.shadowCasters,l=0;l<a.length;l++)d=a[l],g=d.material,f=g.blendType===pc.BLEND_NONE?this.opaqueMeshInstances:this.transparentMeshInstances,0>f.indexOf(d)&&f.push(d),!b&&d.castShadow&&0>e.indexOf(d)&&e.push(d),!this.passThrough&&0<=c&&g._shaderVersion!==c&&(g.updateShader!==pc.Material.prototype.updateShader&&(g.clearVariants(),g.shader=null),g._shaderVersion=c);this.passThrough||(this._dirty=!0)};p.prototype.removeMeshInstances=function(a,b){var c,d,f,g,e,l,k,h=this.opaqueMeshInstances,
p=this.transparentMeshInstances,n=this.shadowCasters;for(c=0;c<a.length;c++){f=a[c];g=-1;e=0;l=h.length;for(d=0;d<l;d++){k=h[d];if(k===f){g=d;e=1;break}if(k._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&h.splice(g,e);g=-1;e=0;l=p.length;for(d=0;d<l;d++){k=p[d];if(k===f){g=d;e=1;break}if(k._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&p.splice(g,e);b||(d=n.indexOf(f),0<=d&&n.splice(d,1))}this._dirty=!0};p.prototype.clearMeshInstances=function(a){if(0!==this.opaqueMeshInstances.length||
...
function(){this._generateCameraHash()};p.prototype._calculateSortDistances=function(a,b,c,d){var f,g,e,l,k;for(f=0;f<b;f++)g=a[f],g.command||g.layer<=pc.LAYER_FX||(e=g.aabb.center,l=e.x-c.x,k=e.y-c.y,e=e.z-c.z,g.zdist=l*d.x+k*d.y+e*d.z)};p.prototype._sortVisible=function(a,b,c){var e=this.instances,l=a?this.transparentSortMode:this.opaqueSortMode;if(l!==pc.SORTMODE_NONE)if(a=a?e.visibleTransparent[c]:e.visibleOpaque[c],l===pc.SORTMODE_CUSTOM)d=b.getPosition(),f=b.forward,this.customCalculateSortValues&&
this.customCalculateSortValues(a.list,a.length,d,f),a.list.length!==a.length&&(a.list.length=a.length),this.customSortCallback&&a.list.sort(this.customSortCallback);else{if(l===pc.SORTMODE_BACK2FRONT||l===pc.SORTMODE_FRONT2BACK)d=b.getPosition(),f=b.forward,this._calculateSortDistances(a.list,a.length,d,f);a.list.length!==a.length&&(a.list.length=a.length);a.list.sort(g[l])}};return{Layer:p,InstanceList:k,VisibleInstanceList:function(){this.list=[];this.length=0;this.done=!1}}}());Object.assign(pc,function(){var e=function(){this.layerList=[];this.subLayerList=[];this.subLayerEnabled=[];this._opaqueOrder={};this._transparentOrder={};this._dirtyCameras=this._dirtyLights=this._dirtyBlend=this._dirty=!1;this._meshInstances=[];this._lights=[];this.cameras=[];this._sortedLights=[[],[],[]];this._lightShadowCasters=[];this._globalLightCameras=[];this._globalLightCameraIds=[];this._renderedRt=[];this._renderedByCam=[];this._renderedLayer=[];this._renderList=[];this._renderListCamera=
...
c.material&&c.material._dirtyBlend&&(this._dirtyBlend=!0,c.material._dirtyBlend=!1))}for(b=0;b<f;b++)this.layerList[b]._dirty=!1,this.layerList[b]._version++}if(this._dirtyBlend){var g=g|pc.COMPUPDATED_BLEND,k,p;for(b=0;b<f;b++)if(d=this.layerList[b],!d.passThrough){e=d.opaqueMeshInstances;c=d.transparentMeshInstances;k=[];p=[];for(a=0;a<e.length;a++)e[a].material&&e[a].material.blendType!==pc.BLEND_NONE?p.push(e[a]):k.push(e[a]);for(a=0;a<c.length;a++)c[a].material&&c[a].material.blendType!==pc.BLEND_NONE?
p.push(c[a]):k.push(c[a]);d.opaqueMeshInstances.length=k.length;for(a=0;a<k.length;a++)d.opaqueMeshInstances[a]=k[a];d.transparentMeshInstances.length=p.length;for(a=0;a<p.length;a++)d.transparentMeshInstances[a]=p[a]}this._dirtyBlend=!1}this._dirty=!1;if(this._dirtyLights)for(g|=pc.COMPUPDATED_LIGHTS,this._lights.length=0,b=this._lightShadowCasters.length=0;b<f;b++)for(d=this.layerList[b],e=d._lights,a=0;a<e.length;a++)k=e[a],c=this._lights.indexOf(k),0>c&&(this._lights.push(k),c=this._lights.length-
1),(k=this._lightShadowCasters[c])||(this._lightShadowCasters[c]=[]);if(this._dirtyLights)for(this._sortLights(this),this._dirtyLights=!1,b=0;b<f;b++)d=this.layerList[b],this._sortLights(d),d._dirtyLights=!1;if(g)for(b=0;b<f;b++)for(d=this.layerList[b],e=d._lights,a=0;a<e.length;a++){k=e[a];c=this._lights.indexOf(k);k=this._lightShadowCasters[c];p=d.shadowCasters;for(c=0;c<k.length;)0>this._meshInstances.indexOf(k[c])?(k[c]=k[k.length-1],--k.length):c++;for(c=0;c<p.length;c++)0>k.indexOf(p[c])&&k.push(p[c])}if(g&
pc.COMPUPDATED_LIGHTS||this._dirtyCameras)for(this._globalLightCameras.length=0,e=this._sortedLights[pc.LIGHTTYPE_DIRECTIONAL],a=0;a<e.length;a++)for(k=e[a],this._globalLightCameras[a]=[],b=0;b<f;b++)if(d=this.layerList[b],!(0>d._sortedLights[pc.LIGHTTYPE_DIRECTIONAL].indexOf(k)))for(c=0;c<d.cameras.length;c++)0<=this._globalLightCameras[a].indexOf(d.cameras[c])||this._globalLightCameras[a].push(d.cameras[c]);if(this._dirtyCameras){g|=pc.COMPUPDATED_CAMERAS;for(b=this.cameras.length=0;b<f;b++)for(d=
this.layerList[b],a=0;a<d.cameras.length;a++)e=d.cameras[a],c=this.cameras.indexOf(e),0>c&&this.cameras.push(e);this._renderList.length=0;for(b=c=this._renderListCamera.length=0;b<f;b++)if(c)c--;else if(d=this.layerList[b],0!==d.cameras.length||d.isPostEffect)if(k=d._cameraHash,0===k)this._renderList.push(b),this._renderListCamera.push(0);else{e=1;for(a=b+1;a<f;a++)if(p=this.layerList[a]._cameraHash,k!==p){e=a-b-1;break}else a===f-1&&(e=a-b);if(1===e)for(k=0;k<d.cameras.length;k++)this._renderList.push(b),
this._renderListCamera.push(k);else{for(k=0;k<d.cameras.length;k++)for(a=0;a<=e;a++)this._renderList.push(b+a),this._renderListCamera.push(k);c=e}}this._dirtyCameras=!1;for(b=0;b<f;b++)this.layerList[b]._dirtyCameras=!1}if(g&pc.COMPUPDATED_LIGHTS||g&pc.COMPUPDATED_CAMERAS)for(a=this._globalLightCameraIds.length=0;a<this._globalLightCameras.length;a++){e=[];for(b=0;b<this._globalLightCameras[a].length;b++)c=this.cameras.indexOf(this._globalLightCameras[a][b]),0>c||e.push(c);this._globalLightCameraIds.push(e)}return g};
...
this._meshes[a]=g?f.call(this,g):null;this.fire("set:meshes")};a.prototype._createSimpleMesh=function(a){var c=a.rect,f=this._atlas.texture.width,g=this._atlas.texture.height,l=c.z/this._pixelsPerUnit,k=c.w/this._pixelsPerUnit,p=a.pivot.x;a=a.pivot.y;var h=c.x/f,n=c.y/g,f=(c.x+c.z)/f,c=(c.y+c.w)/g;return pc.createMesh(this._device,[-p*l,-a*k,0,(1-p)*l,-a*k,0,(1-p)*l,(1-a)*k,0,-p*l,(1-a)*k,0],{uvs:[h,n,f,n,f,c,h,c],normals:e,indices:b})};a.prototype._create9SliceMesh=function(){var a=pc.Vec2.ONE,b,
f,g,e,k,p,h=[],n=[],q=[],m=[],r=0;for(b=0;3>=b;b++)for(k=0===b||3===b?0:1,f=0;3>=f;f++)g=-a.x+2*a.x*(1>=b?0:3)/3,e=-(-a.y+2*a.y*(1>=f?0:3)/3),p=0===f||3===f?0:1,h.push(-g,0,e),n.push(0,1,0),q.push(k,p),3>b&&3>f&&(m.push(r+3+1,r+1,r),m.push(r+3+1,r+3+2,r+1)),r++;return pc.createMesh(this._device,h,{normals:n,uvs:q,indices:m})};a.prototype._onSetFrames=function(a){this._updatingProperties?this._meshesDirty=!0:this._createMeshes()};a.prototype._onFrameChanged=function(a,b){var c=this._frameKeys.indexOf(a);
...
null;this._time=0;this.looping=!0;this._interpolatedKeys=[];this._interpolatedKeyDict={};this._currKeyIndices={};this.graph=null;var d=this;b(a)};b.prototype.addTime=function(a){if(null!==this._animation){var b,d,f,g,e,k,p,h=this._animation._nodes;b=this._animation.duration;if(this._time!==b||this.looping){this._time+=a;if(this._time>b)for(this._time=this.looping?0:b,b=0;b<h.length;b++)d=h[b],f=d._name,this._currKeyIndices[f]=0;else if(0>this._time)for(this._time=this.looping?b:0,b=0;b<h.length;b++)d=
h[b],f=d._name,this._currKeyIndices[f]=d._keys.length-2;a=0<=a?1:-1;for(b=0;b<h.length;b++)if(d=h[b],f=d._name,d=d._keys,g=this._interpolatedKeyDict[f],void 0!==g){p=!1;if(1!==d.length)for(var n=this._currKeyIndices[f];n<d.length-1&&0<=n;n+=a)if(e=d[n],k=d[n+1],e.time<=this._time&&k.time>=this._time){p=(this._time-e.time)/(k.time-e.time);g._pos.lerp(e.position,k.position,p);g._quat.slerp(e.rotation,k.rotation,p);g._scale.lerp(e.scale,k.scale,p);g._written=!0;this._currKeyIndices[f]=n;p=!0;break}if(1===
d.length||!p&&0===this._time&&this.looping)g._pos.copy(d[0].position),g._quat.copy(d[0].rotation),g._scale.copy(d[0].scale),g._written=!0}}}};b.prototype.blend=function(a,b,d){for(var c=this._interpolatedKeys.length,g=0;g<c;g++){var e=a._interpolatedKeys[g],k=b._interpolatedKeys[g],p=this._interpolatedKeys[g];e._written&&k._written?(p._quat.slerp(e._quat,b._interpolatedKeys[g]._quat,d),p._pos.lerp(e._pos,b._interpolatedKeys[g]._pos,d),p._scale.lerp(e._scale,k._scale,d),p._written=!0):e._written?(p._quat.copy(e._quat),
p._pos.copy(e._pos),p._scale.copy(e._scale),p._written=!0):k._written&&(p._quat.copy(k._quat),p._pos.copy(k._pos),p._scale.copy(k._scale),p._written=!0)}};Object.defineProperty(b.prototype,"animation",{get:function(){return this._animation},set:function(a){this._animation=a;this.currentTime=0}});b.prototype.getAnimation=function(){return this._animation};Object.defineProperty(b.prototype,"currentTime",{get:function(){return this._time},set:function(a){this._time=a;a=this._interpolatedKeys.length;
...
this._actions[b]?this._actions[b].push({type:pc.ACTION_GAMEPAD,button:c,pad:a}):this._actions[b]=[{type:pc.ACTION_GAMEPAD,button:c,pad:a}]};e.prototype.registerAxis=function(b){var a=b.name;this._axes[a]||(this._axes[a]=[]);var c=this._axes[a].push(a);b=b||{};b.pad=b.pad||pc.PAD_1;var d=function(d,g,e,k){switch(g){case "mousex":d._mouse.on(pc.EVENT_MOUSEMOVE,function(b){d._axesValues[a][c]=b.dx/10});break;case "mousey":d._mouse.on(pc.EVENT_MOUSEMOVE,function(b){d._axesValues[a][c]=b.dy/10});break;
case "key":d._axes[a].push(function(){return d._keyboard.isPressed(k)?e:0});break;case "padrx":d._axes[a].push(function(){return d._gamepads.getAxis(b.pad,pc.PAD_R_STICK_X)});break;case "padry":d._axes[a].push(function(){return d._gamepads.getAxis(b.pad,pc.PAD_R_STICK_Y)});break;case "padlx":d._axes[a].push(function(){return d._gamepads.getAxis(b.pad,pc.PAD_L_STICK_X)});break;case "padly":d._axes[a].push(function(){return d._gamepads.getAxis(b.pad,pc.PAD_L_STICK_Y)});break;default:throw Error("Unknown axis");
...
e.prototype._enableKeyboard=function(){this._keyboard=new pc.Keyboard;if(!this._element)throw Error("Controller must be attached to an Element");this._keyboard.attach(this._element)};return{Controller:e}}());Object.assign(pc,function(){var e,b,a=new pc.Vec3,c=new pc.Vec3,d=new pc.Vec3,f=new pc.Vec3,g=new pc.Vec3,l=new pc.Vec3,k=new pc.Vec3,p=new pc.Vec3,h=new pc.Vec3,n=new pc.Vec2,q=new pc.Vec3,m=new pc.Vec3,r=new pc.Vec3,t=new pc.Vec3,v=new pc.Vec3,y=new pc.Vec3,u=new pc.Vec3,w=new pc.Vec3,x=new pc.Vec4,D=function(a,b,c){d.sub2(b,a);f.sub2(c[0],a);g.sub2(c[1],a);l.sub2(c[2],a);p.cross(l,d);if(0<=f.dot(p)){if(0>-g.dot(p)||0>h.cross(d,g).dot(f))return!1}else if(k.sub2(c[3],a),0>k.dot(p)||0>h.cross(d,f).dot(k))return!1;
return 1E-8>d.sub2(c[0],c[2]).lengthSq()||1E-8>d.sub2(c[1],c[3]).lengthSq()?!1:!0},z=function(a,b,c){this.event=a;this.element=b;this.camera=c;this._stopPropagation=!1};Object.assign(z.prototype,{stopPropagation:function(){this._stopPropagation=!0;this.event.stopImmediatePropagation();this.event.stopPropagation()}});var C=function(a,b,c,d,f,g,e){z.call(this,a,b,c);this.x=d;this.y=f;this.ctrlKey=a.ctrlKey||!1;this.altKey=a.altKey||!1;this.shiftKey=a.shiftKey||!1;this.metaKey=a.metaKey||!1;this.button=
a.button;pc.Mouse.isPointerLocked()?(this.dx=a.movementX||a.webkitMovementX||a.mozMovementX||0,this.dy=a.movementY||a.webkitMovementY||a.mozMovementY||0):(this.dx=d-g,this.dy=f-e);this.wheel=a.detail?-1*a.detail:a.wheelDelta?a.wheelDelta/120:0};C.prototype=Object.create(z.prototype);C.prototype.constructor=C;var A=function(a,b,c,d,f,g){z.call(this,a,b,c);this.touches=a.touches;this.changedTouches=a.changedTouches;this.x=d;this.y=f};A.prototype=Object.create(z.prototype);A.prototype.constructor=A;
...
d,f,g;for(d=c.length-1;0<=d;d--){var e=c[d],l=0;f=0;for(g=a.changedTouches.length;f<g;f++)if(b[a.changedTouches[f].identifier])l++;else{var k=this._calcTouchCoords(a.changedTouches[f]),h=this._getTargetElement(e,k.x,k.y);h&&(l++,b[a.changedTouches[f].identifier]={element:h,camera:e,x:k.x,y:k.y})}if(l===g)break}return b},_handleTouchStart:function(a){if(this._enabled){for(var b=this._determineTouchedElements(a),c=0,d=a.changedTouches.length;c<d;c++){var f=a.changedTouches[c],g=b[f.identifier],e=this._touchedElements[f.identifier];
!g||e&&g.element===e.element||(this._fireEvent(a.type,new A(a,g.element,g.camera,g.x,g.y,this)),this._touchesForWhichTouchLeaveHasFired[f.identifier]=!1)}for(var l in b)this._touchedElements[l]=b[l]}},_handleTouchEnd:function(a){if(this._enabled){var b=this.app.systems.camera.cameras,c;for(c in this._clickedEntities)delete this._clickedEntities[c];c=0;for(var d=a.changedTouches.length;c<d;c++){var f=a.changedTouches[c],g=this._touchedElements[f.identifier];if(g){var e=g.element,l=g.camera,k=g.x,g=
g.y;delete this._touchedElements[f.identifier];delete this._touchesForWhichTouchLeaveHasFired[f.identifier];this._fireEvent(a.type,new A(a,e,l,k,g,this));if(0===a.touches.length)for(var f=this._calcTouchCoords(f),h=b.length-1;0<=h;h--)this._getTargetElement(b[h],f.x,f.y)!==e||this._clickedEntities[e.entity.getGuid()]||(this._fireEvent("click",new A(a,e,l,k,g,this)),this._clickedEntities[e.entity.getGuid()]=!0)}}}},_handleTouchMove:function(a){a.preventDefault();if(this._enabled)for(var b=this._determineTouchedElements(a),
c=0,d=a.changedTouches.length;c<d;c++){var f=a.changedTouches[c],g=b[f.identifier],e=this._touchedElements[f.identifier];if(e){var l=this._calcTouchCoords(f);g&&g.element===e.element||this._touchesForWhichTouchLeaveHasFired[f.identifier]||(this._fireEvent("touchleave",new A(a,e.element,e.camera,l.x,l.y,this)),this._touchesForWhichTouchLeaveHasFired[f.identifier]=!0);this._fireEvent("touchmove",new A(a,e.element,e.camera,l.x,l.y,this))}}},_onElementMouseEvent:function(a){var c,d=this._hoveredElement;
this._hoveredElement=null;for(var f=this.app.systems.camera.cameras,g,l=f.length-1;0<=l&&!(g=f[l],c=this._getTargetElement(g,e,b));l--);c&&(this._fireEvent(a.type,new C(a,c,g,e,b,this._lastX,this._lastY)),this._hoveredElement=c,a.type===pc.EVENT_MOUSEDOWN&&(this._pressedElement=c));d!==this._hoveredElement&&(d&&this._fireEvent("mouseleave",new C(a,d,g,e,b,this._lastX,this._lastY)),this._hoveredElement&&this._fireEvent("mouseenter",new C(a,this._hoveredElement,g,e,b,this._lastX,this._lastY)));a.type===
pc.EVENT_MOUSEUP&&this._pressedElement&&(this._pressedElement===this._hoveredElement?(this._pressedElement=null,this._clickedEntities&&this._clickedEntities[this._hoveredElement.entity.getGuid()]||this._fireEvent("click",new C(a,this._hoveredElement,g,e,b,this._lastX,this._lastY))):this._pressedElement=null)},_fireEvent:function(a,b){for(var c=b.element;;){c.fire(a,b);if(b._stopPropagation)break;if(!c.entity.parent)break;c=c.entity.parent.element;if(!c)break}},_calcMouseCoords:function(a){var c=this._target.getBoundingClientRect(),
...
_buildHitCorners:function(a,b,c,d){if(a.entity&&a.entity.button){var f=a.entity.button.hitPadding||x;q.copy(a.entity.up);m.copy(q).scale(-1);t.copy(a.entity.right);r.copy(t).scale(-1);q.scale(f.w*d);m.scale(f.y*d);t.scale(f.z*c);r.scale(f.x*c);v.copy(b[0]).add(m).add(r);y.copy(b[1]).add(m).add(t);u.copy(b[2]).add(q).add(t);w.copy(b[3]).add(q).add(r);b=[v,y,u,w]}return b},_calculateScaleToScreen:function(a){var b=a.entity;a=a.screen.screen.scale;for(n.set(a,a);b&&!b.screen;)n.mul(b.getLocalScale()),
b=b.parent;return n},_checkElement2d:function(b,d,f,g){if(f.maskedBy&&!this._checkElement2d(b,d,f.maskedBy.element,g))return!1;var e=this.app.graphicsDevice.width,l=this.app.graphicsDevice.height,k=g.rect.z*e,h=g.rect.w*l,p=g.rect.x*e;g=(1-g.rect.y)*l;var m=g-h;b=b*e/this._target.clientWidth;d=d*l/this._target.clientHeight;return b>=p&&b<=p+k&&d<=g&&d>=m&&(b=e*(b-p)/k,d=l-l*(d-m)/h,e=this._calculateScaleToScreen(f),f=this._buildHitCorners(f,f.screenCorners,e.x,e.y),a.set(b,d,1),c.set(b,d,-1),D(a,
c,f))?!0:!1},_checkElement3d:function(b,d,f,g){if(f.maskedBy&&!this._checkElement3d(b,d,f.maskedBy.element,g))return!1;var e=this._target.clientWidth,l=this._target.clientHeight,k=g.rect.z*e,h=g.rect.w*l,p=g.rect.x*e,m=(1-g.rect.y)*l,n=m-h,q=d;return b>=p&&b<=p+k&&d<=m&&q>=n&&(b=e*(b-p)/k,q=l*(q-n)/h,l=f.entity.getWorldTransform().getScale(),f=this._buildHitCorners(f,f.worldCorners,l.x,l.y),g.screenToWorld(b,q,g.nearClip,a),g.screenToWorld(b,q,g.farClip,c),D(a,c,f))?!0:!1}});Object.defineProperty(B.prototype,
...
c._parseScenes(g);c._parseAssets(e);a?b(a):b(null)})}})},preload:function(a){var c=this;c.fire("preload:start");var d=this.assets.list({preload:!0}),e=new b(d.length),k=!1,p=function(){c.graphicsDevice&&!k&&e.done()&&(k=!0,c.fire("preload:end"),a())},h=d.length,n;if(e.length){var q=function(a){e.inc();c.fire("preload:progress",e.count/h);e.done()&&p()},m=function(a,b){e.inc();c.fire("preload:progress",e.count/h);e.done()&&p()};for(n=0;n<d.length;n++)d[n].loaded?(e.inc(),c.fire("preload:progress",
...
0;this.renderer._cullTime=0;this.renderer._sortTime=0;this.renderer._skinTime=0;this.renderer._morphTime=0;this.renderer._instancingTime=0;this.renderer._shadowMapTime=0;this.renderer._depthMapTime=0;this.renderer._forwardTime=0;d=this.stats.drawCalls;d.forward=this.renderer._forwardDrawCalls;d.culled=this.renderer._numDrawCallsCulled;d.depth=0;d.shadow=this.renderer._shadowDrawCalls;d.skinned=this.renderer._skinDrawCalls;d.immediate=0;d.instanced=0;d.removedByInstancing=0;d.total=this.graphicsDevice._drawCallsPerFrame;
d.misc=d.total-(d.forward+d.shadow);this.renderer._depthDrawCalls=0;this.renderer._shadowDrawCalls=0;this.renderer._forwardDrawCalls=0;this.renderer._numDrawCallsCulled=0;this.renderer._skinDrawCalls=0;this.renderer._immediateRendered=0;this.renderer._instancedDrawCalls=0;this.renderer._removedByInstancing=0;this.graphicsDevice._drawCallsPerFrame=0;this.stats.misc.renderTargetCreationTime=this.graphicsDevice.renderTargetCreationTime;d=this.stats.particles;d.updatesPerFrame=d._updatesPerFrame;d.frameTime=
d._frameTime;d._updatesPerFrame=0;d._frameTime=0},setCanvasFillMode:function(a,b,c){this._fillMode=a;this.resizeCanvas(b,c)},setCanvasResolution:function(a,b,c){this._resolutionMode=a;a===pc.RESOLUTION_AUTO&&void 0===b&&(b=this.graphicsDevice.canvas.clientWidth,c=this.graphicsDevice.canvas.clientHeight);this.graphicsDevice.resizeCanvas(b,c)},isFullscreen:function(){return!!document.fullscreenElement},enableFullscreen:function(a,b,c){a=a||this.graphicsDevice.canvas;var d=function(){b();document.removeEventListener("fullscreenchange",
d)},f=function(){c();document.removeEventListener("fullscreenerror",f)};b&&document.addEventListener("fullscreenchange",d,!1);c&&document.addEventListener("fullscreenerror",f,!1);a.requestFullscreen?a.requestFullscreen(Element.ALLOW_KEYBOARD_INPUT):c()},disableFullscreen:function(a){var b=function(){a();document.removeEventListener("fullscreenchange",b)};a&&document.addEventListener("fullscreenchange",b,!1);document.exitFullscreen()},isHidden:function(){return document[this._hiddenAttr]},onVisibilityChange:function(){this.isHidden()?
...
this._onSkyboxChange(a)},_skyboxRemove:function(a){this._skyboxLast&&(this.assets.off("add:"+a.id,this.setSkybox,this),this.assets.off("load:"+a.id,this._onSkyboxChange,this),this.assets.off("remove:"+a.id,this._skyboxRemove,this),this.scene.setSkybox(null),this._skyboxLast=null)},_firstBake:function(){this.lightmapper.bake(null,this.scene.lightmapMode)},_firstBatch:function(){this.scene._needsStaticPrepare&&(this.renderer.prepareStaticMeshes(this.graphicsDevice,this.scene),this.scene._needsStaticPrepare=
!1);this.batcher.generate()},destroy:function(){var a,b,c=this.graphicsDevice.canvas.id;this.off("librariesloaded");document.removeEventListener("visibilitychange",this._visibilityChangeHandler,!1);document.removeEventListener("mozvisibilitychange",this._visibilityChangeHandler,!1);document.removeEventListener("msvisibilitychange",this._visibilityChangeHandler,!1);document.removeEventListener("webkitvisibilitychange",this._visibilityChangeHandler,!1);this.onVisibilityChange=this._visibilityChangeHandler=
null;this.root.destroy();this.root=null;this.mouse&&(this.mouse.off(),this.mouse.detach(),this.mouse=null);this.keyboard&&(this.keyboard.off(),this.keyboard.detach(),this.keyboard=null);this.touch&&(this.touch.off(),this.touch.detach(),this.touch=null);this.elementInput&&(this.elementInput.detach(),this.elementInput=null);this.controller&&(this.controller=null);var l=this.systems.list;a=0;for(b=l.length;a<b;a++)l[a].destroy();pc.ComponentSystem.destroy();b=this.assets.list();for(a=0;a<b.length;a++)b[a].unload(),
b[a].off();this.assets.off();for(var k in this.loader.getHandler("script")._cache)a=this.loader.getHandler("script")._cache[k],(b=a.parentNode)&&b.removeChild(a);this.loader.getHandler("script")._cache={};this.loader.destroy();this.loader=null;this.scene.destroy();this.scene=null;this.systems=[];this.context=null;this.scripts.destroy();this.scripts=null;this._sceneRegistry.destroy();this._sceneRegistry=null;this.lightmapper.destroy();this.lightmapper=null;this.batcher.destroyManager();this.batcher=
...
null;e._applications[c]=null;e._currentApplication===this&&(e._currentApplication=null)}});var a={},c=function(b){return function(c){if(b.graphicsDevice){e._currentApplication=b;pc.app=b;c=c||pc.now();var d;d=pc.math.clamp((c-(b._time||c))/1E3,0,b.maxDeltaTime);d*=b.timeScale;b._time=c;b.vr&&b.vr.display?b.vr.display.requestAnimationFrame(b.tick):window.requestAnimationFrame(b.tick);if(!b.graphicsDevice.contextLost){b.update(d);if(b.autoRender||b.renderNextFrame)b.render(),b.renderNextFrame=!1;a.timestamp=
pc.now();a.target=b;b.fire("frameend",a);b.fire("frameEnd",a);b.vr&&b.vr.display&&b.vr.display.presenting&&b.vr.display.submitFrame()}}}};return{FILLMODE_NONE:"NONE",FILLMODE_FILL_WINDOW:"FILL_WINDOW",FILLMODE_KEEP_ASPECT:"KEEP_ASPECT",RESOLUTION_AUTO:"AUTO",RESOLUTION_FIXED:"FIXED",Application:e}}());pc.ApplicationStats=function(e){this.frame={fps:0,ms:0,dt:0,updateStart:0,updateTime:0,renderStart:0,renderTime:0,physicsStart:0,physicsTime:0,cullTime:0,sortTime:0,skinTime:0,morphTime:0,instancingTime:0,triangles:0,otherPrimitives:0,shaders:0,materials:0,cameras:0,shadowMapUpdates:0,shadowMapTime:0,depthMapTime:0,forwardTime:0,_timeToCountFrames:0,_fpsAccum:0};this.drawCalls={forward:0,depth:0,shadow:0,immediate:0,misc:0,total:0,skinned:0,instanced:0,removedByInstancing:0};this.misc={renderTargetCreationTime:0};
...
this.addModelToLayers():a&&this._asset&&(c=b.assets.get(this._asset))&&c.resource!==this._model&&this._bindModelAsset(c);this._materialAsset&&(c=b.assets.get(this._materialAsset))&&c.resource!==this._material&&this._bindMaterialAsset(c);if(a&&this._mapping)for(var d in this._mapping)this._mapping[d]&&(c=this._getAssetByIdOrPath(this._mapping[d]))&&!c.resource&&b.assets.load(c)},onDisable:function(){var b=this.system.app,a=b.scene;a.off("set:layers",this.onLayersChanged,this);a.layers&&(a.layers.off("add",
this.onLayerAdded,this),a.layers.off("remove",this.onLayerRemoved,this));0<=this.batchGroupId&&b.batcher.markGroupDirty(this.batchGroupId);this._model&&this.removeModelFromLayers(this._model)},hide:function(){if(this._model){var b,a,c=this._model.meshInstances;b=0;for(a=c.length;b<a;b++)c[b].visible=!1}},show:function(){if(this._model){var b,a,c=this._model.meshInstances;b=0;for(a=c.length;b<a;b++)c[b].visible=!0}},_bindMaterialAsset:function(b){b.on("load",this._onMaterialAssetLoad,this);b.on("unload",
...
d=Math.floor(c.z*this.app.graphicsDevice.width*this.renderTargetScale),c=Math.floor(c.w*this.app.graphicsDevice.height*this.renderTargetScale),f=this.app.graphicsDevice,g=a?f.getHdrFormat():pc.PIXELFORMAT_R8_G8_B8_A8,d=new pc.Texture(f,{format:g,width:d,height:c});d.name="posteffect";d.minFilter=pc.FILTER_NEAREST;d.magFilter=pc.FILTER_NEAREST;d.addressU=pc.ADDRESS_CLAMP_TO_EDGE;d.addressV=pc.ADDRESS_CLAMP_TO_EDGE;return new pc.RenderTarget(this.app.graphicsDevice,d,{depth:b})},_resizeOffscreenTarget:function(b){var a=
this.camera.rect,c=Math.floor(a.z*this.app.graphicsDevice.width*this.renderTargetScale),a=Math.floor(a.w*this.app.graphicsDevice.height*this.renderTargetScale),d=this.app.graphicsDevice,f=b.colorBuffer.format;b._colorBuffer.destroy();c=new pc.Texture(d,{format:f,width:c,height:a});c.name="posteffect";c.minFilter=pc.FILTER_NEAREST;c.magFilter=pc.FILTER_NEAREST;c.addressU=pc.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.ADDRESS_CLAMP_TO_EDGE;b._colorBuffer=c;b.destroy()},setRenderTargetScale:function(b){this.renderTargetScale=
...
0,f,g=c.length-1;for(f=g;0<=f;f--)if(c[f].id===pc.LAYERID_UI){g=f-1;this._origOverrideClear=c[f].overrideClear;this._origClearColorBuffer=c[f].clearColorBuffer;this._origDepthColorBuffer=c[f].clearDepthBuffer;this._origStencilColorBuffer=c[f].clearStencilBuffer;c[f].overrideClear=!0;c[f].clearColorBuffer=!1;c[f].clearDepthBuffer=this.camera.clearDepthBuffer;c[f].clearStencilBuffer=this.camera.clearStencilBuffer;break}for(f=g;0<=f;f--)0<=c[f].cameras.indexOf(this.camera)&&(0===d&&(d=f+1),c[f].renderTarget=
...
h.bilinear;this.layer.postEffect=this;this.layer.shader=h.shader;this.layer.renderTarget=h.destRenderTarget;if(!a){a=q.scope.resolve("uColorBuffer");c=q.scope.resolve("uScreenSize");for(var H=q.supportsMsaa?4:1,F=0;2>F;F++)b[F]=new pc.RenderTarget({depth:!0,stencil:q.supportsStencil,samples:H,autoResolve:!1}),b[F].name="backbuffer"+F;e.on("prerender",function(){var a=e.scene.layers.layerList,c,d,f=0,h=0;p=k=l=!1;var n=pc.PIXELFORMAT_R8_G8_B8_A8;if(e.scene.layers._dirty){var E=0,H,G;for(c=0;c<a.length;c++){d=
...
a);this.fire("swap",b.__name,d);this.fire("swap:"+b.__name,d);return!0},resolveDuplicatedEntityReferenceProperties:function(b,a){var c=this.entity.script,d;for(d in b._scriptsIndex){var f=this.system.app.scripts.get(d);if(f){var g=b._scriptsIndex[d];if(g&&g.instance){var e=c[d].__attributesRaw,k=c[d].__attributes;if(e||k){var g=g.instance.__attributes,p;for(p in g)if(g[p]){var h=f.attributes.get(p);if(h&&"entity"===h.type)if(h.array){var n=g[p];if(h=n.length){for(var n=n.slice(),q=0;q<h;q++){var m=
n[q]instanceof pc.Entity?n[q].getGuid():n[q];a[m]&&(n[q]=e?a[m].getGuid():a[m])}e?e[p]=n:k[p]=n}}else{h=g[p];if(h instanceof pc.Entity)h=h.getGuid();else if("string"!==typeof h)continue;a[h]&&(e?e[p]=a[h].getGuid():k[p]=a[h])}}}}}}},move:function(b,a){var c=this._scripts.length;if(a>=c||0>a)return!1;var d=b;"string"!==typeof d&&(d=b.__name);var f=this._scriptsIndex[d];if(!f||!f.instance)return!1;var g=this._scripts.indexOf(f.instance);if(-1===g||g===a)return!1;this._scripts.splice(a,0,this._scripts.splice(g,
1)[0]);this._resetExecutionOrder(0,c);this._updateList.sort();this._postUpdateList.sort();this.fire("move",d,f.instance,a,g);this.fire("move:"+d,f.instance,a,g);return!0}});Object.defineProperty(e.prototype,"enabled",{get:function(){return this._enabled},set:function(b){var a=this._enabled;this._enabled=b;this.fire("set","enabled",a,b)}});Object.defineProperty(e.prototype,"scripts",{get:function(){return this._scripts},set:function(b){this._scriptsData=b;for(var a in b)if(b.hasOwnProperty(a)){var c=
...
b.hasOwnProperty("scripts")){a._scriptsData=b.scripts;for(var c=0;c<b.order.length;c++)a.create(b.order[c],{enabled:b.scripts[b.order[c]].enabled,attributes:b.scripts[b.order[c]].attributes,preloading:this.preloading})}},cloneComponent:function(a,b){var c,f,g=[],e={};for(c=0;c<a.script._scripts.length;c++){var k=a.script._scripts[c],p=k.__scriptType.__name;g.push(p);var h={};for(f in k.__attributes)h[f]=k.__attributes[f];e[p]={enabled:k._enabled,attributes:h}}for(f in a.script._scriptsIndex)f.awaiting&&
...
c=c.data.scripts,g=0,e=c.length;g<e;g++){var k=c[g].attributes;k&&delete c[g].attributes;f.scripts.push(pc.extend({},c[g]));k&&(f.scripts[g].attributes=this._cloneAttributes(k),c[g].attributes=k)}return this.addComponent(b,f)},onBeforeRemove:function(a,b){b.enabled&&this._disableScriptComponent(b);this._destroyScriptComponent(b)},onInitialize:function(a){this._registerInstances(a);if(a.enabled){a.script&&a.script.enabled&&this._initializeScriptComponent(a.script);a=a._children;var b,d=a.length;for(b=
...
var c=pc.makeArray(arguments).slice(2),f,g,e,k=this.store;for(f in k)k.hasOwnProperty(f)&&(g=k[f].data,g.instances[a]&&(e=g.instances[a].instance[b])&&e.apply(g.instances[a].instance,c))},_preRegisterInstance:function(a,b,d,f){if(a.script){a.script.data._instances=a.script.data._instances||{};if(a.script.data._instances[d])throw Error(pc.string.format("Script name collision '{0}'. Scripts from '{1}' and '{2}' {{3}}",d,b,a.script.data._instances[d].url,a.getGuid()));a.script.data._instances[d]={url:b,
...
if(e.name&&c){for(var k in c)c.hasOwnProperty(k)&&this._createAccessor(c[k],b);a.script.data.attributes[e.name]=this._cloneAttributes(c)}break}}},_createAccessor:function(a,b){var c=this;a={name:a.name,value:a.value,type:a.type};c._convertAttributeValue(a);Object.defineProperty(b.instance,a.name,{get:function(){return a.value},set:function(d){var f=a.value;a.value=d;c._convertAttributeValue(a);b.instance.fire("set",a.name,f,a.value)},configurable:!0})},_updateAccessors:function(a,b){var c,f=a.script.scripts.length,
g,e=b.url,k,p;for(c=0;c<f;c++)if(k=a.script,p=k.scripts[c],p.url===e){c=p.name;p=p.attributes;if(c){if(p)for(g in p)p.hasOwnProperty(g)&&this._createAccessor(p[g],b);if(f=k.data.attributes[c])for(g in f)if(e=f[g],!(g in p))delete b.instance[e.name];else if(p[g].value!==e.value&&b.instance.onAttributeChanged)b.instance.onAttributeChanged(e.name,e.value,p[g].value);p?k.data.attributes[c]=this._cloneAttributes(p):delete k.data.attributes[c]}break}},_convertAttributeValue:function(a){if("rgb"===a.type||
...
a.instances;for(var f=0,g=a.length;f<g;f++)a[f].rollOffFactor=c}},onSetDistanceModel:function(b,a,c){b=this.data.slots;for(var d in b)if(a=b[d],!a.overlap){a=a.instances;for(var f=0,g=a.length;f<g;f++)a[f].distanceModel=c}},onSetPositional:function(b,a,c){b=this.data.slots;for(var d in b)if(a=b[d],!a.overlap){c=a.instances;for(var f=0,g=c.length;f<g;f++){var e=c[f].isPlaying||c[f].isSuspended,k=c[f].currentTime;e&&c[f].stop();c[f]=a._createInstance();e&&(c[f].play(),c[f].currentTime=k)}}},onEnable:function(){if(!this.system._inTools){var b=
...
if(f&&e){g=l.getCollisionFlags();var p=h.getCollisionFlags(),n=k.getNumContacts(),z=[],h=[],C;if(0<n)if(g&pc.BODYFLAG_NORESPONSE_OBJECT||p&pc.BODYFLAG_NORESPONSE_OBJECT)C=f.collision?f.collision.hasEvent("triggerenter")||f.collision.hasEvent("triggerleave"):!1,l=e.collision?e.collision.hasEvent("triggerenter")||e.collision.hasEvent("triggerleave"):!1,C&&(k=this._storeCollision(f,e))&&(!f.collision||p&pc.BODYFLAG_NORESPONSE_OBJECT||f.collision.fire("triggerenter",e)),l&&(k=this._storeCollision(e,f))&&
(!e.collision||g&pc.BODYFLAG_NORESPONSE_OBJECT||e.collision.fire("triggerenter",f));else if(C=f.collision?f.collision.hasEvent("collisionstart")||f.collision.hasEvent("collisionend")||f.collision.hasEvent("contact"):!1,l=e.collision?e.collision.hasEvent("collisionstart")||e.collision.hasEvent("collisionend")||e.collision.hasEvent("contact"):!1,(p=this.hasEvent("contact"))||C||l){for(g=0;g<n;g++){var A=k.getContactPoint(g),B=this._createContactPointFromAmmo(A);if(C||l)A=this._createReverseContactPointFromAmmo(A),
z.push(B),h.push(A);p&&(B=this._createSingleContactResult(f,e,B),this.fire("contact",B))}C&&(n=this._createContactResult(e,z),f.collision&&f.collision.fire("contact",n),(k=this._storeCollision(f,e))&&f.collision&&f.collision.fire("collisionstart",n));l&&(h=this._createContactResult(f,h),e.collision&&e.collision.fire("contact",h),(k=this._storeCollision(e,f))&&e.collision&&e.collision.fire("collisionstart",h))}}}this._cleanOldCollisions();this.contactPointPool.freeAll();this.contactResultPool.freeAll();
...
g;Object.assign(g.prototype,{beforeInitialize:function(a,b){},createPhysicalShape:function(a,b){if("undefined"!==typeof Ammo&&b.model){var c=b.model,d=new Ammo.btCompoundShape,f,e;for(f=0;f<c.meshInstances.length;f++){var g=c.meshInstances[f],k=g.mesh,l=k.indexBuffer[pc.RENDERSTYLE_SOLID],v=k.vertexBuffer,y=v.getFormat(),u=y.size/4,w;for(e=0;e<y.elements.length;e++){var x=y.elements[e];x.name===pc.SEMANTIC_POSITION&&(w=new Float32Array(v.lock(),x.offset))}var l=new Uint16Array(l.lock()),v=k.primitive[0].count/
3,y=new Ammo.btVector3,x=new Ammo.btVector3,D=new Ammo.btVector3,z,C,A=k.primitive[0].base,B=new Ammo.btTriangleMesh;for(e=0;e<v;e++)k=l[A+3*e]*u,z=l[A+3*e+1]*u,C=l[A+3*e+2]*u,y.setValue(w[k],w[k+1],w[k+2]),x.setValue(w[z],w[z+1],w[z+2]),D.setValue(w[C],w[C+1],w[C+2]),B.addTriangle(y,x,D,!0);e=new Ammo.btBvhTriangleMeshShape(B,!0);u=g.node.getWorldTransform().getScale();e.setLocalScaling(new Ammo.btVector3(u.x,u.y,u.z));u=g.node.getPosition();g=g.node.getRotation();l=new Ammo.btTransform;l.setIdentity();
l.getOrigin().setValue(u.x,u.y,u.z);u=new Ammo.btQuaternion;u.setValue(g.x,g.y,g.z,g.w);l.setRotation(u);d.addChildShape(l,e)}c=a.getWorldTransform().getScale();f=new Ammo.btVector3;f.setValue(c.x,c.y,c.z);d.setLocalScaling(f);return d}},recreatePhysicalShapes:function(a){null!==a.data.asset&&a.enabled&&a.entity.enabled?this.loadModelAsset(a):this.doRecreatePhysicalShape(a)},loadModelAsset:function(a){var b=this,c=a.data.asset,d=a.data,f=this.system.app.assets,e=f.get(c);if(e)e.ready(function(c){d.model=
...
rotationSpeedGraph:"curve",rotationSpeedGraph2:"curve",scaleGraph:"curve",scaleGraph2:"curve"};this.on("beforeremove",this.onRemove,this);pc.ComponentSystem.bind("update",this.onUpdate,this)};b.prototype=Object.create(pc.ComponentSystem.prototype);b.prototype.constructor=b;pc.Component._buildAccessors(pc.ParticleSystemComponent.prototype,e);Object.assign(b.prototype,{initializeComponentData:function(a,b,d){var c={};d=[];var e=this.propertyTypes,l;if(b.mesh instanceof pc.Asset||"number"===typeof b.mesh)b.meshAsset=
b.mesh,delete b.mesh;for(var k in b)b.hasOwnProperty(k)&&(d.push(k),c[k]=b[k]),"vec3"===e[k]?"array"===pc.type(c[k])&&(c[k]=new pc.Vec3(c[k][0],c[k][1],c[k][2])):"curve"===e[k]?c[k]instanceof pc.Curve||(l=c[k].type,c[k]=new pc.Curve(c[k].keys),c[k].type=l):"curveset"!==e[k]||c[k]instanceof pc.CurveSet||(l=c[k].type,c[k]=new pc.CurveSet(c[k].keys),c[k].type=l),c.layers&&"array"===pc.type(c.layers)&&(c.layers=c.layers.slice(0));pc.ComponentSystem.prototype.initializeComponentData.call(this,a,c,d)},
cloneComponent:function(a,b){for(var c=a.particlesystem.data,f=this.schema,e={},l=0,k=f.length;l<k;l++){var p=f[l],h=c[p];h instanceof pc.Vec3||h instanceof pc.Curve||h instanceof pc.CurveSet?(h=h.clone(),e[p]=h):"layers"===p?e.layers=c.layers.slice(0):null!==h&&void 0!==h&&(e[p]=h)}return this.addComponent(b,e)},onUpdate:function(a){var b=this.store,d,f,e,l,k=this.app.stats.particles,p;for(p in b)if(b.hasOwnProperty(p)&&(l=b[p],f=l.entity,d=l.data,d.enabled&&f.enabled)){var h=d.model.emitter;if(h.meshInstance.visible){if(h.lighting){var n,
q=d.layers;for(f=0;f<q.length;f++)if(l=this.app.scene.layers.getLayerById(q[f])){l._lightCube||(l._lightCube=new Float32Array(18));n=l._lightCube;for(f=0;6>f;f++)n[3*f]=this.app.scene.ambientLight.r,n[3*f+1]=this.app.scene.ambientLight.g,n[3*f+2]=this.app.scene.ambientLight.b;var m=l._sortedLights[pc.LIGHTTYPE_DIRECTIONAL];for(e=0;e<m.length;e++)for(l=0;6>l;l++){var r=Math.max(h.lightCubeDir[l].dot(m[e]._direction),0)*m[e]._intensity;n[3*l]+=m[e]._color.r*r;n[3*l+1]+=m[e]._color.g*r;n[3*l+2]+=m[e]._color.b*
r}}h.constantLightCube.setValue(n)}if(!d.paused){h.simTime+=a;d=0;h.simTime>h.fixedTimeStep&&(d=Math.floor(h.simTime/h.fixedTimeStep),h.simTime-=d*h.fixedTimeStep);if(d){d=Math.min(d,h.maxSubSteps);for(f=0;f<d;f++)h.addTime(h.fixedTimeStep);k._updatesPerFrame+=d;k._frameTime+=h._addTimeTime;h._addTimeTime=0}h.finishFrame()}}}},onRemove:function(a,b){b.onRemove()}});return{ParticleSystemComponentSystem:b}}());Object.assign(pc,function(){return{ParticleSystemComponentData:function(){this.rate=this.numParticles=1;this.rate2=null;this.startAngle=0;this.startAngle2=null;this.lifetime=50;this.emitterExtents=new pc.Vec3;this.emitterRadius=0;this.emitterShape=pc.EMITTERSHAPE_BOX;this.initialVelocity=0;this.wrapBounds=new pc.Vec3;this.localSpace=!1;this.normalMapAsset=this.normalMap=this.colorMapAsset=this.colorMap=null;this.loop=!0;this.preWarm=!1;this.sort=0;this.mode=pc.PARTICLEMODE_GPU;this.scene=null;this.halfLambert=
...
!1)}},_updateTransform:function(){var b=this.flipX?-1:1,a=this.flipY?-1:1,c=0,d=0;if(this.sprite&&(this.sprite.renderMode===pc.SPRITE_RENDERMODE_SLICED||this.sprite.renderMode===pc.SPRITE_RENDERMODE_TILED)){var f=1,e=1;if(this.sprite.atlas){var l=this.sprite.atlas.frames[this.sprite.frameKeys[this.frame]];l&&(f=l.rect.z,e=l.rect.w,c=(.5-l.pivot.x)*this._width,d=(.5-l.pivot.y)*this._height)}f/=this.sprite.pixelsPerUnit;e/=this.sprite.pixelsPerUnit;this._outerScale.set(Math.max(this._width,this._innerOffset.x*
f),Math.max(this._height,this._innerOffset.y*e));a*=e;this._outerScale.x/=f;this._outerScale.y/=e;b=b*f*pc.math.clamp(this._width/(this._innerOffset.x*f),1E-4,1);a*=pc.math.clamp(this._height/(this._innerOffset.y*e),1E-4,1);this._meshInstance&&(this._outerScaleUniform[0]=this._outerScale.x,this._outerScaleUniform[1]=this._outerScale.y,this._meshInstance.setParameter("outerScale",this._outerScaleUniform,4294967295))}this._node.setLocalScale(b,a,1);this._node.setLocalPosition(c,d,0)},_updateAabb:function(b){b.center.set(0,
...
this._onResize,this);this.fire("remove");this.off()}});Object.defineProperty(e.prototype,"resolution",{set:function(a){this._screenSpace?this._resolution.set(this.system.app.graphicsDevice.width,this.system.app.graphicsDevice.height):this._resolution.set(a.x,a.y);this._updateScale();this._calcProjectionMatrix();this.entity._dirtyLocal||this.entity._dirtifyLocal();this.fire("set:resolution",this._resolution)},get:function(){return this._resolution}});Object.defineProperty(e.prototype,"referenceResolution",
{set:function(a){this._referenceResolution.set(a.x,a.y);this._updateScale();this._calcProjectionMatrix();this.entity._dirtyLocal||this.entity._dirtifyLocal();this.fire("set:referenceresolution",this._resolution)},get:function(){return this._scaleMode===pc.SCALEMODE_NONE?this._resolution:this._referenceResolution}});Object.defineProperty(e.prototype,"screenSpace",{set:function(a){(this._screenSpace=a)&&this._resolution.set(this.system.app.graphicsDevice.width,this.system.app.graphicsDevice.height);
this.resolution=this._resolution;this.entity._dirtyLocal||this.entity._dirtifyLocal();this.fire("set:screenspace",this._screenSpace)},get:function(){return this._screenSpace}});Object.defineProperty(e.prototype,"scaleMode",{set:function(a){a!==pc.SCALEMODE_NONE&&a!==pc.SCALEMODE_BLEND&&(a=pc.SCALEMODE_NONE);this._screenSpace||a===pc.SCALEMODE_NONE||(a=pc.SCALEMODE_NONE);this._scaleMode=a;this.resolution=this._resolution;this.fire("set:scalemode",this._scaleMode)},get:function(){return this._scaleMode}});
Object.defineProperty(e.prototype,"scaleBlend",{set:function(a){this._scaleBlend=a;this._updateScale();this._calcProjectionMatrix();this.entity._dirtyLocal||this.entity._dirtifyLocal();this.fire("set:scaleblend",this._scaleBlend)},get:function(){return this._scaleBlend}});Object.defineProperty(e.prototype,"priority",{get:function(){return this._priority},set:function(a){255<a&&(a=255);this._priority=a}});return{ScreenComponent:e}}());Object.assign(pc,function(){var e=["enabled"],b=function(a){pc.ComponentSystem.call(this,a);this.id="screen";this.app=a;this.ComponentType=pc.ScreenComponent;this.DataType=pc.ScreenComponentData;this.schema=e;this.windowResolution=new pc.Vec2;this._drawOrderSyncQueue=new pc.IndexedList;this.app.graphicsDevice.on("resizecanvas",this._onResize,this);pc.ComponentSystem.bind("update",this._onUpdate,this);this.on("beforeremove",this.onRemoveComponent,this)};b.prototype=Object.create(pc.ComponentSystem.prototype);
...
_setLocalPosition:function(a,b,c){a instanceof pc.Vec3?this.localPosition.copy(a):this.localPosition.set(a,b,c);a=this.element;b=this.localPosition;c=a._pivot;a._margin.x=b.x-a._calculatedWidth*c.x;a._margin.z=a._localAnchor.z-a._localAnchor.x-a._calculatedWidth-a._margin.x;a._margin.y=b.y-a._calculatedHeight*c.y;a._margin.w=a._localAnchor.w-a._localAnchor.y-a._calculatedHeight-a._margin.y;this._dirtyLocal||this._dirtifyLocal()},_sync:function(){var f=this.element,g=f.screen;if(g){if(f._anchorDirty){var l,
n,q=0,m=1;this._parent&&this._parent.element?(l=this._parent.element.calculatedWidth,n=this._parent.element.calculatedHeight,q=this._parent.element.pivot.x,m=this._parent.element.pivot.y):(n=g.screen.resolution,l=n.x/g.screen.scale,n=n.y/g.screen.scale);f._anchorTransform.setTranslate(l*(f.anchor.x-q),-(n*(m-f.anchor.y)),0);f._anchorDirty=!1;f._calculateLocalAnchors()}f._sizeDirty&&f._calculateSize()}this._dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),
l=this.localPosition,q=f._pivot,f._margin.x=l.x-f._calculatedWidth*q.x,f._margin.z=f._localAnchor.z-f._localAnchor.x-f._calculatedWidth-f._margin.x,f._margin.y=l.y-f._calculatedHeight*q.y,f._margin.w=f._localAnchor.w-f._localAnchor.y-f._calculatedHeight-f._margin.y,this._dirtyLocal=!1);if(!g)return this._dirtyWorld&&(f._cornersDirty=!0,f._canvasCornersDirty=!0,f._worldCornersDirty=!0),pc.Entity.prototype._sync.call(this);this._dirtyWorld&&(null===this._parent?this.worldTransform.copy(this.localTransform):
(this._parent.element?f._screenToWorld.mul2(this._parent.element._modelTransform,f._anchorTransform):f._screenToWorld.copy(f._anchorTransform),f._modelTransform.mul2(f._screenToWorld,this.localTransform),g?(f._screenToWorld.mul2(g.screen._screenMatrix,f._screenToWorld),g.screen.screenSpace||f._screenToWorld.mul2(g.worldTransform,f._screenToWorld),this.worldTransform.mul2(f._screenToWorld,this.localTransform),l=f._parentWorldTransform,l.setIdentity(),(q=this._parent)&&q.element&&q!==g&&(a.setTRS(pc.Vec3.ZERO,
q.getLocalRotation(),q.getLocalScale()),l.mul2(q.element._parentWorldTransform,a)),e.set(0,0,this.localPosition.z),b.set(f._absLeft+f._pivot.x*f.calculatedWidth,f._absBottom+f._pivot.y*f.calculatedHeight,0),a.setTranslate(-b.x,-b.y,-b.z),c.setTRS(e,this.getLocalRotation(),this.getLocalScale()),d.setTranslate(b.x,b.y,b.z),f._screenTransform.mul2(f._parentWorldTransform,d).mul(c).mul(a),f._cornersDirty=!0,f._canvasCornersDirty=!0,f._worldCornersDirty=!0):this.worldTransform.copy(f._modelTransform)),
...
pc.Vec4?a.anchor.copy(b.anchor):a.anchor.set(b.anchor[0],b.anchor[1],b.anchor[2],b.anchor[3]));void 0!==b.pivot&&(b.pivot instanceof pc.Vec2?a.pivot.copy(b.pivot):a.pivot.set(b.pivot[0],b.pivot[1]));var c=.001<Math.abs(a.anchor.x-a.anchor.z),e=.001<Math.abs(a.anchor.y-a.anchor.w),l=!1;void 0!==b.margin&&(b.margin instanceof pc.Vec4?a.margin.copy(b.margin):a._margin.set(b.margin[0],b.margin[1],b.margin[2],b.margin[3]),l=!0);void 0!==b.left&&(a._margin.x=b.left,l=!0);void 0!==b.bottom&&(a._margin.y=
b.bottom,l=!0);void 0!==b.right&&(a._margin.z=b.right,l=!0);void 0!==b.top&&(a._margin.w=b.top,l=!0);l&&(a.margin=a._margin);l=!1;void 0===b.width||c?c&&(l=!0):a.width=b.width;void 0===b.height||e?e&&(l=!0):a.height=b.height;l&&(a.anchor=a.anchor);void 0!==b.enabled&&(a.enabled=b.enabled);void 0!==b.useInput&&(a.useInput=b.useInput);a.batchGroupId=void 0===b.batchGroupId||null===b.batchGroupId?-1:b.batchGroupId;b.layers&&"array"===pc.type(b.layers)&&(a.layers=b.layers.slice(0));a.type=b.type;a.type===
...
b.pixelsPerUnit),void 0!==b.materialAsset&&(a.materialAsset=b.materialAsset),b.material&&(a.material=b.material),void 0!==b.mask&&(a.mask=b.mask)):a.type===pc.ELEMENTTYPE_TEXT&&(void 0!==b.autoWidth&&(a.autoWidth=b.autoWidth),void 0!==b.autoHeight&&(a.autoHeight=b.autoHeight),void 0!==b.rtlReorder&&(a.rtlReorder=b.rtlReorder),void 0!==b.unicodeConverter&&(a.unicodeConverter=b.unicodeConverter),void 0!==b.text&&(a.text=b.text),void 0!==b.color&&(c=b.color,c instanceof pc.Color||(c=new pc.Color(c[0],
c[1],c[2])),a.color=c),void 0!==b.opacity&&(a.opacity=b.opacity),void 0!==b.spacing&&(a.spacing=b.spacing),void 0!==b.fontSize&&(a.fontSize=b.fontSize,b.lineHeight||(a.lineHeight=b.fontSize)),void 0!==b.lineHeight&&(a.lineHeight=b.lineHeight),void 0!==b.wrapLines&&(a.wrapLines=b.wrapLines),void 0!==b.fontAsset&&(a.fontAsset=b.fontAsset),void 0!==b.font&&(a.font=b.font),void 0!==b.alignment&&(a.alignment=b.alignment));c=a._parseUpToScreen();c.screen&&a._updateScreen(c.screen);pc.ComponentSystem.prototype.initializeComponentData.call(this,
a,b,d);a._beingInitialized=!1;a.type===pc.ELEMENTTYPE_IMAGE&&a._image._meshDirty&&a._image._updateMesh(a._image.mesh)},onRemoveComponent:function(a,b){b.onRemove()},cloneComponent:function(a,b){var c=a.element;return this.addComponent(b,{enabled:c.enabled,width:c.width,height:c.height,anchor:c.anchor.clone(),pivot:c.pivot.clone(),margin:c.margin.clone(),alignment:c.alignment&&c.alignment.clone()||c.alignment,autoWidth:c.autoWidth,autoHeight:c.autoHeight,type:c.type,rect:c.rect&&c.rect.clone()||c.rect,
rtlReorder:c.rtlReorder,unicodeConverter:c.unicodeConverter,materialAsset:c.materialAsset,material:c.material,color:c.color&&c.color.clone()||c.color,opacity:c.opacity,textureAsset:c.textureAsset,texture:c.texture,spriteAsset:c.spriteAsset,sprite:c.sprite,spriteFrame:c.spriteFrame,pixelsPerUnit:c.pixelsPerUnit,text:c.text,spacing:c.spacing,lineHeight:c.lineHeight,wrapLines:c.wrapLines,layers:c.layers,fontSize:c.fontSize,fontAsset:c.fontAsset,font:c.font,useInput:c.useInput,batchGroupId:c.batchGroupId,
mask:c.mask})},getTextElementMaterial:function(a,b){if(a){if(b)return this.defaultScreenSpaceTextMaterial||(this.defaultScreenSpaceTextMaterial=new pc.StandardMaterial,this.defaultScreenSpaceTextMaterial.name="defaultScreenSpaceTextMaterial",this.defaultScreenSpaceTextMaterial.msdfMap=this._defaultTexture,this.defaultScreenSpaceTextMaterial.useLighting=!1,this.defaultScreenSpaceTextMaterial.useGammaTonemap=!1,this.defaultScreenSpaceTextMaterial.useFog=!1,this.defaultScreenSpaceTextMaterial.useSkybox=
...
new pc.Vec4;this._atlasRectUniform=new Float32Array(4);this._defaultMesh=this._createMesh();this._renderable=new e(this._entity,this._defaultMesh,this._material);this._color=new pc.Color(1,1,1,1);this._colorUniform=new Float32Array([1,1,1]);this._renderable.setParameter("material_emissive",this._colorUniform);this._renderable.setParameter("material_opacity",1);this._updateAabbFunc=this._updateAabb.bind(this);this._onScreenChange(this._element.screen);this._element.on("resize",this._onParentResizeOrPivotChange,
...
this._updateMesh(a);return a},_updateMesh:function(a){var b;b=this._element;var d=b.calculatedWidth,f=b.calculatedHeight,e=b._isScreenSpace();this._updateMaterial(e);this._renderable&&this._renderable.forceUpdateAabb();if(!this.sprite||this.sprite.renderMode!==pc.SPRITE_RENDERMODE_SLICED&&this.sprite.renderMode!==pc.SPRITE_RENDERMODE_TILED){this._positions[0]=0;this._positions[1]=0;this._positions[2]=0;this._positions[3]=d;this._positions[4]=0;this._positions[5]=0;this._positions[6]=d;this._positions[7]=
f;this._positions[8]=0;this._positions[9]=0;this._positions[10]=f;this._positions[11]=0;var e=b.pivot.x,l=b.pivot.y;for(b=0;b<this._positions.length;b+=3)this._positions[b]-=e*d,this._positions[b+1]-=l*f;f=d=1;b=this._rect;this._sprite&&this._sprite.frameKeys[this._spriteFrame]&&this._sprite.atlas&&(e=this._sprite.atlas.frames[this._sprite.frameKeys[this._spriteFrame]])&&(b=e.rect,d=this._sprite.atlas.texture.width,f=this._sprite.atlas.texture.height);this._uvs[0]=b.x/d;this._uvs[1]=b.y/f;this._uvs[2]=
(b.x+b.z)/d;this._uvs[3]=b.y/f;this._uvs[4]=(b.x+b.z)/d;this._uvs[5]=(b.y+b.w)/f;this._uvs[6]=b.x/d;this._uvs[7]=(b.y+b.w)/f;d=new pc.VertexIterator(a.vertexBuffer);for(b=0;4>b;b++)d.element[pc.SEMANTIC_POSITION].set(this._positions[3*b+0],this._positions[3*b+1],this._positions[3*b+2]),d.element[pc.SEMANTIC_NORMAL].set(this._normals[3*b+0],this._normals[3*b+1],this._normals[3*b+2]),d.element[pc.SEMANTIC_TEXCOORD0].set(this._uvs[2*b+0],this._uvs[2*b+1]),d.next();d.end();a.aabb.compute(this._positions);
this._renderable&&(this._renderable.node.setLocalScale(1,1,1),this._renderable.node.setLocalPosition(0,0,0),this._renderable.setAabbFunc(null))}else a=this._sprite.atlas.frames[this._sprite.frameKeys[this._spriteFrame]],e=2/a.rect.z,l=2/a.rect.w,this._innerOffset.set(a.border.x*e,a.border.y*l,a.border.z*e,a.border.w*l),e=this.sprite.atlas.texture,this._atlasRect.set(a.rect.x/e.width,a.rect.y/e.height,a.rect.z/e.width,a.rect.w/e.height),l=null!==this._pixelsPerUnit?this._pixelsPerUnit:this.sprite.pixelsPerUnit,
e=a.rect.z/l,a=a.rect.w/l,this._outerScale.set(Math.max(d,this._innerOffset.x*e),Math.max(f,this._innerOffset.y*a)),l=a,this._outerScale.x/=e,this._outerScale.y/=a,e*=pc.math.clamp(d/(this._innerOffset.x*e),1E-4,1),l*=pc.math.clamp(f/(this._innerOffset.y*a),1E-4,1),this._renderable&&(this._innerOffsetUniform[0]=this._innerOffset.x,this._innerOffsetUniform[1]=this._innerOffset.y,this._innerOffsetUniform[2]=this._innerOffset.z,this._innerOffsetUniform[3]=this._innerOffset.w,this._renderable.setParameter("innerOffset",
...
c;b=0;for(c=this._model.meshInstances.length;b<c;b++)this._model.meshInstances[b].drawOrder=a}},_onPivotChange:function(a){this._font&&this._updateText()},_updateText:function(a){var b,c;void 0===a&&(a=this._text);a=pc.string.getSymbols(a);this.rtlReorder&&((b=this._system.app.systems.element.getRtlReorder())?a=b(a):console.warn("Element created with rtlReorder option but no rtlReorder function registered"));c=a.length;0===c&&(c=1,a=[" "]);var d={},f;for(b=0;b<c;b++)f=a[b],(f=this._font.data.chars[f])||
(f=this._font.data.chars[" "]?this._font.data.chars[" "]:this._font.data.chars[Object.keys(this._font.data.chars)[0]]),f=f.map,d[f]||(d[f]=0),d[f]++;f=!1;var e=this._element,n=e._isScreenSpace(),q=e._isScreenCulled(),m=function(a){return e.isVisibleForCamera(a)};b=0;for(c=this._meshInfo.length;b<c;b++){var r=d[b]||0,t=this._meshInfo[b];if(t.count!==r)if(f||(e.removeModelFromLayers(this._model),f=!0),t.count=r,t.positions.length=t.normals.length=12*r,t.indices.length=6*r,t.uvs.length=8*r,t.meshInstance&&
(this._removeMeshInstance(t.meshInstance),t.meshInstance.material=null),0===r)t.meshInstance=null;else{for(var v=0;v<r;v++)t.indices[6*v+0]=4*v,t.indices[6*v+1]=4*v+1,t.indices[6*v+2]=4*v+3,t.indices[6*v+3]=4*v+2,t.indices[6*v+4]=4*v+3,t.indices[6*v+5]=4*v+1,t.normals[12*v+0]=0,t.normals[12*v+1]=0,t.normals[12*v+2]=-1,t.normals[12*v+3]=0,t.normals[12*v+4]=0,t.normals[12*v+5]=-1,t.normals[12*v+6]=0,t.normals[12*v+7]=0,t.normals[12*v+8]=-1,t.normals[12*v+9]=0,t.normals[12*v+10]=0,t.normals[12*v+11]=
-1;r=pc.createMesh(this._system.app.graphicsDevice,t.positions,{uvs:t.uvs,normals:t.normals,indices:t.indices});r=new pc.MeshInstance(this._node,r,this._material);r.name="Text Element: "+this._entity.name;r.castShadow=!1;r.receiveShadow=!1;r.cull=!n;r.screenSpace=n;r.drawOrder=this._drawOrder;q&&(r.cull=!0,r.isVisibleFunc=m);this._setTextureParams(r,this._font.textures[b]);this._colorUniform[0]=this._color.r;this._colorUniform[1]=this._color.g;this._colorUniform[2]=this._color.b;r.setParameter("material_emissive",
this._colorUniform);r.setParameter("material_opacity",this._color.a);r.setParameter("font_sdfIntensity",this._font.intensity);r.setParameter("font_pxrange",this._getPxRange(this._font));r.setParameter("font_textureWidth",this._font.data.info.maps[b].width);t.meshInstance=r;this._model.meshInstances.push(r)}}this._element.maskedBy&&this._element._setMaskedBy(this._element.maskedBy);f&&this._element.enabled&&this._entity.enabled&&this._element.addModelToLayers(this._model);this._updateMeshes(a)},_removeMeshInstance:function(a){var b,
...
this._system.getTextElementMaterial(a,this._font&&this._font.type===pc.FONT_MSDF);if(this._model)for(var f=0,e=this._model.meshInstances.length;f<e;f++){var n=this._model.meshInstances[f];n.cull=!a;n.material=this._material;n.screenSpace=a;c?(n.cull=!0,n.isVisibleFunc=d):n.isVisibleFunc=null}},_updateMeshes:function(b){function f(a,c){k._lineWidths.push(c);var d=b.slice(v,a).join("");k._lineContents.push(d);h=0;q-=k._lineHeight;m++;r=u=y=0;v=a}var e=this._font.data,k=this;this.height=this.width=0;
this._lineWidths=[];this._lineContents=[];var p=b.length,h=0,n=0,q=0,m=1,r=0,t=0,v=0,y=0,u=0,w=1E-4<=Math.abs(this._element.anchor.x-this._element.anchor.z),x=this._element.calculatedWidth;if(this.autoWidth&&!w||!this._wrapLines)x=Number.POSITIVE_INFINITY;var D=0,w=0,z=1,C,A,B;for(A in e.chars)B=e.chars[A],z=B.height/32*this._fontSize/B.height,B.bounds&&(D=Math.min(D,B.bounds[1]*z),w=Math.max(w,B.bounds[3]*z));for(A=0;A<this._meshInfo.length;A++)this._meshInfo[A].quad=0,this._meshInfo[A].lines={};
for(A=0;A<p;A++){C=b[A];var J=0,F=0,H=0,E=1,G=0,I=0;(B=e.chars[C])||(B=e.chars[" "]?e.chars[" "]:e.chars[Object.keys(e.chars)[0]]);B?(J=B.scale||1,F=(B.width+B.height)/2,z=F/32*this._fontSize/F,E=F/32*this._fontSize/J,H=B.xadvance*z,J=B.xoffset*z,F=B.yoffset*z,B.bounds?(I=(B.bounds[2]-B.bounds[0])*z,G=B.bounds[0]*z):(I=J,G=0)):console.error("Couldn't substitute missing character: '"+C+"'");var Q=a.test(C),V=d.test(C),W=c.test(C);if(Q)f(A,n),t=A+1,v=A+1;else{z=this._meshInfo[B&&B.map||0];if(h+I+G>=
x&&0<u&&!W)if(0===y)t=A,f(A,n);else{B=Math.max(A-t,0);if(1>=this._meshInfo.length)z.lines[m-1]-=B,z.quad-=B;else for(C=t;C<A;C++)J=e.chars[b[C]],J=this._meshInfo[J&&J.map||0],--J.lines[m-1],--J.quad;A-=B+1;f(t,r);continue}B=z.quad;z.lines[m-1]=B;z.positions[12*B+0]=h-J;z.positions[12*B+1]=q-F;z.positions[12*B+2]=0;z.positions[12*B+3]=h-J+E;z.positions[12*B+4]=q-F;z.positions[12*B+5]=0;z.positions[12*B+6]=h-J+E;z.positions[12*B+7]=q-F+E;z.positions[12*B+8]=0;z.positions[12*B+9]=h-J;z.positions[12*
B+10]=q-F+E;z.positions[12*B+11]=0;this.width=Math.max(this.width,h+I+G);this.height=Math.max(this.height,w-(q+D));h+=this._spacing*H;W||Q||(n=h);V&&(y++,r=n,t=A+1);u++;C=this._getUv(C);z.uvs[8*B+0]=C[0];z.uvs[8*B+1]=C[1];z.uvs[8*B+2]=C[2];z.uvs[8*B+3]=C[1];z.uvs[8*B+4]=C[2];z.uvs[8*B+5]=C[3];z.uvs[8*B+6]=C[0];z.uvs[8*B+7]=C[3];z.quad++}}v<p&&f(p,h);this._noResize=!0;this.autoWidth=this._autoWidth;this.autoHeight=this._autoHeight;this._noResize=!1;e=this._element.pivot.x;p=this._element.pivot.y;n=
this._alignment.x;t=this._alignment.y;for(A=0;A<this._meshInfo.length;A++)if(0!==this._meshInfo[A].count){B=0;for(var U in this._meshInfo[A].lines){x=this._meshInfo[A].lines[U];D=-e*this._element.calculatedWidth+n*(this._element.calculatedWidth-this._lineWidths[parseInt(U,10)]);for(C=(1-p)*this._element.calculatedHeight-w-(1-t)*(this._element.calculatedHeight-this.height);B<=x;B++)this._meshInfo[A].positions[12*B]+=D,this._meshInfo[A].positions[12*B+3]+=D,this._meshInfo[A].positions[12*B+6]+=D,this._meshInfo[A].positions[12*
B+9]+=D,this._meshInfo[A].positions[12*B+1]+=C,this._meshInfo[A].positions[12*B+4]+=C,this._meshInfo[A].positions[12*B+7]+=C,this._meshInfo[A].positions[12*B+10]+=C;B=x+1}x=4*this._meshInfo[A].count;D=4*this._meshInfo[A].quad;B=new pc.VertexIterator(this._meshInfo[A].meshInstance.mesh.vertexBuffer);for(C=0;C<x;C++)C>=D?(B.element[pc.SEMANTIC_POSITION].set(0,0,0),B.element[pc.SEMANTIC_TEXCOORD0].set(0,0)):(B.element[pc.SEMANTIC_POSITION].set(this._meshInfo[A].positions[3*C+0],this._meshInfo[A].positions[3*
C+1],this._meshInfo[A].positions[3*C+2]),B.element[pc.SEMANTIC_TEXCOORD0].set(this._meshInfo[A].uvs[2*C+0],this._meshInfo[A].uvs[2*C+1])),B.next();B.end();this._meshInfo[A].meshInstance.mesh.aabb.compute(this._meshInfo[A].positions);this._meshInfo[A].meshInstance._aabbVer=-1}this._aabbDirty=!0},_onFontAdded:function(a){this._system.app.assets.off("add:"+a.id,this._onFontAdded,this);a.id===this._fontAsset&&this._bindFont(a)},_bindFont:function(a){this._entity.enabled&&(a.on("load",this._onFontLoad,
this),a.on("change",this._onFontChange,this),a.on("remove",this._onFontRemove,this),a.resource?this._onFontLoad(a):this._system.app.assets.load(a))},_unbindFont:function(a){a.off("load",this._onFontLoad,this);a.off("change",this._onFontChange,this);a.off("remove",this._onFontRemove,this)},_onFontRender:function(){this.font=this._font},_onFontLoad:function(a){this.font!==a.resource&&(this.font=a.resource)},_onFontChange:function(a,b,c,d){if("data"===b)for(this._font.data=c,a=this._font.data.info.maps.length,
...
"lines",{get:function(){return this._lineContents}});Object.defineProperty(b.prototype,"spacing",{get:function(){return this._spacing},set:function(a){var b=this._spacing;this._spacing=a;b!==a&&this._font&&this._updateText()}});Object.defineProperty(b.prototype,"fontSize",{get:function(){return this._fontSize},set:function(a){var b=this._fontSize;this._fontSize=a;b!==a&&this._font&&this._updateText()}});Object.defineProperty(b.prototype,"fontAsset",{get:function(){return this._fontAsset},set:function(a){var b=
this._system.app.assets,c=a;a instanceof pc.Asset&&(c=a.id);if(this._fontAsset!==c&&(this._fontAsset&&(b.off("add:"+this._fontAsset,this._onFontAdded,this),(a=b.get(this._fontAsset))&&this._unbindFont(a)),this._fontAsset=c))if(c=b.get(this._fontAsset))this._bindFont(c);else b.on("add:"+this._fontAsset,this._onFontAdded,this)}});Object.defineProperty(b.prototype,"font",{get:function(){return this._font},set:function(a){var b;this._font&&(b=this._font.type,this._font.off&&this._font.off("render",this._onFontRender,
this));if(this._font=a){if(this._font.on)this._font.on("render",this._onFontRender,this);if(this._fontAsset){var c=this._system.app.assets.get(this._fontAsset);c.resource!==this._font&&(this._unbindFont(c),this._fontAsset=null)}a.type!==b&&(a=this._element._isScreenSpace(),this._updateMaterial(a));a=0;for(b=this._font.textures.length;a<b;a++)if(this._meshInfo[a]){if(c=this._meshInfo[a].meshInstance)c.setParameter("font_sdfIntensity",this._font.intensity),c.setParameter("font_pxrange",this._getPxRange(this._font)),
c.setParameter("font_textureWidth",this._font.data.info.maps[a].width),this._setTextureParams(c,this._font.textures[a])}else this._meshInfo[a]=new e;b=!1;for(a=this._font.textures.length;a<this._meshInfo.length;a++)this._meshInfo[a].meshInstance&&(b||(this._element.removeModelFromLayers(this._model),b=!0),this._removeMeshInstance(this._meshInfo[a].meshInstance));this._meshInfo.length>this._font.textures.length&&(this._meshInfo.length=this._font.textures.length);this._updateText()}}});Object.defineProperty(b.prototype,
"alignment",{get:function(){return this._alignment},set:function(a){a instanceof pc.Vec2?this._alignment.set(a.x,a.y):this._alignment.set(a[0],a[1]);this._font&&this._updateText()}});Object.defineProperty(b.prototype,"autoWidth",{get:function(){return this._autoWidth},set:function(a){(this._autoWidth=a)&&1E-4>Math.abs(this._element.anchor.x-this._element.anchor.z)&&(this._element.width=this.width)}});Object.defineProperty(b.prototype,"autoHeight",{get:function(){return this._autoHeight},set:function(a){(this._autoHeight=
a)&&1E-4>Math.abs(this._element.anchor.y-this._element.anchor.w)&&(this._element.height=this.height)}});Object.defineProperty(b.prototype,"rtlReorder",{get:function(){return this._rtlReorder},set:function(a){this._rtlReorder!==a&&(this._rtlReorder=a,this._font&&this._updateText())}});Object.defineProperty(b.prototype,"unicodeConverter",{get:function(){return this._unicodeConverter},set:function(a){this._unicodeConverter!==a&&(this._unicodeConverter=a,this.text=this._text)}});Object.defineProperty(b.prototype,
"aabb",{get:function(){if(this._aabbDirty){for(var a=!1,b=0;b<this._meshInfo.length;b++)this._meshInfo[b].meshInstance&&(a?this._aabb.add(this._meshInfo[b].meshInstance.aabb):(this._aabb.copy(this._meshInfo[b].meshInstance.aabb),a=!0));this._aabbDirty=!1}return this._aabb}});return{TextElement:b}}());Object.assign(pc,function(){var e=new pc.Vec2,b=new pc.Vec3,a=new pc.Vec3,c=new pc.Vec3,d=new pc.Vec3,f=new pc.Vec3,g=new pc.Quat,l={x:"y",y:"x"},k=function(a,b){if(!(a&&a instanceof pc.ElementComponent))throw Error("Element was null or not an ElementComponent");if(b&&"x"!==b&&"y"!==b)throw Error("Unrecognized axis: "+b);this._element=a;this._app=a.system.app;this._axis=b||null;this._enabled=!0;this._dragScale=new pc.Vec3;this._dragStartMousePosition=new pc.Vec3;this._dragStartHandlePosition=new pc.Vec3;
...
b.sort(function(a,b){return a.entity.graphDepth-b.entity.graphDepth});for(var d=0;d<b.length;++d)b[d].reflow();if(100<=++a){console.warn("Max reflow iterations limit reached, bailing.");break}}},_onRemoveComponent:function(a,b){b.onRemove()}});return{LayoutGroupComponentSystem:b}}());Object.assign(pc,function(){return{LayoutGroupComponentData:function(){this.enabled=!0}}}());Object.assign(pc,function(){function e(){}function b(b){function e(a){a=a.entity.layoutchild;return!a||!a.enabled||!a.excludeFromLayout}function l(a,b,c){switch(a){case pc.FITTING_NONE:return f.NONE;case pc.FITTING_STRETCH:return b<c?f.APPLY_STRETCHING:f.NONE;case pc.FITTING_SHRINK:return b>=c?f.APPLY_SHRINKING:f.NONE;case pc.FITTING_BOTH:return b<c?f.APPLY_STRETCHING:b>=c?f.APPLY_SHRINKING:f.NONE;default:throw Error("Unrecognized fitting mode: "+a);}}function k(a,b){return y(a,b.size)+(a.length-
1)*C.spacing[b.axis]}function q(a,b,c){var d=w(a,c.maxSize),f=u(a,c.fittingProportion),e=z(f,d);b=g[c.axis]-b;for(var l=0;l<a.length;++l){var h=d[l],k=r(h,b,f,e),m=a[h][c.size]+k,n=Math.min(m,a[h][c.maxSize]);a[h][c.size]=n;b-=k-Math.max(m-n,0)}}function m(a,b,c){var d=w(a,c.minSize,!0),f;f=u(a,c.fittingProportion);if(1===f.length)f=[1];else{for(var e=[],l=f.length,h=0;h<l;++h)e.push((1-f[h])/(l-1));f=e}e=z(f,d);b-=g[c.axis];for(l=0;l<a.length;++l){var h=d[l],k=r(h,b,f,e),m=a[h][c.size]-k,n=Math.max(m,
a[h][c.minSize]);a[h][c.size]=n;b-=k-Math.max(n-m,0)}}function r(a,b,c,d){c=c[a];a=d[a];return 1E-5>Math.abs(c)&&1E-5>Math.abs(a)?b:b*c/a}function t(a){for(var b=[],c=0;c<a.length;++c){var d=a[c],f=Math.max(v(d,"minWidth"),0),e=Math.max(v(d,"minHeight"),0),g=Math.max(v(d,"maxWidth"),f),l=Math.max(v(d,"maxHeight"),e),h;h=v(d,"width");h=Math.min(Math.max(h,f),g);var k;k=v(d,"height");k=Math.min(Math.max(k,e),l);var m=v(d,"fitWidthProportion"),d=v(d,"fitHeightProportion");b.push({minWidth:f,minHeight:e,
maxWidth:g,maxHeight:l,width:h,height:k,fitWidthProportion:m,fitHeightProportion:d})}return b}function v(a,b){var c=a.entity.layoutchild;return c&&c.enabled&&void 0!==c[b]&&null!==c[b]?c[b]:void 0!==a[b]?a[b]:d[b]}function y(a,b){return a.reduce(function(a,c){return a+c[b]},0)}function u(a,b){var c=y(a,b),d=[],f=a.length,e;if(0===c)for(e=0;e<f;++e)d.push(1/f);else for(e=0;e<f;++e)d.push(a[e][b]/c);return d}function w(a,b,c){a.forEach(x);return a.slice().sort(function(a,d){return c?d[b]-a[b]:a[b]-
d[b]}).map(D)}function x(a,b){a.index=b}function D(a){return a.index}function z(a,b){var c=[];c[b[a.length-1]]=a[b[a.length-1]];for(var d=a.length-2;0<=d;--d)c[b[d]]=c[b[d+1]]+a[b[d]];return c}var C,A=a[b],B=a[c[b]];return function(a,b){a=a.filter(e);C=b;g.x=C.containerSize.x-C.padding.x-C.padding.z;g.y=C.containerSize.y-C.padding.y-C.padding.w;for(var c=a,d=0;d<c.length;++d){var h=c[d],n=h.anchor;if(0!==n.x||0!==n.y||0!==n.z||0!==n.w)h.anchor=pc.Vec4.ZERO}c=a;if(C.wrap){for(var d=[[]],h=t(c),n=0,
p=C[A.fitting]===pc.FITTING_SHRINK,r=0;r<c.length;++r){0<d[d.length-1].length&&(n+=C.spacing[A.axis]);var u=h[r][A.size],n=n+u;!p&&n>g[A.axis]&&0!==d[d.length-1].length&&(n=u,d.push([]));d[d.length-1].push(c[r]);p&&n>g[A.axis]&&r!==c.length-1&&(n=0,d.push([]))}c=d}else c=[c];d=C.orientation===pc.ORIENTATION_HORIZONTAL&&C.reverseX||C.orientation===pc.ORIENTATION_VERTICAL&&C.reverseY;h=C.orientation===pc.ORIENTATION_HORIZONTAL&&C.reverseY||C.orientation===pc.ORIENTATION_VERTICAL&&C.reverseX;if(d)for(n=
0;n<c.length;++n)d&&c[n].reverse();h&&c.reverse();d=[];for(h=0;h<c.length;++h)n=t(c[h]),p=k(n,A),r=l(C[A.fitting],p,g[A.axis]),r===f.APPLY_STRETCHING?q(n,p,A):r===f.APPLY_SHRINKING&&m(n,p,A),d.push(n);u=[];r=[];for(n=0;n<c.length;++n){p=c[n];p.largestElement=null;p.largestSize={width:Number.NEGATIVE_INFINITY,height:Number.NEGATIVE_INFINITY};for(h=0;h<p.length;++h){var v=d[n][h];v[B.size]>p.largestSize[B.size]&&(p.largestElement=p[h],p.largestSize=v)}u.push(p.largestElement);r.push(p.largestSize)}h=
k(r,B);n=l(C[B.fitting],h,g[B.axis]);n===f.APPLY_STRETCHING?q(r,h,B):n===f.APPLY_SHRINKING&&m(r,h,B);for(n=0;n<c.length;++n)for(p=c[n],h=0;h<p.length;++h)r=d[n][h],u=1===c.length?g[B.axis]:p.largestSize[B.size],v=l(C[B.fitting],r[B.size],u),v===f.APPLY_STRETCHING?r[B.size]=Math.min(u,r[B.maxSize]):v===f.APPLY_SHRINKING&&(r[B.size]=Math.max(u,r[B.minSize]));a:{h={};h[A.axis]=0;h[B.axis]=0;c[A.size]=Number.NEGATIVE_INFINITY;n=[];for(p=0;p<c.length;++p){r=c[p];if(0===r.length){h=void 0;break a}for(var u=
[],v=d[p],w=0;w<r.length;++w){var x=r[w],y=v[w];h[B.axis]-=-y[B.size]*x.pivot[B.axis];h[A.axis]-=-y[A.size]*x.pivot[A.axis];u[w]={};u[w][A.axis]=h[A.axis];u[w][B.axis]=h[B.axis];h[B.axis]+=-y[B.size]*x.pivot[B.axis];h[A.axis]+=y[A.size]*(1-x.pivot[A.axis])+C.spacing[A.axis]}r[A.size]=h[A.axis]-C.spacing[A.axis];r[B.size]=r.largestSize[B.size];c[A.size]=Math.max(c[A.size],r[A.size]);h[A.axis]=0;h[B.axis]+=r[B.size]+C.spacing[B.axis];n.push(u)}c[B.size]=h[B.axis]-C.spacing[B.axis];h=n}n=h;p=C.alignment[A.axis];
r=C.alignment[B.axis];u=C.padding[A.axis];v=C.padding[B.axis];for(w=0;w<c.length;++w)for(var x=c[w],y=d[w],z=n[w],D=(g[A.axis]-x[A.size])*p+u,F=(g[B.axis]-c[B.size])*r+v,J=0;J<x.length;++J){var O=(x[B.size]-y[J][B.size])*C.alignment[B.axis];z[J][A.axis]+=D;z[J][B.axis]+=F+O}for(n=0;n<c.length;++n)for(p=c[n],r=d[n],u=h[n],v=0;v<p.length;++v)w=p[v],w[A.calculatedSize]=r[v][A.size],w[B.calculatedSize]=r[v][B.size],C.orientation===pc.ORIENTATION_HORIZONTAL?w.entity.setLocalPosition(u[v][A.axis],u[v][B.axis],
w.entity.getLocalPosition().z):w.entity.setLocalPosition(u[v][B.axis],u[v][A.axis],w.entity.getLocalPosition().z);d=c.width;c=c.height;return{bounds:new pc.Vec4((g.x-d)*C.alignment.x+C.padding.x,(g.y-c)*C.alignment.y+C.padding.y,d,c)}}}var a={};a[pc.ORIENTATION_HORIZONTAL]={axis:"x",size:"width",calculatedSize:"calculatedWidth",minSize:"minWidth",maxSize:"maxWidth",fitting:"widthFitting",fittingProportion:"fitWidthProportion"};a[pc.ORIENTATION_VERTICAL]={axis:"y",size:"height",calculatedSize:"calculatedHeight",
...
k[m],u=pc.string.getCodePoint(k[m]);e.font=this.fontWeight+" "+this.fontSize.toString()+"px "+this.fontName;e.textAlign="center";e.textBaseline="bottom";this.renderCharacter(e,a,v,y,f);var w=e.measureText(a).width;this._addChar(this.data,a,u,v-t,y-r,h,r,(h-w)/2,q[a].descent-n,w,b-1,c,d);v+=h;v+t>c&&(v=t,y+=r,y>d&&(this.textures[b-1].upload(),b++,y=r,b>p?(a=document.createElement("canvas"),a.height=d,a.width=c,e=this._getAndClearContext(a,l),u=new pc.Texture(this.app.graphicsDevice,{format:pc.PIXELFORMAT_R8_G8_B8_A8,
autoMipmap:!0}),u.name="font-atlas",u.setSource(a),u.minFilter=pc.FILTER_LINEAR_MIPMAP_LINEAR,u.magFilter=pc.FILTER_LINEAR,u.addressU=pc.ADDRESS_CLAMP_TO_EDGE,u.addressV=pc.ADDRESS_CLAMP_TO_EDGE,this.textures.push(u)):(a=this.textures[b-1].getSource(),e=this._getAndClearContext(a,l))))}this.textures[b-1].upload();if(b<p){for(m=b;m<p;m++)this.textures[m].destroy();this.textures.splice(b)}this.fire("render")};e.prototype._createJson=function(b,a,c,d){return{version:3,intensity:this.intensity,info:{face:a,
width:c,height:d,maps:[{width:c,height:d}]},chars:{}}};e.prototype._addChar=function(b,a,c,d,f,e,l,k,p,h,n,q,m){b.info.maps.length<n+1&&b.info.maps.push({width:q,height:m});q=this.fontSize/32;b.chars[a]={id:c,letter:a,x:d,y:f,width:e,height:l,xadvance:h/q,xoffset:k/q,yoffset:p/q,scale:q,range:1,map:n,bounds:[0,0,e/q,l/q]}};e.prototype._normalizeCharsSet=function(b){var a=this.app.systems.element.getUnicodeConverter();a&&(b=a(b));a={};b=pc.string.getSymbols(b);var c;for(c=0;c<b.length;c++){var d=b[c];
a[d]||(a[d]=d)}return Object.keys(a).sort()};e.prototype._getTextMetrics=function(b){var a=document.createElement("span");a.id="content-span";a.innerHTML=b;b=document.createElement("div");b.id="content-block";b.style.display="inline-block";b.style.width="1px";b.style.height="0px";var c=document.createElement("div");c.appendChild(a);c.appendChild(b);c.style.font=this.fontName;c.style.fontSize=this.fontSize+"px";document.body.appendChild(c);var d=-1,f=-1,e=-1;try{b.style["vertical-align"]="baseline",
...
this._toggleLifecycleListeners("on")}Object.assign(e.prototype,{_configureEventListeners:function(b,a){var c=this._parseEventListenerConfig(b,"external",this._parentComponent),d=this._parseEventListenerConfig(a,"internal",this);this._eventListenerConfigs=c.concat(d);this._listenerStatusFlags={};this._gainListeners={};this._loseListeners={}},_parseEventListenerConfig:function(b,a,c){return Object.keys(b).map(function(d,f){var e=d.split("#"),l=e[0],k=e[1],p=b[d];if(2!==e.length||"string"!==typeof l||
0===l.length||"string"!==typeof k||0===k.length)throw Error("Invalid event listener description: `"+d+"`");if("function"!==typeof p)throw Error("Invalid or missing callback for event listener `"+d+"`");return{id:a+"_"+f+"_"+d,sourceName:l,eventName:k,callback:p,scope:c}},this)},_toggleLifecycleListeners:function(b){this._parentComponent[b]("set_"+this._entityPropertyName,this._onSetEntity,this);this._parentComponent.system[b]("beforeremove",this._onParentComponentRemove,this);pc.ComponentSystem[b]("postInitialize",
...
b){var c=this._parser.migrate(a.data),f=a.resource,e="path"===c.mappingFormat,l=pc.StandardMaterial.TEXTURE_PARAMETERS,k;e&&(k=pc.path.getDirectory(a.getFileUrl()));var p,h,n;for(p=0;p<l.length;p++)(h=l[p],n=f._assetReferences[h],!c[h]||c[h]instanceof pc.Texture)?n&&(e?n.url=null:n.id=null):(n||(n=new pc.AssetReference(h,a,b,{load:this._onTextureLoad,add:this._onTextureAdd,remove:this._onTextureRemove},this),f._assetReferences[h]=n),e?n.url=pc.path.join(k,c[h]):n.id=c[h],n.asset&&(n.asset.resource?
this._assignTexture(h,a,n.asset.resource):this._assignPlaceholderTexture(h,a),b.load(n.asset)));l=pc.StandardMaterial.CUBEMAP_PARAMETERS;for(p=0;p<l.length;p++)h=l[p],n=f._assetReferences[h],!c[h]||c[h]instanceof pc.Texture||(n||(n=new pc.AssetReference(h,a,b,{load:this._onCubemapLoad,add:this._onCubemapAdd,remove:this._onCubemapRemove},this),f._assetReferences[h]=n),e?n.url=c[h]:n.id=c[h],n.asset&&(n.asset.resource&&this._assignCubemap(h,a,n.asset.resources),b.load(n.asset)));this._parser.initialize(f,
...
b));return null},patch:function(b,a){if(b.resource){var c=b.data,d=this;b.resource.meshInstances.forEach(function(f,e){if(c.mapping){var g=function(b){b.resource?f.material=b.resource:(b.once("load",g),a.load(b));b.once("remove",function(a){f.material===a.resource&&(f.material=d._defaultMaterial)})};if(c.mapping[e]){var k=c.mapping[e].material,p=c.mapping[e].path;if(void 0!==k)if(k)if(p=a.get(k))g(p);else a.once("add:"+k,g);else f.material=d._defaultMaterial;else if(p)if(k=b.getFileUrl(),k=pc.path.getDirectory(k),
k=pc.path.join(k,c.mapping[e].path),p=a.getByUrl(k))g(p);else a.once("add:url:"+k,g)}else f.material=d._defaultMaterial}})}},addParser:function(b,a){this._parsers.push({parser:b,decider:a})}});return{ModelHandler:e}}());Object.assign(pc,function(){var e=function(b){this._app=b;this._scripts={};this._cache={}};e._types=[];e._push=function(b){pc.script.legacy&&0<e._types.length?console.assert("Script Ordering Error. Contact support@playcanvas.com"):e._types.push(b)};Object.assign(e.prototype,{load:function(b,a){var c=this;pc.script.app=this._app;this._loadScript(b,function(b,f,g){if(b)a(b);else if(pc.script.legacy)b=null,e._types.length&&(b=e._types.pop()),b?this._scripts[f]=b:b=null,a(null,b,g);else{b={};for(var d=
...
a))},c.src=a;else{var k=d.indexOf("blob:");0<=k?(a=d=d.substr(k),c=new Image,c.onload=function(){b(null,c)},c.onerror=function(c){b(pc.string.format("Error loading Texture from: '{0}'",a))},c.src=a):setTimeout(function(){b(pc.string.format("Error loading Texture: format not supported: '{0}'",e))},0)}},open:function(a,b){if(a){var c,d=pc.path.getExtension(a).toLowerCase();if(b instanceof Image||b instanceof HTMLImageElement)c=".jpg"===d||".jpeg"===d?pc.PIXELFORMAT_R8_G8_B8:pc.PIXELFORMAT_R8_G8_B8_A8,
c=new pc.Texture(this._device,{width:b.width,height:b.height,format:c}),c.name=a,c.setSource(b);else if(b instanceof ArrayBuffer)if(".dds"===d){c=b;var e=this._device;if(".crn"===pc.path.getExtension(a).toLowerCase()){var d=c.byteLength,k=new Uint8Array(c);c=Module._malloc(d);var p=Module.HEAPU8,h,n=c/4,q=d%4,m=new Uint32Array(k.buffer,0,(d-q)/4),r=new Uint32Array(p.buffer);for(h=0;h<m.length;h++)r[n+h]=m[h];for(h=d-q;h<d;h++)p[c+h]=k[h];k=Module._crn_decompress_get_data(c,d);c=Module._crn_decompress_get_size(c,
d);c=Module.HEAPU8.buffer.slice(k,k+c)}var t=new Uint32Array(c,0,32),d=t[4],k=t[3],p=Math.max(t[7],1),v=t[21],y=t[22];h=65024===t[28];var u=r=m=q=n=!1,w=null;if(4===t[20])if(827611204===v)w=pc.PIXELFORMAT_DXT1,n=!0;else if(894720068===v)w=pc.PIXELFORMAT_DXT5,n=!0;else if(116===v)w=pc.PIXELFORMAT_RGBA32F,q=!0;else if(826496069===v)w=pc.PIXELFORMAT_ETC1,m=n=!0;else if(825438800===v||825504336===v)w=825438800===v?pc.PIXELFORMAT_PVRTC_2BPP_RGB_1:pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1,r=n=!0;else{if(825439312===
v||825504848===v)w=825439312===v?pc.PIXELFORMAT_PVRTC_4BPP_RGB_1:pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1,u=n=!0}else 32===y&&(w=pc.PIXELFORMAT_R8_G8_B8_A8);if(w){e=new pc.Texture(e,{width:d,height:k,format:w,cubemap:h});h&&(e.addressU=pc.ADDRESS_CLAMP_TO_EDGE,e.addressV=pc.ADDRESS_CLAMP_TO_EDGE);for(var t=128,y=h?6:1,x,v=827611204===v?8:16,D,w=0;w<y;w++)for(var z=d,C=k,A=0;A<p;A++)n?m?x=Math.floor((z+3)/4)*Math.floor((C+3)/4)*8:r?x=Math.max(z,16)*Math.max(C,8)/4:u?x=Math.max(z,8)*Math.max(C,8)/2:(x=Math.floor((z+
4-1)/4),D=Math.floor((C+4-1)/4),x*=D,x*=v):x=z*C*4,D=q?new Float32Array(c,t,x):new Uint8Array(c,t,x),h?(e._levels[A]||(e._levels[A]=[]),e._levels[A][w]=D):e._levels[A]=D,t+=q?4*x:x,z=Math.max(.5*z,1),C=Math.max(.5*C,1);e.name=a;e.upload()}else e=new pc.Texture(e,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8}),e.name="dds-legacy-empty";c=e}else{switch(d){case ".dds":k=new pc.DdsParser(b);break;case ".ktx":k=new pc.KtxParser(b);break;case ".pvr":console.warn("PVR container not supported.")}if(!k)return c=
new pc.Texture(this._device,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8}),c.name="unsupported-empty",c;c=new pc.Texture(this._device,{addressU:k.cubemap?pc.ADDRESS_CLAMP_TO_EDGE:pc.ADDRESS_REPEAT,addressV:k.cubemap?pc.ADDRESS_CLAMP_TO_EDGE:pc.ADDRESS_REPEAT,width:k.width,height:k.height,format:k.format,cubemap:k.cubemap,levels:k.levels});c.name=a;c.upload()}return c}},patch:function(a,d){var c=a.resource;if(c){c.name!==a.name&&(c.name=a.name);a.data.hasOwnProperty("minfilter")&&c.minFilter!==
b[a.data.minfilter]&&(c.minFilter=b[a.data.minfilter]);a.data.hasOwnProperty("magfilter")&&c.magFilter!==b[a.data.magfilter]&&(c.magFilter=b[a.data.magfilter]);a.data.hasOwnProperty("addressu")&&c.addressU!==e[a.data.addressu]&&(c.addressU=e[a.data.addressu]);a.data.hasOwnProperty("addressv")&&c.addressV!==e[a.data.addressv]&&(c.addressV=e[a.data.addressv]);a.data.hasOwnProperty("mipmaps")&&c.mipmaps!==a.data.mipmaps&&(c.mipmaps=a.data.mipmaps);a.data.hasOwnProperty("anisotropy")&&c.anisotropy!==
a.data.anisotropy&&(c.anisotropy=a.data.anisotropy);var g=!!a.data.rgbm;a.data.hasOwnProperty("rgbm")&&c.rgbm!==g&&(c.rgbm=g)}}});return{TextureHandler:a}}());Object.assign(pc,function(){var e=function(){};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a(pc.string.format("Error loading html resource: {0} [{1}]",b,c)):a(null,d)})},open:function(b,a){return a},patch:function(b,a){}});return{HtmlHandler:e}}());Object.assign(pc,function(){var e=function(){};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a(pc.string.format("Error loading css resource: {0} [{1}]",b,c)):a(null,d)})},open:function(b,a){return a},patch:function(b,a){}});return{CssHandler:e,createStyle:function(b){var a=document.createElement("style");a.type="text/css";a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b));return a}}}());Object.assign(pc,function(){var e=function(){};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a(pc.string.format("Error loading shader resource: {0} [{1}]",b,c)):a(null,d)})},open:function(b,a){return a},patch:function(b,a){}});return{ShaderHandler:e}}());Object.assign(pc,function(){var e=function(b){this._app=b};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a("Error requesting scene: "+b):a(null,d)})},open:function(b,a){this._app.systems.script.preloading=!0;var c=(new pc.SceneParser(this._app)).parse(a),d=this._app.scene;d.root=c;this._app.applySceneSettings(a.settings);this._app.systems.script.preloading=!1;return d},patch:function(b,a){}});return{SceneHandler:e}}());Object.assign(pc,function(){var e=function(b){this._app=b};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a("Error requesting scene: "+b):a(null,d)})},open:function(b,a){this._app.systems.script.preloading=!0;var c=(new pc.SceneParser(this._app)).parse(a);this._app.systems.script.preloading=!1;return c}});return{HierarchyHandler:e}}());Object.assign(pc,function(){var e=function(b){this._app=b};Object.assign(e.prototype,{load:function(b,a){pc.http.get(b,function(c,d){c?a("Error requesting scene: "+b):a(null,d)})},open:function(b,a){return a.settings}});return{SceneSettingsHandler:e}}());Object.assign(pc,function(){var e=function(){};Object.assign(e.prototype,{load:function(b,a){a(null,null)},open:function(b,a){return a}});return{FolderHandler:e}}());Object.assign(pc,function(){function e(a){3>a.version&&(2>a.version&&(a.info.maps=a.info.maps||[{width:a.info.width,height:a.info.height}]),a.chars=Object.keys(a.chars||{}).reduce(function(b,d){var c=a.chars[d],e=void 0!==c.letter?c.letter:pc.string.fromCodePoint(d);2>a.version&&(c.map=c.map||0);b[e]=c;return b},{}),a.version=3);return a}var b=function(a){this._loader=a};Object.assign(b.prototype,{load:function(a,b,d){var c=this;".json"===pc.path.getExtension(a)?pc.http.get(a,function(d,f){var g=
e(f);d?b(pc.string.format("Error loading font resource: {0} [{1}]",a,d)):c._loadTextures(a.replace(".json",".png"),g,function(a,c){if(a)return b(a);b(null,{data:g,textures:c})})}):(d&&d.data&&(d.data=e(d.data)),this._loadTextures(a,d&&d.data,b))},_loadTextures:function(a,b,d){var c=b.info.maps.length,e=0,l=null,k=Array(c),p=this._loader;b=function(b){var f=function(a,f){if(!l){if(a)return l=a,d(a);f.upload();k[b]=f;e++;e===c&&d(null,k)}};0===b?p.load(a,"texture",f):p.load(a.replace(".png",b+".png"),
...
a.data.hasOwnProperty("mipmaps")&&d.mipmaps!==a.data.mipmaps&&(d.mipmaps=a.data.mipmaps);a.data.hasOwnProperty("anisotropy")&&d.anisotropy!==a.data.anisotropy&&(d.anisotropy=a.data.anisotropy);var f=!!a.data.rgbm;a.data.hasOwnProperty("rgbm")&&d.rgbm!==f&&(d.rgbm=f)}a.resource.texture=d;var d={},k;for(k in a.data.frames)f=a.data.frames[k],d[k]={rect:new pc.Vec4(f.rect),pivot:new pc.Vec2(f.pivot),border:new pc.Vec4(f.border)};a.resource.frames=d;a.off("change",this._onAssetChange,this);a.on("change",
...
c.data.textureAtlasAsset,b,c);this._assets.on("load:"+c.data.textureAtlasAsset,b,c);var f=this._assets.get(c.data.textureAtlasAsset);f&&f.resource?d.atlas=f.resource:f?this._assets.load(f):(this._assets.off("add:"+c.data.textureAtlasAsset,a,c),this._assets.on("add:"+c.data.textureAtlasAsset,a,c))}else d.atlas=null},_onAssetChange:function(c,d,f,e){"data"===d&&f&&f.textureAtlasAsset&&e&&f.textureAtlasAsset!==e.textureAtlasAsset&&(this._assets.off("load:"+e.textureAtlasAsset,b,c),this._assets.off("add:"+
e.textureAtlasAsset,a,c))}});return{SpriteHandler:e}}());Object.assign(pc,function(){var e={points:pc.PRIMITIVE_POINTS,lines:pc.PRIMITIVE_LINES,lineloop:pc.PRIMITIVE_LINELOOP,linestrip:pc.PRIMITIVE_LINESTRIP,triangles:pc.PRIMITIVE_TRIANGLES,trianglestrip:pc.PRIMITIVE_TRISTRIP,trianglefan:pc.PRIMITIVE_TRIFAN},b={int8:pc.TYPE_INT8,uint8:pc.TYPE_UINT8,int16:pc.TYPE_INT16,uint16:pc.TYPE_UINT16,int32:pc.TYPE_INT32,uint32:pc.TYPE_UINT32,float32:pc.TYPE_FLOAT32},a=function(a){this._device=a;this._defaultMaterial=pc.getDefaultMaterial()};Object.assign(a.prototype,
{parse:function(a){var b=a.model;if(!b||1>=b.version)return null;var b=this._parseNodes(a),c=this._parseSkins(a,b),e=this._parseMorphs(a,b),l=this._parseVertexBuffers(a),k=this._parseIndexBuffers(a,l),k=this._parseMeshes(a,c.skins,e.morphs,l,k.buffer,k.data);this._initMorphs(a,e.morphs,l,k);a=this._parseMeshInstances(a,b,k,c.skins,c.instances,e.morphs,e.instances);l=new pc.Model;l.graph=b[0];l.meshInstances=a;l.skinInstances=c.instances;l.morphInstances=e.instances;l.getGraph().syncHierarchy();return l},
_parseNodes:function(a){a=a.model;var b=[],c;for(c=0;c<a.nodes.length;c++){var e=a.nodes[c],l=new pc.GraphNode;l.setName(e.name);l.setLocalPosition(e.position[0],e.position[1],e.position[2]);l.setLocalEulerAngles(e.rotation[0],e.rotation[1],e.rotation[2]);l.setLocalScale(e.scale[0],e.scale[1],e.scale[2]);l.scaleCompensation=!!e.scaleCompensation;b.push(l)}for(c=1;c<a.parents.length;c++)b[a.parents[c]].addChild(b[c]);return b},_parseSkins:function(a,b){var c=a.model,d=[],e=[],k,p;!this._device.supportsBoneTextures&&
0<c.skins.length&&(k=this._device.getBoneLimit(),pc.partitionSkin(c,null,k));for(k=0;k<c.skins.length;k++){var h=c.skins[k],n=[];for(p=0;p<h.inverseBindMatrices.length;p++){var q=h.inverseBindMatrices[p];n[p]=(new pc.Mat4).set(q)}h=new pc.Skin(this._device,n,h.boneNames);d.push(h);n=new pc.SkinInstance(h);q=[];for(p=0;p<h.boneNames.length;p++){var m=b[0].findByName(h.boneNames[p]);q.push(m)}n.bones=q;e.push(n)}return{skins:d,instances:e}},_parseMorphs:function(a,b){var c=a.model,d=[],e=[],k,p,h,n,
q;if(c.morphs)for(k=0;k<c.morphs.length;k++){h=c.morphs[k].targets;q=[];for(p=0;p<h.length;p++){var m=h[p].aabb;n=m.min;m=m.max;n=new pc.BoundingBox(new pc.Vec3(.5*(m[0]+n[0]),.5*(m[1]+n[1]),.5*(m[2]+n[2])),new pc.Vec3(.5*(m[0]-n[0]),.5*(m[1]-n[1]),.5*(m[2]-n[2])));n=new pc.MorphTarget({indices:h[p].indices,deltaPositions:h[p].deltaPositions,deltaNormals:h[p].deltaNormals,name:h[p].name,aabb:n});q.push(n)}p=new pc.Morph(q);d.push(p);p=new pc.MorphInstance(p);e.push(p)}return{morphs:d,instances:e}},
_calculateTangentsMorphTarget:function(a,b,f,e,l,k,p,h){var c,d,g,r,t,v,y,u,w,x,D,z,C,A,B,J,F,H,E,G;J=e.length/3;for(G=0;G<J;G++)F=e[3*G],H=e[3*G+1],E=e[3*G+2],y=a[3*F],t=a[3*F+1],v=a[3*F+2],r=a[3*H],u=a[3*H+1],w=a[3*H+2],x=a[3*E],D=a[3*E+1],z=a[3*E+2],C=f[2*F],c=f[2*F+1],A=f[2*H],g=f[2*H+1],B=f[2*E],d=f[2*E+1],r-=y,y=x-y,u-=t,t=D-t,w-=v,v=z-v,A-=C,C=B-C,g-=c,z=d-c,c=A*z-C*g,0==c?(c=0,d=1,g=0,r=1,v=t=0):(B=1/c,c=(z*r-g*y)*B,d=(z*u-g*t)*B,g=(z*w-g*v)*B,r=(A*y-C*r)*B,t=(A*t-C*u)*B,v=(A*v-C*w)*B),l[3*
F+0]+=c,l[3*F+1]+=d,l[3*F+2]+=g,l[3*H+0]+=c,l[3*H+1]+=d,l[3*H+2]+=g,l[3*E+0]+=c,l[3*E+1]+=d,l[3*E+2]+=g,k[3*F+0]+=r,k[3*F+1]+=t,k[3*F+2]+=v,k[3*H+0]+=r,k[3*H+1]+=t,k[3*H+2]+=v,k[3*E+0]+=r,k[3*E+1]+=t,k[3*E+2]+=v;c=p.length;for(E=0;E<c;E++)G=p[E],w=b[3*G],d=b[3*G+1],u=b[3*G+2],a=l[3*G],f=l[3*G+1],e=l[3*G+2],J=k[3*G],F=k[3*G+1],H=k[3*G+2],v=w*a+d*f+u*e,y=w*v,t=d*v,v*=u,r=d*e-f*u,u=u*a-e*w,w=w*f-a*d,a-=y,f-=t,e-=v,v=1/Math.sqrt(a*a+f*f+e*e),a*=v,f*=v,e*=v,h[4*G]=a,h[4*G+1]=f,h[4*G+2]=e,h[4*G+3]=0>r*
J+u*F+w*H?-1:1;return h},_initMorphs:function(a,b,f,e){a=a.model;var c,d,g,h,n,q,m,r,t,v,y,u,w,x,D,z=[],C=[];for(f=0;f<e.length;f++)if(t=a.meshes[f].vertices,!C[t]&&(d=a.vertices[t],d.tangent)){var A=new Float32Array(d.tangent.data);C[t]=!0;if(d.position&&d.normal&&d.texCoord0){var B=[];for(c=0;c<a.meshes.length;c++)a.meshes[c].vertices===t&&(B=B.concat(a.meshes[c].indices));t=d.position.data;v=d.normal.data;y=d.texCoord0.data;u=t.length/3;w=B.length;var J=new Float32Array(4*u),F=new Float32Array(3*
u),H=new Float32Array(3*u);x=new Float32Array(3*u);x.set(t);D=new Float32Array(3*u);D.set(v);for(c=0;c<b.length;c++)if(a.meshes[f].morph===c)for(g=0;g<b[c]._targets.length;g++){d=b[c]._targets[g];var E=d.indices,G=E.length;if(0!==G){d.deltaTangents=new Float32Array(4*G);if(!r||r.length<u)r=new Uint8Array(u);else for(h=0;h<u;h++)r[h]=0;for(h=0;h<G;h++)n=E[h],r[n]=1;var I=0;for(h=0;h<w;h+=3)if(n=B[h],q=B[h+1],m=B[h+2],r[n]||r[q]||r[m])z[I]=n,z[I+1]=q,z[I+2]=m,I+=3;z.length=I;q=d.deltaPositions;m=d.deltaNormals;
...
q&&(q=pc.BAKE_COLORDIR);q===pc.BAKE_COLORDIR&&(y=2);var u,w=[],x=[];if(h){var D;for(m=a.length-1;0<=m;m--)for(n=0;n<h.length;n++)if(a[m]===h[n]){for(D=0;D<b[m].length;D++)b[m][D].destroy();b.splice(m,1);a.splice(m,1)}D=[];for(m=0;m<h.length;m++)e(h[m],D,x);h=D;e(this.root,null,null,w)}else{for(m=0;m<b.length;m++)for(n=0;n<b[m].length;n++)b[m][n].destroy();b=[];a=[];h=[];e(this.root,h,x,w)}if(0===h.length)t.fire("lightmapper:end",{timestamp:pc.now(),target:this});else{D=!1;v._needsStaticPrepare&&(v._needsStaticPrepare=
...
for(K=0;K<h.length;K++){O=x[K];f=ea[K];if(z[m]._type===pc.LIGHTTYPE_DIRECTIONAL)d.copy(f.center),d.y+=f.halfExtents.y,c._node.setPosition(d),c._node.setEulerAngles(-90,0,0),n=Math.max(f.halfExtents.x,f.halfExtents.z),c.projection=pc.PROJECTION_ORTHOGRAPHIC,c.nearClip=0,c.farClip=2*f.halfExtents.y,c.aspectRatio=1,c.orthoHeight=n;else if(!g.intersects(f))continue;if(z[m]._type===pc.LIGHTTYPE_SPOT){u=!1;for(n=0;n<O.length;n++)if(this.renderer._isVisible(Y,O[n])){u=!0;break}if(!u)continue}z[m]._type===
...
this._batchGroups[a.sprite.batchGroupId]));for(c=0;c<a._children.length;c++)this._collectAndRemoveModels(a._children[c],b,e)}};a.prototype._registerEntities=function(a,b){for(var c,d=[],e=0;e<b.length;e++){for(c=b[e].node;!c._app&&c._parent;)c=c._parent;c._app&&d.push(c)}this.register(a,d)};a.prototype.generate=function(a){var b,c,e={};if(a){c=[];for(b=0;b<this._batchList.length;b++)0>a.indexOf(this._batchList[b].batchGroupId)?c.push(this._batchList[b]):this.destroy(this._batchList[b]);this._batchList=
c;this._collectAndRemoveModels(this.rootNode,e,a);if(a===this._dirtyGroups)this._dirtyGroups.length=0;else{c=[];for(b=0;b<this._dirtyGroups.length;b++)0>a.indexOf(this._dirtyGroups[b])&&c.push(this._dirtyGroups[b]);this._dirtyGroups=c}}else{for(b=0;b<this._batchList.length;b++)this.destroy(this._batchList[b]);this._batchList.length=0;this._collectAndRemoveModels(this.rootNode,e);this._dirtyGroups.length=0}var l,k,p;for(p in e)if(e.hasOwnProperty(p)&&(b=e[p],a=this._batchGroups[p]))for(l=this.prepare(b,
a.dynamic,a.maxAabbSize),b=0;b<l.length;b++){k=this.create(l[b],a.dynamic,parseInt(p,10));for(c=0;c<a.layers.length;c++)this.scene.layers.getLayerById(a.layers[c]).addMeshInstances(k.model.meshInstances);this._registerEntities(k,l[b])}};a.prototype.prepare=function(a,b,f){if(0===a.length)return[];void 0===f&&(f=Number.POSITIVE_INFINITY);f*=.5;for(var c=this.device.supportsBoneTextures?1024:this.device.boneLimit,d,k,p,h,n,q,m,r,t,v=new pc.BoundingBox,y=new pc.BoundingBox,u=[],w=0,x=a,D,z;0<x.length;){u[w]=
[];D=[];d=x[0].material;k=x[0].layer;t=x[0]._shaderDefs;h=x[0].parameters;r=x[0]._staticLightList;p=x[0].mesh.vertexBuffer.getNumVertices();v.copy(x[0].aabb);for(a=0;a<x.length;a++){if(0<a){if(d!==x[a].material){D.push(x[a]);continue}if(k!==x[a].layer){D.push(x[a]);continue}if(t!==x[a]._shaderDefs){D.push(x[a]);continue}if(65535<p+x[a].mesh.vertexBuffer.getNumVertices()){D.push(x[a]);continue}y.copy(v);y.add(x[a].aabb);if(y.halfExtents.x>f||y.halfExtents.y>f||y.halfExtents.z>f){D.push(x[a]);continue}n=
x[a].parameters;m=!1;for(q in h)if(h.hasOwnProperty(q)&&!e(h[q],n[q])){m=!0;break}if(!m)for(q in n)if(n.hasOwnProperty(q)&&!e(n[q],h[q])){m=!0;break}if(m){D.push(x[a]);continue}n=x[a]._staticLightList;if(r&&!n||!r&&n){D.push(x[a]);continue}if(r&&n){m=!1;for(z=0;z<r.length;z++)if(0>n.indexOf(r[z])){m=!0;break}for(z=0;z<n.length;z++)if(0>r.indexOf(n[z])){m=!0;break}if(m){D.push(x[a]);continue}}}v.add(x[a].aabb);p+=x[a].mesh.vertexBuffer.getNumVertices();u[w].push(x[a]);if(b&&u[w].length===c){D=a===
x.length?[]:x.slice(a+1);break}}w++;x=D}return u};a.prototype.create=function(a,d,e){this._init||(this.transformVS="#define BONE_LIMIT "+this.device.getBoneLimit()+"\n#define DYNAMICBATCH\n"+pc.shaderChunks.transformVS,this.skinTexVS=pc.shaderChunks.skinBatchTexVS,this.skinConstVS=pc.shaderChunks.skinBatchConstVS,this.vertexFormats={},this._init=!0);var c,f;e=new pc.Batch(a,d,e);this._batchList.push(e);var k=null,p,h,n,q,m,r,t,v,y,u=0,w=0;for(c=0;c<a.length;c++){if(!k)k=a[c].material;else if(k!==
a[c].material)return;p=a[c].mesh;h=p.vertexBuffer.format.elements;n=p.vertexBuffer.numVertices;u+=n;for(f=0;f<h.length;f++)h[f].name===pc.SEMANTIC_POSITION?q=!0:h[f].name===pc.SEMANTIC_NORMAL?m=!0:h[f].name===pc.SEMANTIC_TEXCOORD0?r=!0:h[f].name===pc.SEMANTIC_TEXCOORD1?t=!0:h[f].name===pc.SEMANTIC_TANGENT?v=!0:h[f].name===pc.SEMANTIC_COLOR&&(y=!0);w+=p.primitive[0].count}if(q){var x=3+(m?3:0)+(r?2:0)+(t?2:0)+(v?4:0)+(y?1:0)+(d?1:0),D=m?6:3,z=(m?6:3)+(r?2:0),C=(m?6:3)+(r?2:0)+(t?2:0),A=(m?6:3)+(r?
2:0)+(t?2:0)+(v?4:0),B=(m?6:3)+(r?2:0)+(t?2:0)+(v?4:0)+(y?1:0),J=new ArrayBuffer(u*x*4);q=new Float32Array(J);var F=new Uint8Array(J),J=new pc.IndexBuffer(this.device,pc.INDEXFORMAT_UINT16,w,pc.BUFFER_STATIC),H=new Uint16Array(J.lock()),E,G,I,Q=0,V=0;I=0;var W,U,Z,T,L,R,P,K;d||(K=new pc.Vec3);for(c=0;c<a.length;c++){p=a[c].mesh;h=p.vertexBuffer.format.elements;n=p.vertexBuffer.numVertices;f=p.vertexBuffer.format.size;E=f/4;for(f=0;f<h.length;f++)h[f].name===pc.SEMANTIC_POSITION?W=h[f].offset/4:h[f].name===
pc.SEMANTIC_NORMAL?U=h[f].offset/4:h[f].name===pc.SEMANTIC_TEXCOORD0?Z=h[f].offset/4:h[f].name===pc.SEMANTIC_TEXCOORD1?T=h[f].offset/4:h[f].name===pc.SEMANTIC_TANGENT?L=h[f].offset/4:h[f].name===pc.SEMANTIC_COLOR&&(R=h[f].offset/4);h=new Float32Array(p.vertexBuffer.storage);G=new Uint8Array(p.vertexBuffer.storage);if(d)for(f=0;f<n;f++)q[f*x+I]=h[f*E+W],q[f*x+I+1]=h[f*E+W+1],q[f*x+I+2]=h[f*E+W+2],m&&(q[f*x+I+3]=h[f*E+U],q[f*x+I+3+1]=h[f*E+U+1],q[f*x+I+3+2]=h[f*E+U+2]),r&&(q[f*x+I+D]=h[f*E+Z],q[f*x+
I+D+1]=h[f*E+Z+1]),t&&(q[f*x+I+z]=h[f*E+T],q[f*x+I+z+1]=h[f*E+T+1]),v&&(q[f*x+I+C]=h[f*E+L],q[f*x+I+C+1]=h[f*E+L+1],q[f*x+I+C+2]=h[f*E+L+2],q[f*x+I+C+3]=h[f*E+L+3]),y&&(F[f*x*4+4*I+4*A]=G[f*E*4+4*R],F[f*x*4+4*I+4*A+1]=G[f*E*4+4*R+1],F[f*x*4+4*I+4*A+2]=G[f*E*4+4*R+2],F[f*x*4+4*I+4*A+3]=G[f*E*4+4*R+3]),q[f*x+B+I]=c;else for(P=a[c].node.getWorldTransform(),f=0;f<n;f++)K.set(h[f*E+W],h[f*E+W+1],h[f*E+W+2]),P.transformPoint(K,K),q[f*x+I]=K.x,q[f*x+I+1]=K.y,q[f*x+I+2]=K.z,m&&(K.set(h[f*E+U],h[f*E+U+1],
h[f*E+U+2]),P.transformVector(K,K),q[f*x+I+3]=K.x,q[f*x+I+3+1]=K.y,q[f*x+I+3+2]=K.z),r&&(q[f*x+I+D]=h[f*E+Z],q[f*x+I+D+1]=h[f*E+Z+1]),t&&(q[f*x+I+z]=h[f*E+T],q[f*x+I+z+1]=h[f*E+T+1]),v&&(K.set(h[f*E+L],h[f*E+L+1],h[f*E+L+2]),P.transformVector(K,K),q[f*x+I+C]=K.x,q[f*x+I+C+1]=K.y,q[f*x+I+C+2]=K.z,q[f*x+I+C+3]=h[f*E+L+3]),y&&(F[f*x*4+4*I+4*A]=G[f*E*4+4*R],F[f*x*4+4*I+4*A+1]=G[f*E*4+4*R+1],F[f*x*4+4*I+4*A+2]=G[f*E*4+4*R+2],F[f*x*4+4*I+4*A+3]=G[f*E*4+4*R+3]);I=p.primitive[0].base;E=p.primitive[0].count;
p=new Uint16Array(p.indexBuffer[0].storage);for(f=0;f<E;f++)H[f+V]=p[I+f]+Q;V+=E;Q+=n;I=Q*x}a=0;m&&(a|=2);r&&(a|=4);t&&(a|=8);v&&(a|=16);y&&(a|=32);d&&(a|=64);c=this.vertexFormats[a];c||(c=[],c.push({semantic:pc.SEMANTIC_POSITION,components:3,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),m&&c.push({semantic:pc.SEMANTIC_NORMAL,components:3,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),r&&c.push({semantic:pc.SEMANTIC_TEXCOORD0,components:2,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),t&&c.push({semantic:pc.SEMANTIC_TEXCOORD1,
...
m;p.indexBuffer[0]=J;p.primitive[0].type=e.origMeshInstances[0].mesh.primitive[0].type;p.primitive[0].base=0;p.primitive[0].count=w;p.primitive[0].indexed=!0;p.cull=!1;d&&(k=k.clone(),k.chunks.transformVS=this.transformVS,k.chunks.skinTexVS=this.skinTexVS,k.chunks.skinConstVS=this.skinConstVS,k.update());k=new pc.MeshInstance(this.rootNode,p,k);k.castShadow=e.origMeshInstances[0].castShadow;k.parameters=e.origMeshInstances[0].parameters;k.isStatic=e.origMeshInstances[0].isStatic;k.cull=e.origMeshInstances[0].cull;
k.layer=e.origMeshInstances[0].layer;k._staticLightList=e.origMeshInstances[0]._staticLightList;k._shaderDefs=e.origMeshInstances[0]._shaderDefs;if(d){d=[];for(c=0;c<e.origMeshInstances.length;c++)d.push(e.origMeshInstances[c].node);k.skinInstance=new b(this.device,d,this.rootNode)}k._updateAabb=!1;e.meshInstance=k;this.update(e);d=new pc.Model;d.meshInstances=[e.meshInstance];d.castShadows=e.origMeshInstances[0].castShadows;e.model=d;return e}};a.prototype.update=function(a){a._aabb.copy(a.origMeshInstances[0].aabb);
for(var b=0;b<a.origMeshInstances.length;b++)0<b&&a._aabb.add(a.origMeshInstances[b].aabb);a.meshInstance.aabb=a._aabb;a._aabb._radiusVer=-1;a.meshInstance._aabbVer=0};a.prototype.updateAll=function(){0<this._dirtyGroups.length&&this.generate(this._dirtyGroups);for(var a=0;a<this._batchList.length;a++)this._batchList[a].dynamic&&this.update(this._batchList[a])};a.prototype.clone=function(a,d){var c=new pc.Batch(d,a.dynamic,a.batchGroupId);this._batchList.push(c);for(var e=[],l=0;l<d.length;l++)e.push(d[l].node);
c.meshInstance=new pc.MeshInstance(a.meshInstance.node,a.meshInstance.mesh,a.meshInstance.material);c.meshInstance._updateAabb=!1;c.meshInstance.parameters=d[0].parameters;c.meshInstance.isStatic=d[0].isStatic;c.meshInstance.cull=d[0].cull;c.meshInstance.layer=d[0].layer;c.meshInstance._staticLightList=d[0]._staticLightList;a.dynamic&&(c.meshInstance.skinInstance=new b(this.device,e,this.rootNode));c.meshInstance.castShadow=a.meshInstance.castShadow;c.meshInstance._shader=a.meshInstance._shader;e=
new pc.Model;e.meshInstances=[c.meshInstance];e.castShadows=a.origMeshInstances[0].castShadows;c.model=e;return c};a.prototype.destroy=function(a){a.refCounter=0;for(var b=this._batchGroups[a.batchGroupId].layers,c=0;c<b.length;c++)this.scene.layers.getLayerById(b[c]).removeMeshInstances(a.model.meshInstances);a.model.destroy()};a.prototype.decrement=function(a){a.refCounter--;0===a.refCounter&&this.destroy(a)};a.prototype.register=function(a,b){a.refCounter=b.length;for(var c=this,d=function(){c.decrement(a)},
e=0;e<b.length;e++)b[e].once("destroy",d)};return{Batch:function(a,b,e){this.origMeshInstances=a;this._aabb=new pc.BoundingBox;this.model=this.meshInstance=null;this.dynamic=b;this.batchGroupId=e;this.refCounter=0},BatchGroup:function(a,b,e,g,l){this.dynamic=e;this.maxAabbSize=g;this.id=a;this.name=b;this.layers=void 0===l?[pc.LAYERID_WORLD]:l},BatchManager:a}}());
  return pc;
}));
